<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlEmployeeAbsenceDetailReport.ascx.vb" Inherits="Reports_ControlsViewer_ctlEmployeeAbsenceDetailReport" %>
        ...
        <table class="xFormView" style="width: 450px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Employee Absence Detail Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Search Employees:%> " /></td>
