<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlEmployeeListReport.ascx.vb" Inherits="Reports_ControlsViewer_ctlEmployeeListReport" %>
...
<%@ Register Src="../ControlsFilter/fltEmployeeListReport.ascx" TagName="fltEmployeeListReport"
    TagPrefix="uc1" %>

<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>

<uc1:fltEmployeeListReport ID="FltEmployeeListReport1" runat="server" />
        <br />
        <br />
