...
Public Class AccountEmployeeTimeEntryBLL
    ...
    Public Function GetAccountEmployeeTimeEntriesByDate(ByVal AccountEmployeeId As Integer, ByVal TimeEntryDate As Date, ByVal IsCopy As Boolean) As Object
        If System.Web.HttpContext.Current.Session("StoreInSession") Is Nothing Then
            GetAccountEmployeeTimeEntriesByDate = System.Web.HttpContext.Current.Session("TimeEntryDayView")
        Else
            ...
            If LocaleUtilitiesBLL.IsShowTimeOffInTimesheet Then
                ...
                Next
            End If
            System.Web.HttpContext.Current.Session("TimeEntryDayView") = GetAccountEmployeeTimeEntriesByDate
            System.Web.HttpContext.Current.Session.Remove("StoreInSession")
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetPendingTimeEntryApprovalsWithPreferenceByApproverEmployeeIdForEmail(ByVal ApproverEmployeeId As Integer) As TimeLiveDataSet.vueAccountEmployeeTimeEntryApprovalPendingEmailWithPreferenceDataTable
        LoggingBLL.WriteToLog("GetPendingTimeEntryApprovalsWithPreferenceByApproverEmployeeIdForEmail" & " " & ApproverEmployeeId)
        Dim _vueAccountEmployeeTimeEntryApprovalPendingEmailWithPreferenceTableAdapter As New vueAccountEmployeeTimeEntryApprovalPendingEmailWithPreferenceTableAdapter
        Return _vueAccountEmployeeTimeEntryApprovalPendingEmailWithPreferenceTableAdapter.GetDataByApproverEmployeeIdForEmail(ApproverEmployeeId)
    End Function
    ''' <summary>
    ...
    Public Function GetPendingTimeEntryApprovalsWithPreferenceGroupByApproverEmployeeId() As TimeLiveDataSet.vueAccountEmployeeTimeEntryApprovalPendingEmailWithPreferenceGroupByApproverEmployeeIdDataTable
        ...
        _vueAccountEmployeeTimeEntryApprovalPendingEmailWithPreferenceGroupByApproverEmployeeIdTableAdapter.SetCommandTimeOut(1000)
        Return _vueAccountEmployeeTimeEntryApprovalPendingEmailWithPreferenceGroupByApproverEmployeeIdTableAdapter.GetData()
    End Function
    ''' <summary>
    ...
    Public Function AddAccountEmployeeTimeEntryForImportExport( _
        ...
        If CheckCurrentPeriodDateForOfflineTimesheet(OfflineTimesheet, TimeEntryDate) Then
            ...
            End If
            Dim InsertedAccountEmployeeTimeEntryId As Integer = Me.AddAccountEmployeeTimeEntry(AccountEmployeeId, TimeEntryDate, StartTime, EndTime, TotalTime, AccountProjectId, AccountProjectTaskId, Description, Approved, CreatedOn, ModifiedOn, AccountPartyId, Submitted, AccountWorkTypeId, AccountCostCenterId, TimesheetPeriodType, PeriodStartDate, PeriodEndDate, AccountEmployeeTimeEntryPeriodId, False, System.Guid.Empty, System.Guid.Empty, System.Guid.Empty, 0)
    ...
    Public Function AddAccountEmployeeTimeEntry( _
        ...
        Try
            ...
            BillingRateExchangeRate, EmployeeRateExchangeRate, AccountBaseCurrencyId, AccountEmployeeTimeEntryApprovalProjectId, Percentage, Hours, _
    ...
    Public Function UpdateAccountEmployeeTimeEntry( _
        ...
        Try
            ...
            BillingRate, EmployeeRate, BillingRateCurrencyId, EmployeeRateCurrencyId, _
            BillingRateExchangeRate, EmployeeRateExchangeRate, AccountBaseCurrencyId, AccountEmployeeTimeEntryApprovalProjectId, Original_AccountEmployeeTimeEntryId, Percentage, Hours, _
            CustomField1, CustomField2, CustomField3, CustomField4, CustomField5, CustomField6, CustomField7, _
            CustomField8, CustomField9, CustomField10, CustomField11, CustomField12, CustomField13, CustomField14, CustomField15)
            Me.AfterUpdate(TimeEntryDate)
        ...
        If Not IsDBNull(Original_AccountEmployeeTimeEntryPeriodId) Then
            If Original_AccountEmployeeTimeEntryPeriodId <> System.Guid.Empty Then
                If Original_TimeEntryViewType <> "" Then
                    Me.DeleteAccountEmployeeTimeEntryApprovalProject(Original_AccountEmployeeTimeEntryApprovalProjectId)
                    Me.DeleteAccountEmployeeTimeEntryPeriod(Original_AccountEmployeeId, Original_TimeEntryStartDate, Original_TimeEntryEndDate, Original_TimeEntryViewType, Original_AccountEmployeeTimeEntryPeriodId)
                End If
                Me.AfterUpdate()
                Return 1
            End If
    ...
    Public Sub DeleteAccountEmployeeTimeEntryWithTimeOffHoursDeduction(ByVal AccountEmployeeTimeEntryId As Integer)
        ...
        If IsTimeOff And Approved Then
            Me.UpdateEmployeeTimeOffHours(AccountEmployeeId, AccountTimeOffTypeId, TotalTime)
        End If
        If IsTimeOff = False And Percentage <> 0 Then
    ...
    Public Sub DeleteAccountEmployeeTimeEntryTimeOffRequest(ByVal AccountEmployeeTimeEntryId As Integer)
        ...
        If dt.Rows.Count > 0 Then
            ...
            If Not IsDBNull(dr.Item("AccountEmployeeTimeOffRequestId")) Then
                Call New AccountEmployeeTimeOffRequestBLL().DeleteAccountEmployeeTimeOffRequest(dr.AccountEmployeeTimeOffRequestId)
            End If
        End If
    End Sub
    ''' <summary>
    ...
    Public Function GetAccountEmployeeTimeEntriesForPeriodView(ByVal AccountEmployeeId As Integer, ByVal TimeEntryStartDate As Date, ByVal TimeEntryEndDate As Date, ByVal AccountEmployeeTimeEntryPeriodId As Guid, Optional ByVal IsCopy As Boolean = False, Optional ByVal CopyToStartDate As Date = #1/1/2010#, Optional ByVal CopyToEndDate As Date = #1/7/2010#, Optional ByVal IsFromMobileTimeSheet As Boolean = False) As DataView
        ...
        AccountEmployeeId, TimeEntryStartDate, TimeEntryEndDate, CopyToStartDate, CopyToEndDate, IsFromMobileTimeSheet)
        Dim dv As DataView
    ...
    ByVal TimeEntryStartDate As Date, ByVal TimeEntryEndDate As Date, ByVal CopyToStartDate As Date, ByVal CopyToEndDate As Date, Optional ByVal IsFromMobileTimeSheet As Boolean = False)
        If IsCopy <> True Then
            WorkingDays = DateTimeUtilities.GetWorkingDays(AccountEmployeeId, TimeEntryStartDate, TimeEntryStartDate, TimeEntryEndDate)
            WorkingDaysCount = WorkingDays.Count
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub SendPendingTimesheet(ByVal AccountEmployeeId As Integer)

        Dim BLL As New AccountEmployeeTimeEntryBLL

        Dim dtPendingApprovals As TimeLiveDataSet.vueAccountEmployeeTimeEntryApprovalPendingEmailWithPreferenceDataTable = BLL.GetPendingTimeEntryApprovalsWithPreferenceByApproverEmployeeIdForEmail(AccountEmployeeId)
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub SendTimesheetPendingEMail(ByVal AccountEmployeeId As Integer)

        SendPendingTimesheet(AccountEmployeeId)
    ...
    ''' <param name="EmailAddress"></param>
    ''' <remarks></remarks>
    Public Sub SendPendingTimeEntry(ByVal AccountId As Integer, ByVal AccountEmployeeId As Integer, ByVal EmployeeName As String, ByVal EmailAddress As String, ByVal CultureName As String, Optional ByVal SystemTimesheetPeriodTypeEmail As String = "", _
    Optional ByVal EmployeeWeekStartDayEmail As Integer = 0, Optional ByVal SystemInitialDayOfFirstPeriodEmail As Integer = 0, Optional ByVal SystemInitialDayOfLastPeriodEmail As Integer = 0, Optional ByVal InitialDayOfTheMonthEmail As Integer = 0)
        ...
        Dim WorkingDaysArray As ArrayList = DateTimeUtilities.GetWorkingDays(AccountEmployeeId, Date.Now.Date, Date.Now.Date, Date.Now.Date, True, SystemTimesheetPeriodTypeEmail, EmployeeWeekStartDayEmail, SystemInitialDayOfFirstPeriodEmail, SystemInitialDayOfLastPeriodEmail, InitialDayOfTheMonthEmail)
    ...
    ''' <param name="EmailAddress"></param>
    ''' <remarks></remarks>
    Public Sub SendTimeEntryPendingEMail(ByVal AccountId As Integer, ByVal AccountEmployeeId As Integer, ByVal EmployeeName As String, ByVal EmailAddress As String, ByVal CultureName As String, Optional ByVal SystemTimesheetPeriodTypeEmail As String = "", _
    Optional ByVal EmployeeWeekStartDayEmail As Integer = 0, Optional ByVal SystemInitialDayOfFirstPeriodEmail As Integer = 0, Optional ByVal SystemInitialDayOfLastPeriodEmail As Integer = 0, Optional ByVal InitialDayOfTheMonthEmail As Integer = 0)

        SendPendingTimeEntry(AccountId, AccountEmployeeId, EmployeeName, EmailAddress, CultureName, SystemTimesheetPeriodTypeEmail, EmployeeWeekStartDayEmail, SystemInitialDayOfFirstPeriodEmail, SystemInitialDayOfLastPeriodEmail, InitialDayOfTheMonthEmail)
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function UpdateTimeEntrArchive(ByVal Original_AccountEmployeeTimeEntryId As Integer, _
            ByVal Approved As Boolean, ByVal BillingRate As Decimal, ByVal Submitted As Boolean, ByVal Original_TimeEntryDate As DateTime, _
            ByVal Original_AccountEmployeeId As Integer, ByVal Original_TimeEntryStartDate As Object, ByVal Original_TimeEntryEndDate As Object, ByVal Original_TimeEntryViewType As String, ByVal Original_AccountEmployeeTimeEntryApprovalProjectId As Object, ByVal Original_AccountEmployeeTimeEntryPeriodId As Object) As Boolean
        ...
        If Not IsDBNull(Original_AccountEmployeeTimeEntryPeriodId) Then
            AccountEmployeeTimeEntries = Adapter.GetDataByAccountEmployeeTimeEntryPeriodId(Original_AccountEmployeeTimeEntryPeriodId)
        Else
        ...
        '= AccountEmployeeTimeEntries.Rows(0)
        ...
        Next
        If Not IsDBNull(Original_AccountEmployeeTimeEntryPeriodId) Then
            If TimeEntryPeriodApproved <> True Then
    ...
    ''' <remarks></remarks>
    Public Sub SendPendingTimeEntryForADMINAndPMAndTLAndEM(ByVal AccountId As Integer, ByVal AccountEmployeeId As Integer, ByVal EmployeeName As String, ByVal EmailAddress As String, ByVal PendingEmailType As String, ByVal CultureInfoName As String)
        Dim EmployeeBLL As New AccountEmployeeBLL
        ...
        If dtEmployees.Rows.Count > 0 Then
            ...
            For Each drEmployees In dtEmployees.Rows
                WorkingDaysArray = DateTimeUtilities.GetWorkingDays(drEmployees.AccountEmployeeId, Date.Now.Date, Date.Now.Date, Date.Now.Date, True, IIf(Not IsDBNull(drEmployees.Item("SystemTimesheetPeriodType")), drEmployees.Item("SystemTimesheetPeriodType"), "Weekly"), IIf(Not IsDBNull(drEmployees.Item("EmployeeWeekStartDay")), drEmployees.Item("EmployeeWeekStartDay"), 1), drEmployees.SystemInitialDayOfFirstPeriod, drEmployees.SystemInitialDayOfLastPeriod, drEmployees.InitialDayOfTheMonth)
                If WorkingDaysArray.Count > 0 Then
    ...
    ''' <param name="CultureInfoName"></param>
    ''' <remarks></remarks>
    Public Sub SendTimeEntryPendingEMailForADMINAndPMAndTLAndEM(ByVal AccountId As Integer, ByVal AccountEmployeeId As Integer, ByVal EmployeeName As String, ByVal EmailAddress As String, ByVal PendingEmailType As String, ByVal CultureInfoName As String)
        SendPendingTimeEntryForADMINAndPMAndTLAndEM(AccountId, AccountEmployeeId, EmployeeName, EmailAddress, PendingEmailType, CultureInfoName)
    End Sub
    ''' <summary>
    ...
    ''' <param name="CultureInfoName"></param>
    ''' <remarks></remarks>
    Public Sub SendTimesheetOverdueNotification(ByVal AccountId As Integer, ByVal AccountEmployeeId As Integer, ByVal EmployeeName As String, ByVal EmailAddress As String, ByVal PendingEmailType As String, ByVal CultureInfoName As String)
        Dim EmployeeBLL As New AccountEmployeeBLL
        ...
        If dtEmployees.Rows.Count > 0 Then
            ...
            For Each drEmployees In dtEmployees.Rows
                ...
                TimesheetPeriodDaysArray = DateTimeUtilities.GetPeriodStartAndEndDate(drEmployees.AccountEmployeeId, Now.Date, Now.Date, Now.Date, True, IIf(Not IsDBNull(drEmployees.Item("SystemTimesheetPeriodType")), drEmployees.Item("SystemTimesheetPeriodType"), "Weekly"), IIf(Not IsDBNull(drEmployees.Item("EmployeeWeekStartDay")), drEmployees.Item("EmployeeWeekStartDay"), 1), drEmployees.SystemInitialDayOfFirstPeriod, drEmployees.SystemInitialDayOfLastPeriod, drEmployees.InitialDayOfTheMonth)
    ...
    Public Function IsCurrentTimesheetOverdue(AccountEmployeeId As Integer, UserCurrentDateTime As Date, TimesheetOverdueAfterDays As Short, SystemTimesheetPeriodType As String, EmployeeWeekStartDay As Integer, SystemInitialDayOfFirstPeriod As Integer, SystemInitialDayOfLastPeriod As Integer, InitialDayOfTheMonth As Integer) As Boolean
        Dim WorkingDaysArray As ArrayList
        WorkingDaysArray = Me.GetWorkingDays(AccountEmployeeId, Now.Date, Now.Date, Now.Date, True, SystemTimesheetPeriodType, EmployeeWeekStartDay, SystemInitialDayOfFirstPeriod, SystemInitialDayOfLastPeriod, InitialDayOfTheMonth)
        If WorkingDaysArray.Count > 0 Then
    ...
    Public Sub SendTimesheetdueNotification(ByVal AccountId As Integer, ByVal AccountEmployeeId As Integer, _
                                            ...
                                            SystemTimesheetPeriodType As String, EmployeeWeekStartDay As Integer, _
                                            SystemInitialDayOfFirstPeriod As Integer, SystemInitialDayOfLastPeriod As Integer, _
                                            InitialDayOfTheMonth As Integer, TimesheetOverduePeriods As Short, MinimumHoursPerWeek As Double)
        Dim EmployeeBLL As New AccountEmployeeBLL
        Dim strTable As String = ""
        Dim WorkingDaysArray As ArrayList
        Dim TimesheetPeriodDaysArray As ArrayList
    ...
    Public Function IsCurrentTimesheetdue(AccountEmployeeId As Integer, UserCurrentDateTime As Date, SystemTimesheetPeriodType As String, EmployeeWeekStartDay As Integer, SystemInitialDayOfFirstPeriod As Integer, SystemInitialDayOfLastPeriod As Integer, InitialDayOfTheMonth As Integer) As Boolean
        Dim WorkingDaysArray As ArrayList
        WorkingDaysArray = DateTimeUtilities.GetWorkingDays(AccountEmployeeId, Now.Date, Now.Date, Now.Date, True, SystemTimesheetPeriodType, EmployeeWeekStartDay, SystemInitialDayOfFirstPeriod, SystemInitialDayOfLastPeriod, InitialDayOfTheMonth)
        If WorkingDaysArray.Count > 0 Then
            Dim dtdate As Date = WorkingDaysArray(WorkingDaysArray.Count - 1)
            If UserCurrentDateTime.Date = dtdate.Date Then
                Return True
