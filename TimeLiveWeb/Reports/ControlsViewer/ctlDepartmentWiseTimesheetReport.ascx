<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlDepartmentWiseTimesheetReport.ascx.vb" Inherits="Reports_ControlsViewer_ctlDepartmentWiseTimesheetReport" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table class="xFormView" style="width: 350px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Department Wise Timesheet Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Employees:%> " /></td>
                <td style="width: 60%">
                    <asp:DropDownList ID="ddlEmployees" runat="server" AppendDataBoundItems="True" Height="22px" Width="186px" DataTextField="EmployeeName" DataValueField="AccountEmployeeId">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Project:%> " /></td>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:TimeLive.Web, Location:%> " /></td>
                <td style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:TimeLive.Web, Submitted:%> " /></td>
                <td style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:TimeLive.Web, Billable:%> " /></td>
                <td style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal12" runat="server" Text="<%$ Resources:TimeLive.Web, Start Date:%> " /></td>
                <td style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal13" runat="server" Text="<%$ Resources:TimeLive.Web, End Date:%> " /></td>
                <td style="width: 60%">
        ...
        <asp:ObjectDataSource ID="dsEmployee" runat="server" DeleteMethod="DeleteAccountEmployee"
            ...
            UpdateMethod="UpdateUsernameOfExistingEmployee">
            <DeleteParameters>
        ...
        <asp:ObjectDataSource ID="dsProjectsObject" runat="server" DeleteMethod="DeleteAccountProject"
            ...
            <SelectParameters>
                <asp:SessionParameter Name="AccountEmployeeId" SessionField="AccountEmployeeId" Type="Int32" DefaultValue="39" />
            </SelectParameters>
            <InsertParameters>
                <asp:Parameter Name="AccountId" Type="Int32" />
