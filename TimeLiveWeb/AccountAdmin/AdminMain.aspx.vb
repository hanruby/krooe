...
Partial Class AccountAdmin_AdminMain
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.HyperLink73.ToolTip = ResourceHelper.GetFromResource("Tax Code")
        Me.HyperLink73.Text = ResourceHelper.GetFromResource("Tax Code")
        ...
        Me.HyperLink61.ToolTip = ResourceHelper.GetFromResource("Tax Zone")
        Me.HyperLink74.ToolTip = ResourceHelper.GetFromResource("Tax Zone")
        Me.HyperLink74.Text = ResourceHelper.GetFromResource("Tax Zone")
