<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountWorkTypeList, App_Web_j1ru2ref" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Caption= '<%# ResourceHelper.GetFromResource("Work Type List") %>'
            ...
            <Columns>
                <asp:TemplateField InsertVisible="False" SortExpression="AccountWorkTypeId">
                    <edititemtemplate>
...
<asp:Label id="Label2" runat="server" Text='<%# Bind("SortOrder") %>' __designer:wfdid="w65"></asp:Label> 
                ...
                <asp:TemplateField SortExpression="AccountWorkTypeCode">
                    <edititemtemplate>
...
<asp:Label id="Label3" runat="server" Text='<%# Bind("AccountWorkTypeCode") %>' __designer:wfdid="w68"></asp:Label> 
                ...
                <asp:TemplateField SortExpression="AccountWorkType">
                    <edititemtemplate>
...
<asp:Label id="Label4" runat="server" Text='<%# Bind("AccountWorkType") %>' __designer:wfdid="w71"></asp:Label> 
                ...
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Edit_text %>" ShowHeader="False">
                    <itemtemplate>
<asp:LinkButton id="LinkButton2" runat="server" CausesValidation="False" CommandName="Select" ToolTip="<%$ Resources:TimeLive.Web, Edit_text%> " Text="<%$ Resources:TimeLive.Web, Edit_text%> " __designer:wfdid="w17" ></asp:LinkButton>
</itemtemplate>
                    <headerstyle horizontalalign="Center" verticalalign="Middle" />
                ...
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Delete_text %>" ShowHeader="False">
                    <itemtemplate>
<asp:LinkButton id="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" ToolTip="<%$ Resources:TimeLive.Web, Delete_text%> " Text="<%$ Resources:TimeLive.Web, Delete_text%> " __designer:wfdid="w81" OnClientClick='<%# ResourceHelper.GetDeleteMessageJavascript()%>'></asp:LinkButton> 
</itemtemplate>
                    <headerstyle horizontalalign="Center" verticalalign="Middle" />
                ...
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Disabled_text %>">
                    <headertemplate>
<asp:Image id="Image2" runat="server" __designer:wfdid="w80" ImageUrl="~/Images/Disabled.gif" ToolTip="<%$ Resources:TimeLive.Web, Disabled_text%> "></asp:Image> 
</headertemplate>
                    <itemtemplate>
<asp:Image id="Image1" runat="server" __designer:wfdid="w79" ImageUrl="~/Images/Disabled.gif" ToolTip="<%$ Resources:TimeLive.Web, Disabled_text%> " Visible='<%# IIF(IsDBNull(Eval("IsDisabled")),"False",Eval("IsDisabled")) %>'></asp:Image> 
</itemtemplate>
                    <headerstyle horizontalalign="Center" verticalalign="Middle" />
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="AccountWorkTypeId" DataSourceID="dsAccountWorkTypeFormViewObject" SkinID="formviewskinemployee"
            DefaultMode="Insert" Width="350px">
            <EditItemTemplate>
                <table class="xview" width="100%">
                    <tr>
                        <td colspan="2" class="caption">
                        <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Work Type List:")%> ' /></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="FormViewSubHeader">
                        <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Work Type:")%> ' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewLabelCell" style="width: 40%">
                            
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="txtSortOrder">
                            <asp:Literal ID="Literal9" runat="server" Text='<%# ResourceHelper.GetFromResource("Sort Order:")%> ' /></asp:Label></td>
                        <td style="width: 60%">
                            <asp:TextBox ID="txtSortOrder" runat="server" MaxLength="10" Text='<%# Bind("SortOrder") %>'
...
<asp:Label ID="Label5" runat="server" AssociatedControlID="AccountWorkTypeCodeTextBox">
                  <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Work Type Code:")%> ' /></asp:Label></td>
                        <td style="width: 60%">
                <asp:TextBox ID="AccountWorkTypeCodeTextBox" runat="server" Text='<%# Bind("AccountWorkTypeCode") %>' Width="40px" MaxLength="3"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="AccountWorkTypeCodeTextBox"
                                Display="Dynamic" ErrorMessage="*" Width="0px"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td style="width: 40%" class="FormViewLabelCell">
                            <SPAN 
...
<asp:Label ID="Label8" runat="server" AssociatedControlID="AccountWorkTypeTextBox">
                  <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Work Type:")%> ' /></asp:Label></td>
                        <td style="width: 60%">
                <asp:TextBox ID="AccountWorkTypeTextBox" runat="server" Text='<%# Bind("AccountWorkType") %>' Width="150px" MaxLength="50"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="AccountWorkTypeTextBox"
                                Display="Dynamic" ErrorMessage="*" Width="0px"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td style="width: 40%" class="FormViewLabelCell">
            ...
            <InsertItemTemplate>
                <table class="xview" width="100%">
                    <tr>
                        ...
                        <asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("Work Type Information")%> ' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="2">
                            <asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Working Type")%> ' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewLabelCell" style="width: 40%">
...
<asp:Label ID="Label6" runat="server" AssociatedControlID="AccountWorkTypeCodeTextBox">
                   <asp:Literal ID="Literal7" runat="server" Text='<%# ResourceHelper.GetFromResource("Work Type Code:")%> ' /></asp:Label></td>
                        <td style="width: 60%">
                            <asp:TextBox ID="AccountWorkTypeCodeTextBox" runat="server" Text='<%# Bind("AccountWorkTypeCode") %>' Width="40px" MaxLength="3"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="AccountWorkTypeCodeTextBox"
                                Display="Dynamic" ErrorMessage="*" Width="0px"></asp:RequiredFieldValidator></td>
...
<asp:Label ID="Label7" runat="server" AssociatedControlID="AccountWorkTypeTextBox">
                  <asp:Literal ID="Literal8" runat="server" Text='<%# ResourceHelper.GetFromResource("Work Type:")%> ' /></asp:Label></td>
                        <td style="width: 60%">
                            <asp:TextBox ID="AccountWorkTypeTextBox" runat="server" Text='<%# Bind("AccountWorkType") %>' Width="150px" MaxLength="50"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="AccountWorkTypeTextBox"
                                Display="Dynamic" ErrorMessage="*" Width="0px"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td style="width: 40%">
                        ...
                        <td style="width: 60%">
                            <asp:Button ID="btnAdd" runat="server" Text="<%$ Resources:TimeLive.Web, Add_Text%> " Width="68px" CommandName="Insert" /></td>
                    </tr>
                </table>
            </InsertItemTemplate>
            <ItemTemplate>
                AccountWorkTypeId:
                <asp:Label ID="AccountWorkTypeIdLabel" runat="server" Text='<%# Eval("AccountWorkTypeId") %>'>
                </asp:Label><br />
                AccountWorkTypeCode:
                <asp:Label ID="AccountWorkTypeCodeLabel" runat="server" Text='<%# Bind("AccountWorkTypeCode") %>'>
                </asp:Label><br />
                AccountWorkType:
                <asp:Label ID="AccountWorkTypeLabel" runat="server" Text='<%# Bind("AccountWorkType") %>'>
                </asp:Label><br />
                SystemWorkTypeId:
                <asp:Label ID="SystemWorkTypeIdLabel" runat="server" Text='<%# Bind("SystemWorkTypeId") %>'>
                </asp:Label><br />
                AccountId:
