...
Public Class ResourceHelper
    Public Shared Function GetDeleteMessageJavascript() As String
        Return "return confirm('" & Resources.TimeLive.Web.Delete_cofirmation & "');"
    End Function
    ...
    Public Shared Function GetSaveMessageJavascriptForDayView() As String
        Return "return alert('" & Resources.TimeLive.Web.Save_Confirmation_DayView & "');"
    End Function
    ...
    Public Shared Function GetSaveMessageJavascriptForInvoice() As String
        Return "return alert('" & Resources.TimeLive.Web.save_confirmation_Invoice & "');"
    End Function
    Public Shared Function GetCopyMessageJavascriptForDayView() As String
        Return "return confirm('" & Resources.TimeLive.Web.Copy_Conformation_Message_DayView & "');"
    End Function
    Public Shared Function GetCopyMessageJavascriptForWeekView() As String
        Return "return confirm('" & Resources.TimeLive.Web.Copy_Conformation_Message_WeekView & "');"
    End Function
    Public Shared Function GetCopyMessageJavascriptForHolidayType() As String
        Return "return confirm('" & Resources.TimeLive.Web.Copy_Conformation_Message_DayView1 & "');"
    End Function
    Public Shared Function GetPopulateMessageJavascriptForInvoice() As String
        Return "return confirm('" & Resources.TimeLive.Web.Populate_Conformation_Message_Invoice & "');"
    End Function
    ...
    Public Shared Function TransformToTerminology(ByVal Value As String, Optional ByVal AccountId As Integer = 0) As String
        ...
        Dim Name As String = System.Web.HttpContext.GetGlobalResourceObject("TimeLive.Web", TransformValue)
