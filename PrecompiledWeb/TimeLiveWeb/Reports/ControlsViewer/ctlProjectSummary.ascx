<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsViewer_ctlProjectSummaryReport, App_Web_iqmrpsj3" %>
        ...
        <table class="xFormView" style="width: 700px">
            <tr>
                <td class="caption" colspan="2" style="height: 1px">
                    <asp:Literal ID="Literal13" runat="server" Text="<%$ Resources:TimeLive.Web, Project Activity Summary Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="FormViewLabelCellWithBorder" style="width: 30%">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Projects:%> " /></td>
            ...
            <tr>
                <td align="right" class="FormViewLabelCellWithBorder" style="width: 30%"><asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:TimeLive.Web, Date Range:%> " /></td>
                <td align="left" style="width: 70%">
                    <table class="xTableWithoutBorder" width="100%">
                        <tr>
                            <td class="FormViewLabelCellBold" style="width: 25%">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Start Date:%> " /></td>
                            <td style="width: 75%">
                    ...
                    <asp:DropDownList ID="ddlApproved" runat="server" AppendDataBoundItems="True" Visible="False" Width="45px">
                        ...
                        <tr>
                            <td class="FormViewLabelCellBold" style="width: 25%">
                                <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, End Date:%> " /></td>
                            <td style="width: 75%">
