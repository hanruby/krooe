...
Imports System
Namespace dsEmployeeAttendanceSummaryReportTableAdapters
    Partial Public Class vueAccountAttendanceTableAdapter



        Public Function GetDataForEmployeeAttendanceSummaryReport(ByVal AccountId As Integer, ByVal AccountEmployees As String, ByVal AttendanceStartDate As Date, ByVal AttendanceEndDate As Date) As dsEmployeeAttendanceSummaryReport.vueAccountAttendanceDataTable
            Dim sql As String
            ...
            Dim dataTable As dsEmployeeAttendanceSummaryReport.vueAccountAttendanceDataTable = New dsEmployeeAttendanceSummaryReport.vueAccountAttendanceDataTable
