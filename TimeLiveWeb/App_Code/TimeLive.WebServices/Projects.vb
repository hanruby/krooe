...
Public Class Projects
    ...
    Public Function GetProjects() As ArrayList
        ...
        Dim dtProject As TimeLiveDataSet.vueAccountProjectsDataTable = ProjectBLL.GetAccountProjectsForGridView(AccountId, False)
    ...
    ByVal Completed As Boolean)
        ...
        Else
            ...
            ModifiedOn, ModifiedByEmployeeId, Completed)
        End If
    End Sub
    <WebMethod()> _
    <System.Web.Services.Protocols.SoapHeader("SoapHeader")> _
