<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountCostCenterList, App_Web_yhen42r4" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountCostCenterId" SkinID="xgridviewskinemployee" Caption='<%# ResourceHelper.GetFromResource("Cost Center List") %>'
            ...
            <Columns>
                <asp:BoundField DataField="AccountCostCenterId" HeaderText="<%$ Resources:TimeLive.Web, Id %>" InsertVisible="False"
                    ReadOnly="True" SortExpression="AccountCostCenterId">
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" />
                </asp:BoundField>
                <asp:BoundField DataField="SortOrder" HeaderText="<%$ Resources:TimeLive.Web, Sort Order %>" SortExpression="SortOrder">
                    <itemstyle width="10%" />
                </asp:BoundField>
                <asp:TemplateField SortExpression="AccountCostCenterCode">
                    <edititemtemplate>
...
<asp:Label id="Label1" runat="server" __designer:wfdid="w33" Text='<%# Bind("AccountCostCenterCode") %>'></asp:Label>
                ...
                <asp:TemplateField SortExpression="AccountCostCenter">
                    <edititemtemplate>
...
<asp:LinkButton id="LinkButton2" runat="server" CausesValidation="False" CommandName="Select" 
                            ToolTip="<%$ Resources:TimeLive.Web, Edit_text %>" Text="Edit" 
                            __designer:wfdid="w1"></asp:LinkButton>
</itemtemplate>
                    <itemstyle cssclass="edit_button" width="5%" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Delete_text %>" >
                    <ItemTemplate>
<asp:LinkButton id="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete" ToolTip="<%$ Resources:TimeLive.Web, Delete_text%> " Text="Delete" __designer:wfdid="w2" Visible='<%# IsDBNull(Eval("MasterCostCenterId")) %>' OnClientClick='<%# ResourceHelper.GetDeleteMessageJavascript()%>'></asp:LinkButton> 
</ItemTemplate>
                    <ItemStyle Width="5%" cssclass="delete_button" />
                </asp:TemplateField>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="AccountCostCenterId" DataSourceID="dsAccountCostCenterFormViewObject" DefaultMode="Insert" SkinID="FormViewSkinEmployee">
            <EditItemTemplate><table width="500" class="xview">
                <tr>
                    <td colspan="2" class="caption">
                        <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Cost Center Information")%> ' /></td>
                </tr>
                <tr>
                    <td colspan="2" class="FormViewSubHeader">
                        <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Cost Center")%> ' /></td>
                </tr>
                <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="txtSortOrder">
                        <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:TimeLive.Web, Sort Order:%> " /></asp:Label></td>
...
<asp:Label ID="Label4" runat="server" AssociatedControlID="CostCenterCodeTextBox">
                  <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Cost Center Code:")%> ' /></asp:Label></td>
                    <td style="width: 300px">
                        <asp:TextBox ID="CostCenterCodeTextBox" runat="server" Text='<%# Bind("AccountCostCenterCode") %>'
                            Width="59px" MaxLength="7"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="CostCenterCodeTextBox"
...
<asp:Label ID="Label6" runat="server" AssociatedControlID="CostCenterTextBox">
                  <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Cost Center:")%> ' /></asp:Label></td>
                    <td style="width: 300px">
                        <asp:TextBox ID="CostCenterTextBox" runat="server" Text='<%# Bind("AccountCostCenter") %>'
                            Width="178px" MaxLength="50"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="CostCenterTextBox"
                            CssClass="ErrorMessage" ErrorMessage="*"></asp:RequiredFieldValidator></td>
                </tr>
                <tr style="color: #000000">
                    <td align="right" class="FormViewLabelCell" style="width: 200px">
                        <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Disabled:%> " /></td>
                    <td style="width: 300px">
                ...
                <tr>
                    ...
                    <td style="width: 300px">
                        <asp:Button ID="btnUpdate" runat="server" Text="<%$ Resources:TimeLive.Web, Update_text%> " CommandName="Update" Width="68px" />
                        <asp:Button ID="btnCancel" runat="server" Text="<%$ Resources:TimeLive.Web, Cancel_text%> " CommandName="Cancel" ValidationGroup="Cost" Width="68px" /></td>
                </tr>
            </table>
            </EditItemTemplate>
            <InsertItemTemplate>
                <table width="500" class="xview">
                    <tr>
                        <td colspan="2" class="caption">
                            <asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("Cost Center Information")%> ' /></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="FormViewSubHeader">
                            <asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Cost Center") %>' /></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 200px">
...
<asp:Label ID="Label3" runat="server" AssociatedControlID="CostCenterCodeTextBox">
                  <asp:Literal ID="Literal7" runat="server" Text='<%# ResourceHelper.GetFromResource("Cost Center Code:")%> ' /></asp:Label></td>
                        <td style="width: 300px">
                            <asp:TextBox ID="CostCenterCodeTextBox" runat="server" Text='<%# Bind("AccountCostCenterCode") %>'
                                Width="59px" MaxLength="7"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="CostCenterCodeTextBox"
...
<asp:Label ID="Label5" runat="server" AssociatedControlID="CostCenterTextBox">
                  <asp:Literal ID="Literal8" runat="server" Text='<%# ResourceHelper.GetFromResource("Cost Center:")%> ' /></asp:Label></td>
                        <td style="width: 300px">
                            <asp:TextBox ID="CostCenterTextBox" runat="server" Text='<%# Bind("AccountCostCenter") %>'
                                Width="178px" MaxLength="50"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="CostCenterTextBox"
