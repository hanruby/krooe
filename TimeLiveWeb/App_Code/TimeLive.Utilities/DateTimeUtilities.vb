...
Public Module DateTimeUtilities
    ...
    Public Function GetStartDateOfSemiMonthly(ByVal dtDate As Date, ByVal InitialDayOfFirstPeriod As Integer, ByVal InitialDayOfLastPeriod As Integer) As Date
        ...
        If dtDate.Day >= InitialDayOfFirstPeriod And dtDate.Day < InitialDayOfLastPeriod Then
            dtStartDate = DateSerial(dtDate.Year, dtDate.Month, InitialDayOfFirstPeriod)
        Else
            dtStartDate = DateSerial(dtDate.Year, dtDate.Month, InitialDayOfLastPeriod)
        End If
        If dtStartDate > dtDate Then
            dtStartDate.AddDays(-InitialDayOfLastPeriod + InitialDayOfFirstPeriod)
        End If
        Return dtStartDate
    End Function
    ...
    Public Function GetEndDateOfWeekBiWeekly(ByVal dtDate As Date, ByVal WeekStartDay As Integer) As Date
        ...
        Return dtEndDate
    End Function
    Public Function GetEndDateOfSemiMonthly(ByVal dtDate As Date, ByVal InitialDaysOfFirstPeriod As Integer, ByVal InitialDayOfLastPeriod As Integer) As Date
        Dim dtEndDate As Date
        If dtDate.Day >= InitialDaysOfFirstPeriod And dtDate.Day < InitialDayOfLastPeriod Then
            dtEndDate = DateSerial(dtDate.Year, dtDate.Month, InitialDayOfLastPeriod - 1)
        Else
            Dim dtStartDate As Date = GetStartDateOfSemiMonthly(dtDate, InitialDaysOfFirstPeriod, InitialDayOfLastPeriod)
            dtEndDate = DateAdd(DateInterval.Day, -1, DateAdd(DateInterval.Month, 1, DateSerial(dtDate.Year, dtDate.Month, InitialDaysOfFirstPeriod)))
        End If
        Return dtEndDate
    End Function
