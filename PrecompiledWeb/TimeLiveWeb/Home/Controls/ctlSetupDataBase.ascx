<%@ control language="VB" autoeventwireup="false" inherits="Home_Controls_ctlSetupDataBase, App_Web_zvpgekji" %>
<br />
<table class="xFormView" width="90%" align="center">
    <tr>
        <td class="caption" colspan="2">
            Database Setup Information</td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="FormViewSubHeader" colspan="2" style="height:40px;">
    ...
    <tr>
        ...
        <td style="width: 75%; height: 35px;">
            <asp:Button ID="btnCreateDatabase" runat="server" Text="Create Database and populate schema" Width="220px" Visible="False" />
