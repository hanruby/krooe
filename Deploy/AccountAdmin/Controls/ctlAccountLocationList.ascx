<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountLocationList, App_Web_yhen42r4" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountLocationId"
            ...
            <Columns>
                <asp:BoundField DataField="AccountLocationId" HeaderText="<%$ Resources:TimeLive.Web, Id %>" InsertVisible="False"
...
<asp:Label id="Label1" runat="server" Text='<%# Bind("AccountLocation") %>' __designer:wfdid="w30"></asp:Label>
                ...
                <asp:CommandField HeaderText="<%$ Resources:TimeLive.Web, Edit_Text %>" SelectText="Edit" ShowSelectButton="True" >
                    ...
                    <ItemStyle HorizontalAlign="Center" cssclass="edit_button" Width="5%" />
                </asp:CommandField>
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="AccountLocationId" DataSourceID="dsAccountLocationFormObject"
            ...
            <EditItemTemplate> 
                <table  width="100%" class="xview">
                    <tr>
                        <td class="caption" colspan="2" style="width: 20%; height: 21px">
                            <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Location Information")%> ' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="2" style="width: 20%; height: 21px">
                            <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Location")%> ' /></td>
                    </tr>
                    <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="AccountLocationTextBox">
                  <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Location:")%> ' /></asp:Label></td>
                        <td style="width: 75%; height: 26px;">
                            <asp:TextBox ID="AccountLocationTextBox" runat="server" Text='<%# Bind("AccountLocation") %>' MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator
                    ...
                    <tr>
                        ...
                        <td style="width: 75%; height: 26px;">
                            <asp:Button ID="Update" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text%> " Width="68px" />
                            <asp:Button ID="Cancel" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%> " Width="68px" /></td>
                    </tr>
                </table>
            </EditItemTemplate>
            <InsertItemTemplate>
                <table width="100%" class="xview">
                    ...
                    <tr>
                        ...
                        <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Location")%> ' /></td>
                    </tr>
                    <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="AccountLocationTextBox">
                  <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Location:")%> ' /></asp:Label></td>
                        <td style="width: 75%; height: 26px;">
                            <asp:TextBox ID="AccountLocationTextBox" runat="server" Text='<%# Bind("AccountLocation") %>' MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator
                                ID="RequiredFieldValidator1" runat="server" ControlToValidate="AccountLocationTextBox"
                                Display="Dynamic" ErrorMessage="*"></asp:RequiredFieldValidator></td>
            ...
            <ItemTemplate>
                AccountLocationId:
                <asp:Label ID="AccountLocationIdLabel" runat="server" Text='<%# Eval("AccountLocationId") %>'>
                </asp:Label><br />
                AccountId:
                <asp:Label ID="AccountIdLabel" runat="server" Text='<%# Bind("AccountId") %>'></asp:Label><br />
                AccountLocation:
                <asp:Label ID="AccountLocationLabel" runat="server" Text='<%# Bind("AccountLocation") %>'>
                </asp:Label><br />
