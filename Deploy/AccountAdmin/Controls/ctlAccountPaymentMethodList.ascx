<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountPaymentMethodList, App_Web_yhen42r4" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Caption='<%# ResourceHelper.GetFromResource("Payment Method") %>' DataKeyNames="AccountPaymentMethodId" DataSourceID="dsAccountPaymentMethodGridViewObject" SkinID="xgridviewSkinEmployee" Width="98%">
            <Columns>
                <asp:TemplateField InsertVisible="False" SortExpression="AccountPaymentMethodId">
                    <edititemtemplate>
                ...
                <table width="450" class="xview">
                    <tr>
                        <td class="caption" colspan="2">
                            <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Payment Method Information")%> ' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="2">
                            <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Payment Method")%> ' /></td>
                    </tr>
                    <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="PaymentMethodTextBox">
                  <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Payment Method:")%> ' /></asp:Label></td>
                        <td style="width: 65%">
                            <asp:TextBox ID="PaymentMethodTextBox" runat="server" Text='<%# Bind("PaymentMethod") %>'></asp:TextBox><ew:requiredfieldvalidator
                                id="RequiredFieldValidator1" runat="server" controltovalidate="PaymentMethodTextBox"
                                cssclass="ErrorMessage" display="Dynamic" errormessage="*" ValidationGroup="I"></ew:requiredfieldvalidator></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 35%">
                    ...
                    <tr>
                        ...
                        <td style="width: 65%">
                            <asp:Button ID="btnUpdate" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text%>" Width="68px" /><asp:Button
                                ID="btnCancel" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%>" Width="68px" /><asp:Label
                ...
                <table width="450" class="xview">
                    <tr>
                        <td colspan="2" class="caption">
                            <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Payment Method Information")%> ' /></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="FormViewSubHeader">
                            <asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("Payment Method")%> ' /></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 35%">
                            <SPAN 
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="PaymentMethodTextBox">
                  <asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Payment Method:")%> ' /></asp:Label></td>
                        <td style="width: 65%">
                            <asp:TextBox ID="PaymentMethodTextBox" runat="server" Text='<%# Bind("PaymentMethod") %>'></asp:TextBox><ew:requiredfieldvalidator
                                id="RequiredFieldValidator1" runat="server" controltovalidate="PaymentMethodTextBox"
            ...
            <ItemTemplate>
                ...
                <asp:Label ID="AccountPaymentMethodIdLabel" runat="server" Text='<%# Eval("AccountPaymentMethodId") %>'>
                </asp:Label><br />
                AccountId:
