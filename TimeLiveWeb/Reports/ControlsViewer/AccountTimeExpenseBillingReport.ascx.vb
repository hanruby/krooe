...
Partial Class Reports_ControlsViewer_AccountTimeExpenseBillingReport
    ...
    Public Sub ShowReport(ByVal AccountId As Integer, ByVal AccountTimeExpenseBillingId As Guid)
        If LocaleUtilitiesBLL.ShowEmployeeNameInInvoiceReport = True Then
            ...
            If dsCheckTimesheet.Rows.Count = 0 Then
                ...
                'Report.Bands.AddRange(New DevExpress.XtraReports.UI
                'Else
                '    For Each drchecktimesheet In dsCheckTimesheet.Rows
                '        If DBUtilities.IsInvoiceBillingTypeDaily Then
                '            CType(Report.Bands.Item("Detail").Controls("xrLabel3"), DevExpress.XtraReports.UI.XRLabel).Text = drchecktimesheet.BillHours
                '        Else
                '            CType(Report.Bands.Item("Detail").Controls("xrLabel3"), DevExpress.XtraReports.UI.XRLabel).Text = drchecktimesheet.BillHours
                '        End If
                '    Next
            ...
            SubReport.DataMember = "XtraReport2"
