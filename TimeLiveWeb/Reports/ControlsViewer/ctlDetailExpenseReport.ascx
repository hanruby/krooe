<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlDetailExpenseReport.ascx.vb" Inherits="Reports_ControlsViewer_ctlDetailExpenseReport" %>
        ...
        <table class="xFormView" style="width: 450px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal14" runat="server" Text="<%$ Resources:TimeLive.Web, Detail Expense Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" style="width: 60%">
                    &nbsp;<asp:DropDownList ID="ddlEmployees" runat="server" AppendDataBoundItems="True" DataTextField="EmployeeNameWithCode" DataValueField="AccountEmployeeId"
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Projects:%> " /></td>
                <td align="left" style="width: 60%">
                    &nbsp;<asp:DropDownList ID="ddlProjects" runat="server" AppendDataBoundItems="True" DataTextField="ProjectName" DataValueField="AccountProjectId"
                        Height="22px" Width="186px">
                        <%--<asp:ListItem Selected="True" Value="0">&lt;ALL&gt;</asp:ListItem>--%>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Clients:%> " /></td></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Location:%> " /></td></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Web, Submitted:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:TimeLive.Web, Billable:%> " /></td>
                <td align="left" style="width: 60%">
...
<dxxr:ReportViewer ID="ReportViewer1" runat="server" > <%--Report="<%# New xtrDetailExpenseReport() %>" ReportName="xtrDetailExpenseReport">--%>
</dxxr:ReportViewer>
    </ContentTemplate>
</asp:UpdatePanel>
