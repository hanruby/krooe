<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsViewer_ctlProjectExpenseDetailReport, App_Web_or234bqc" %>
        ...
        <table class="xFormView" style="width: 450px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:TimeLive.Web, Project Expense Detail Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Clients:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Location:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Web, Approved:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:TimeLive.Web, Billable:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:TimeLive.Web, Base Currency:%> " /></td>
                </td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                ...
                <td align="left" style="width: 60%; height: 26px">
                    &nbsp;<asp:Button ID="Show" runat="server" Text="<%$ Resources:TimeLive.Web, Show_text%> " OnClick="Show_Click" /></td>
            </tr>
        </table>
