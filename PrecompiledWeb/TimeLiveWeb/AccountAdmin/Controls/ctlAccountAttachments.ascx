<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountAttachments, App_Web_j1ru2ref" %>
...
<table style="width: 400px" class="xview">
    <tr>
        <td class="caption" colspan="2">
            <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Expense Information%> " /></td>
    </tr>
    <tr>
        <td style="width: 150px" align="right" class="FormViewLabelCell">
            <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Expense Entry Id:%> " /></td>
        </td>
    ...
    <tr>
        <td style="width: 150px" align="right" class="FormViewLabelCell">
            <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Expense Name:%> " /></td>
        </td>
        <td style="width: 250px">
    ...
    <tr>
        <td align="right" class="FormViewLabelCell" style="width: 150px">
            <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Amount:%> " /></td>
        </td>
        <td style="width: 250px">
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            Caption="<%$ Resources:TimeLive.Web, Attachment List%> "  DataKeyNames="AccountAttachmentId" DataSourceID="dsAccountAttachmentsGridViewObject"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="AttachmentName" HeaderText="<%$ Resources:TimeLive.Web, Attachment Name %>"  SortExpression="AttachmentName" >
                    ...
                    <ItemStyle HorizontalAlign="Center" Width="250px" VerticalAlign="Middle" />
                </asp:BoundField>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="AccountAttachmentId" DataSourceID="dsAccountAttachmentsFormViewObject"
            DefaultMode="Insert" SkinID="formviewSkinEmployee" Width="656px">
            <EditItemTemplate>
                AccountAttachmentId:
            ...
            <InsertItemTemplate>
                <table style="width: 100%" class="xview">
                    <tr>
                        ...
                        <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Attachment Information%> " /></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="FormViewSubHeader">
                            <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Attachment%> " /></td>
                    </tr>
                    <tr>
                        <td style="width: 25%" align="right" class="FormViewLabelCell">
                            <SPAN 
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:TimeLive.Web, Attachment Name:%> " /></td>
                        <td style="width: 75%">
                            <asp:TextBox ID="txtAttachmentName" runat="server" ValidationGroup="Attachment" Width="288px" Text='<%# Bind("AttachmentName") %>'></asp:TextBox>
                    ...
                    <tr>
                        <td style="width: 25%" align="right" class="FormViewLabelCell">
                            <SPAN 
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Web, File Path:%> " /></td>
                        <td style="width: 75%">
                            <asp:FileUpload ID="AttachmentFileUpload" runat="server" Width="500px" /></td>
                    </tr>
                    <tr>
                        <td style="width: 25%" align="right" class="FormViewLabelCell">
                        </td>
                        <td style="width: 75%">
                            <asp:Button ID="btnUpload" runat="server" Text="<%$ Resources:TimeLive.Web, Upload_text%> " OnClick="btnUpload_Click" Width="68px" /></td>
                    </tr>
                </table>
            </InsertItemTemplate>
            <ItemTemplate>
