...
Public Class AccountAttachmentsBLL
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetAccountAttachmentsByAccountExpenseEntryId(ByVal AccountExpenseEntryId As Integer, Optional ByVal NotFixTable As Boolean = False) As TimeLiveDataSet.AccountAttachmentsDataTable
   ...
   Public Function AddAccountAttachments( _
                       ByVal AccountAttachmentTypeId As Integer, ByVal AccountExpenseEntryId As Integer, ByVal AttachmentName As String, ByVal AttachmentLocalPath As String _
                   ) As Boolean
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Delete, True)> _
    Public Function FileUpload(ByVal objFileUpload As FileUpload, ByVal AccountAttachmentTypeId As Integer, ByVal AccountExpenseEntryId As Integer, ByVal AccountId As Integer, ByVal AttachmentName As String) As Boolean
        ...
        End If
        Dim strAccountAttachmentsPath As String = strAccountPath & AccountExpenseEntryId & "\"
        ...
        Me.AddAccountAttachments(AccountAttachmentTypeId, AccountExpenseEntryId, AttachmentName, AttachmentLocalPath)
    End Function
