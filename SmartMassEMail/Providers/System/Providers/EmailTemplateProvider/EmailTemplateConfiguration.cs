...
namespace SmartMassEmail.Providers {
	...
	public class EmailTemplateConfiguration {
        ...
        public static EmailTemplateConfiguration GetConfig( )
        {
            //return (EmailQueueConfiguration)ConfigurationSettings.GetConfig("smartMassEmail.providers/emailQueue");
            return (EmailTemplateConfiguration)ConfigurationManager.GetSection("smartMassEmail.providers/emailTemplate");
		}  
