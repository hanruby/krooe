<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlEmployeeAttendanceSummaryReport.ascx.vb" Inherits="Reports_ControlsViewer_ctlEmployeeAttendanceSummaryReport" %>
        ...
        <table class="xFormView" style="width: 400px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Employee Attendance Summary Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" style="width: 60%">
                    <asp:DropDownList ID="ddlEmployees" runat="server"
                        ...
                        Width="186px" AppendDataBoundItems="True">
