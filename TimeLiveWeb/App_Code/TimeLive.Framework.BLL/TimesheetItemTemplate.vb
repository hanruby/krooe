...
Public Class TimesheetItemTemplate
    ...
    Public Property NVColumnName() As String
        ...
        End Set
    End Property
    Public Sub New(ByVal STColumnName As String, ByVal ETColumnName As String, ByVal TTColumnName As String, ByVal MESTColumnName As String, ByVal MEETColumnName As String, ByVal METTColumnName As String, ByVal MEVSTColumnName As String, ByVal MEVETColumnName As String, ByVal MEVTTColumnName As String, ByVal imgStatusColumnName As String, ByVal IsEnable As Boolean, ByVal PColumnName As String, ByVal MEPColumnName As String, ByVal MEVPColumnName As String, ByVal NVColumnName As String)
