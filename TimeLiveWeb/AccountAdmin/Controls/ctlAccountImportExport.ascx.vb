Partial Class AccountAdmin_Controls_ctlAccountImportExport
    ...
    Protected Sub cmdProceed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdProceed.Click
        ...
        ElseIf Me.radExport.Checked Then
            ...
            tempFile = objImportExportBLL.GetTempFileForExport(Me.GetImportExportType)
    ...
    Public Sub ReadAndFillColumnsMapping(ByVal ExportType As String, ByVal tempFile As String)
        ...
        objDataTable = objImportExportBLL.GetAllColumnsOfDBForMapping(Me.ddlDataSource.SelectedValue)
    ...
    Public Function DoDelimiatedImport()
        ...
        Count = bll.InsertRecords(dtMappings, Me.ddlDataSource.Text, Me.ViewState("ImportTempFile"), Me.GetImportExportType, True)
        Count = bll.InsertRecords(dtMappings, Me.ddlDataSource.Text, Me.ViewState("ImportTempFile"), Me.GetImportExportType, False)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.Literal5.Text = ResourceHelper.GetFromResource("Select Employee:")
        Me.Literal7.Text = ResourceHelper.GetFromResource("Select Project:")
