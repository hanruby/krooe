<%@ control language="VB" autoeventwireup="false" inherits="Controls_ctlAccountEmployeeProfile, App_Web_uitpp31g" %>
...
<table border="0" id="Table1" language="javascript" onclick="return TABLE1_onclick()" cellpadding="0" cellspacing="2" style="width: 100%" class="xview">
                <tr>
                    <td class="caption" colspan="4" style="height: 21px">
                        <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Personal Profile") %>' /></td>
                </tr>
                <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="txtUsername">
                        <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("User Name:") %>' /></asp:Label></td><td style="width: 30%; height: 26px" width="40%">
                        <asp:TextBox ID="txtUsername" runat="server" MaxLength="20" Text='<%# Bind("Username") %>' Width="170px"></asp:TextBox></td><td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                    </td>
                ...
                <tr>
                  ...
                  <asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("First Name:") %>' /></asp:Label></td><td style="height: 26px; width: 30%;" width="40%">
                        <asp:TextBox ID="FirstNameTextBox" runat="server" Text='<%# Bind("FirstName") %>' MaxLength="75" Width="170px"></asp:TextBox><asp:RequiredFieldValidator
...
<asp:Label ID="Label2" runat="server" AssociatedControlID="MiddleNameTextBox">
                  ...
                  <asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Last Name:") %>' /></asp:Label></td><td style="height: 26px; width: 30%;" width="40%">
                        <asp:TextBox ID="LastNameTextBox" runat="server" Text='<%# Bind("LastName") %>' MaxLength="75" Width="170px"></asp:TextBox><asp:RequiredFieldValidator
...
<asp:Label ID="Label6" runat="server" AssociatedControlID="AddressLine1TextBox">
                        <asp:Literal ID="Literal9" runat="server" Text='<%# ResourceHelper.GetFromResource("Address Line 1:") %>' /></asp:Label></td><td style="height: 26px; width: 30%;" width="40%">
                        <asp:TextBox ID="AddressLine1TextBox" runat="server" Text='<%# Bind("AddressLine1") %>' MaxLength="150" Width="170px"></asp:TextBox></td><td colspan="1" style="height: 26px; width: 20%;" class="FormViewLabelCell" align="right">
...
<asp:Label ID="Label10" runat="server" AssociatedControlID="StateTextBox">
                        <asp:Literal ID="Literal11" runat="server" Text='<%# ResourceHelper.GetFromResource("State:") %>' /></asp:Label></td><td style="height: 26px; width: 30%;" width="40%">
                        <asp:TextBox ID="StateTextBox" runat="server" Text='<%# Bind("State") %>' MaxLength="20" Width="170px"></asp:TextBox></td><td colspan="1" style="height: 26px; width: 20%;" class="FormViewLabelCell" align="right">
...
<asp:Label ID="Label13" runat="server" AssociatedControlID="ZipTextBox">
                        <asp:Literal ID="Literal13" runat="server" Text='<%# ResourceHelper.GetFromResource("ZipCode") %>' /></asp:Label></td><td style="height: 26px; width: 30%;" width="40%">
                        <asp:TextBox ID="ZipTextBox" runat="server" Text='<%# Bind("Zip") %>' MaxLength="10" Width="170px"></asp:TextBox></td><td colspan="1" style="height: 26px; width: 20%;" class="FormViewLabelCell" align="right">
                        <asp:Literal ID="Literal14" runat="server" Text='<%# ResourceHelper.GetFromResource("Country:") %>' /></td>
                    <td colspan="1" style="width: 30%; height: 26px">
                        <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="dsSystemCountryObject"
                                DataTextField="Country" DataValueField="CountryId" Width="170px">
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    <td class="FormViewLabelCell" style="height: 26px; width: 20%;" align="right">
...
<asp:Label ID="Label15" runat="server" AssociatedControlID="HomePhoneNoTextBox">
                        <asp:Literal ID="Literal15" runat="server" Text='<%# ResourceHelper.GetFromResource("Home Phone No:") %>' /></asp:Label></td><td style="height: 26px; width: 30%;" width="40%">
                        <asp:TextBox ID="HomePhoneNoTextBox" runat="server" Text='<%# Bind("HomePhoneNo") %>' MaxLength="20" Width="170px"></asp:TextBox></td><td class="FormViewLabelCell" colspan="1" style="height: 26px; width: 20%;" align="right">
                    </td>
                    <td colspan="1" style="width: 30%; height: 26px">
                    </td>
                </tr>
...
<asp:Label ID="Label17" runat="server" AssociatedControlID="WorkPhoneNoTextBox">
                        <asp:Literal ID="Literal16" runat="server" Text='<%# ResourceHelper.GetFromResource("Work Phone No:") %>' /></asp:Label></td><td style="height: 26px; width: 30%;" width="40%">
                        <asp:TextBox ID="WorkPhoneNoTextBox" runat="server" Text='<%# Bind("WorkPhoneNo") %>' MaxLength="50" Width="170px"></asp:TextBox></td><td colspan="1" style="height: 26px; width: 20%;" class="FormViewLabelCell" align="right">
                       
<asp:Label ID="Label19" runat="server" AssociatedControlID="MobilePhoneNoTextBox">
                        <asp:Literal ID="Literal17" runat="server" Text='<%# ResourceHelper.GetFromResource("Mobile Phone No:") %>' /></asp:Label></td><td colspan="1" style="width: 30%; height: 26px">
                        <asp:TextBox ID="MobilePhoneNoTextBox" runat="server" Text='<%# Bind("MobilePhoneNo") %>' MaxLength="50" Width="170px"></asp:TextBox></td></tr><tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            User Interface Language:</td>
                        <td colspan="3" style="height: 26px">
                            ...
                            Value="nn-NO">Norwegian, Nynorsk (Norway)</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3" style="height: 26px; ">
                        <asp:DropDownList ID="ddlTimeZoneId" runat="server" DataSourceID="dsTimeZone" 
                            DataTextField="TimeZoneName" DataValueField="SystemTimeZoneId" Width="490px">
                        </asp:DropDownList>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="FormViewSubHeader" style="height: 21px" colspan="4">
                        <asp:Literal ID="Literal19" runat="server" Text='<%# ResourceHelper.GetFromResource("Password") %>' /></td>
                </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            <span 
                  ...
                  <asp:Literal ID="Literal22" runat="server" 
                                Text='<%# ResourceHelper.GetFromResource("Current Password:") %>' /></asp:Label></td><td style="width: 30%; height: 26px" width="40%">
                            <asp:TextBox 
                ...
                Text='<%# ResourceHelper.GetFromResource("Password:") %>' /></asp:Label></td><td 
                        width="40%"><asp:TextBox ID="PasswordTextBox" 
                ...
                Text='<%# ResourceHelper.GetFromResource("Verify Password:") %>' /></asp:Label></td><td 
                        colspan="1" valign="middle"><asp:TextBox 
                            ...
                            ErrorMessage="(Mismatch)" Width="35px"></asp:CompareValidator></td></tr><%End If %><tr>
                    <td class="FormViewLabelCell" colspan="3" style="height: 26px">
                        ...
                        <asp:Button 
                            ...
                            Text="<%$ Resources:TimeLive.Web,Update_text%> " Width="72px" 
                            onclick="Update_Click" /><asp:Button ID="Cancel" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%> " Width="72px" OnClick="Cancel_Click" /></td>
                </tr>
            </table>
...
<InsertItemTemplate>
                <table border="0" id="Table3" language="javascript" onclick="return TABLE1_onclick()" cellpadding="0" cellspacing="2" style="width: 100%" class="xview">
                    <tr>
                        <td class="caption" colspan="4" style="height: 26px; width: 20%;">
                            <asp:Literal ID="Literal21" runat="server" Text='<%# ResourceHelper.GetFromResource("Personal Profile") %>' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="4" style="height: 26px; width: 20%;">
                            <asp:Literal ID="Literal22" runat="server" Text='<%# ResourceHelper.GetFromResource("Personal Information") %>' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewLabelCell" style="height: 26px; width: 20%;" align="right">
                                                <SPAN 
...
<asp:Label ID="Label20" runat="server" AssociatedControlID="MobilePhoneNoTextBox">
                        ...
                        <td class="FormViewSubHeader" style="height: 26px; width: 20%;" colspan="4">
                            <asp:Literal ID="Literal37" runat="server" Text='<%# ResourceHelper.GetFromResource("Login") %>' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewLabelCell" style="height: 26px; width: 20%;" align="right">
                                                <SPAN 
                  ...
                  class=reqasterisk>*</SPAN><asp:Literal ID="Literal42" runat="server" Text='<%# ResourceHelper.GetFromResource("Department:") %>' /></td>
                    ...
                    <tr>
                        <td class="FormViewSubHeader" style="height: 26px; width: 20%;" colspan="4">
                            <asp:Literal ID="Literal44" runat="server" Text='<%# ResourceHelper.GetFromResource("Billing Rate") %>' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewLabelCell" style="height: 26px; width: 20%;" align="right">
                    ...
                    <tr>
                        <td class="FormViewLabelCell" colspan="3" style="height: 26px; width: 20%;">
                            &nbsp;</td><td colspan="1" style="width: 30%; height: 26px">
                            <asp:Button ID="Add" runat="server" CommandName="Insert" Text="<%$ Resources:TimeLive.Web, Add_text%> " Width="50px" /></td>
                    </tr>
                </table>
