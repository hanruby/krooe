<%@ control language="VB" autoeventwireup="false" inherits="Menus_Controls_ctlAccountAdminSiteMenu, App_Web_xlcplz22" enableviewstate="False" %>
             <br /><div id="navigation" style="position: static;">
                <ul><li><asp:HyperLink runat="server" ID="H" NavigateUrl="~/Login.aspx"><asp:Literal ID="L1" runat="server" Text="<%$ Resources:TimeLive.Web, Home%> " /></asp:HyperLink></li>
