<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsViewer_ctlTaskSummary, App_Web_iqmrpsj3" %>
        ...
        <table class="xFormView" style="width: 350px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Task Summary Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%; height: 21px">
                    <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:TimeLive.Web, Project Tasks:%> " /></td>
                <td style="width: 60%; height: 21px">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Web, Location:%> " /></td>
                <td style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:TimeLive.Web, Approved:%> " /></td>
                <td style="width: 60%">
