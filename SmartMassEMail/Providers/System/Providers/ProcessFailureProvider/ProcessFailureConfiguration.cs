...
namespace SmartMassEmail.Providers {
	...
	public class ProcessFailureConfiguration {
		string defaultProvider;
		Hashtable providers = new Hashtable();

        public static ProcessFailureConfiguration GetConfig( )
        {
            //return (EmailQueueConfiguration)ConfigurationSettings.GetConfig("smartMassEmail.providers/emailQueue");
            return (ProcessFailureConfiguration)ConfigurationManager.GetSection("smartMassEmail.providers/processFailure");
		}  
