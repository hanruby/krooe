...
Partial Class ProjectAdmin_Controls_ctlTimeSheetApprovalSummary
    ...
    Public Sub ShowDataForTimeSheetApprovalSummary(ByVal AccountEmployeeId As Integer, ByVal TimeEntryStartDate As DateTime, ByVal TimeEntryEndDate As DateTime, ByVal IncludeDateRange As Boolean)
        ...
        Me.dsApprovalEntriesForEmployeeManagerForTimeOffObject.SelectParameters("TimeEntryAccountEmployeeId").DefaultValue = AccountEmployeeId
        Me.dsApprovalEntriesForEmployeeManagerForTimeOffObject.SelectParameters("TimeEntryStartDate").DefaultValue = TimeEntryStartDate
        Me.dsApprovalEntriesForEmployeeManagerForTimeOffObject.SelectParameters("TimeEntryEndDate").DefaultValue = TimeEntryEndDate
        Me.dsApprovalEntriesForEmployeeManagerForTimeOffObject.SelectParameters("IncludeDateRange").DefaultValue = IncludeDateRange
    ...
    Protected Sub GridView7_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        ...
        End If
        If e.Row.RowType = DataControlRowType.Footer Then
            CType(e.Row.Cells(3).FindControl("lblSumTotalTime"), Label).Text = DBUtilities.GetDateTimeOfMinutesAsString(TotalTime6)
        End If
    End Sub
