...
Partial Class Employee_Controls_ctlAccountEmployeeTimeEntryWeekView
    ...
    Public Sub Show()
        ...
        End If
        WeekButton1.Attributes.Add("onclick", "javascript: if ( Page_ClientValidate() )" + "{" + btnCopyActivities.ClientID + ".disabled=true;" + btnCopy.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + WeekButton1.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnSubmit.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnTopSubmit.ClientID + ".disabled=true;" + "}" + Me.Page.ClientScript.GetPostBackEventReference(WeekButton1, ""))
        btnTopSave.Attributes.Add("onclick", "javascript: if ( Page_ClientValidate() )" + "{" + btnCopyActivities.ClientID + ".disabled=true;" + btnCopy.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + WeekButton1.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnSubmit.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnTopSubmit.ClientID + ".disabled=true;" + "}" + Me.Page.ClientScript.GetPostBackEventReference(btnTopSave, ""))
        btnCopy.Attributes.Add("onclick", ResourceHelper.GetCopyMessageJavascriptForWeekView + "javascript:" + btnCopyActivities.ClientID + ".disabled=true;" + btnCopy.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + WeekButton1.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnSubmit.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnTopSubmit.ClientID + ".disabled=true;" + Me.Page.ClientScript.GetPostBackEventReference(btnCopy, ""))
        btnCopyActivities.Attributes.Add("onclick", ResourceHelper.GetCopyMessageJavascriptForWeekView + "javascript:" + btnCopyActivities.ClientID + ".disabled=true;" + btnCopy.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + WeekButton1.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnSubmit.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnTopSubmit.ClientID + ".disabled=true;" + Me.Page.ClientScript.GetPostBackEventReference(btnCopyActivities, ""))
        btnSubmit.Attributes.Add("onclick", ResourceHelper.GetSubmitMessageJavascript + "javascript: if ( Page_ClientValidate() )" + "{" + btnCopyActivities.ClientID + ".disabled=true;" + btnCopy.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + WeekButton1.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnSubmit.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnTopSubmit.ClientID + ".disabled=true;" + "}" + Me.Page.ClientScript.GetPostBackEventReference(btnSubmit, ""))
        btnTopSubmit.Attributes.Add("onclick", ResourceHelper.GetSubmitMessageJavascript + "javascript: if ( Page_ClientValidate() )" + "{" + btnCopyActivities.ClientID + ".disabled=true;" + btnCopy.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + WeekButton1.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnSubmit.ClientID + ".disabled=true;" + btnTopSave.ClientID + ".disabled=true;" + btnTopSubmit.ClientID + ".disabled=true;" + "}" + Me.Page.ClientScript.GetPostBackEventReference(btnTopSubmit, ""))
    ...
    Public Sub AddColumnsInWGByDate(ByVal dtDate As Date)
        ...
        For dayNo As Integer = 0 To WorkingDaysCount - 1
            ...
            dtcolumn.ItemTemplate = New TimesheetItemTemplate("S" & dayNo, "E" & dayNo, "TT" & dayNo, "MS" & dayNo, "ME" & dayNo, "MT" & dayNo, "VS" & dayNo, "VE" & dayNo, "VT" & dayNo, "i" & dayNo, IsEnable, "PC" & dayNo, "MP" & dayNo, "VP" & dayNo, "NV" & dayNo)
        ...
        If WorkingDaysCount <> 0 Then
            DataKeyNames = AccountEmployeeTimeEntryDataKeyNames + "," + TotalTimeDataKeyNames + "," + _
                StartTimeDataKeyNames + "," + EndTimeDataKeyNames + "," + DescriptionDataKeyNames + "," + _
                "PeriodDescription" + "," + "IsTimeOff" + "," + "AccountEmployeeTimeOffRequestId" + "," + _
                "AccountEmployeeTimeEntryApprovalProjectId" + "," + "ProjectApproved" + "," + "AccountProjectId" + _
                "," + "AccountProjectTaskId" + "," + "AccountCostCenterId" + "," + "AccountWorkTypeId" + "," + _
                "AccountTimeOffTypeId" + "," + TotalApprovedDataKeyNames + "," + TotalSubmittedDataKeyNames + "," + _
                TotalRejectedDataKeyNames + "," + PercentageDataKeyNames + "," + HoursDataKeyNames + _
                "," + CustomField1DataKeyNames + "," + _
    ...
    Public Sub SetCascadingAccountId(ByVal objRow As GridViewRow)
        ...
        MyCascading.Category = TimeEntryAccountEmployeeId & "," & LocaleUtilitiesBLL.IsShowCompletedTasksInTimeSheet & "," & AccountProjectTaskId & "," & DBUtilities.GetSessionAccountId & "," & AccountProjectId & "," & DBUtilities.GetShowAdditionalTaskInformationType
    End Sub
    ''' <summary>
                ...
                For dayNo As Integer = 0 To WorkingDaysCount - 1
                    If Not CType(objrow.Cells(5 + dayNo).FindControl("TT" & dayNo), TextBox) Is Nothing Then
                        If CType(objrow.Cells(5 + dayNo).FindControl("TT" & dayNo), TextBox).Text <> "" And CType(objrow.Cells(1).FindControl("PT"), DropDownList).SelectedValue = "" And Me.G.DataKeys(objrow.RowIndex)("IsTimeOff").ToString = "False" Then
                            Me.ShowNotFoundMessage(Resources.TimeLive.Web.TimeEntry_Validation)
                            Return False
                        End If
    ...
    Protected Sub WG_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles G.DataBound
        ...
        If DBUtilities.GetLockPreviousTimesheetPeriods Then
            DisablePriovousPeriodsTimeEntryOfWeek()
            Me.btnSubmit.Enabled = False
            Me.btnTopSubmit.Enabled = False
            Me.WeekButton1.Enabled = False
            Me.btnTopSave.Enabled = False
        ...
        If DBUtilities.GetLockNextTimsheetPeriods Then
            DisableNextPeriodsTimeEntryOfWeek()
            Me.btnSubmit.Enabled = False
            Me.btnTopSubmit.Enabled = False
            Me.WeekButton1.Enabled = False
            Me.btnTopSave.Enabled = False
    ...
    Public Sub UpdateDay(ByVal DayNo As Integer, ByVal objRow As GridViewRow, ByVal AccountEmployeeTimeEntryPeriodId As Guid, ByVal ApprovalProjectId As Guid, ByVal ProjectApproved As Boolean, ByVal Submitted As Boolean)
        With Me.dsAccountEmployeeTimeEntriesWeek
            ...
            ElseIf UpdateId > 0 And (Me.GetCellValue(objRow, DayNo + 5, "TT" & DayNo) = "" And DBUtilities.IsTimeEntryHoursFormat = "Time") Or (Me.GetCellValue(objRow, DayNo + 5, "TT" & DayNo) = "" And DBUtilities.IsTimeEntryHoursFormat = "Decimal") Or (Me.GetCellValue(objRow, DayNo + 5, "PC" & DayNo) = "" And LocaleUtilitiesBLL.ShowPercentageInTimesheet = True And DBUtilities.IsTimeEntryHoursFormat = "None" And Me.G.DataKeys(objRow.RowIndex).Item("IsTimeOff").ToString = "False") Or (Me.GetCellValue(objRow, DayNo + 5, "TT" & DayNo) = "" And Me.G.DataKeys(objRow.RowIndex).Item("IsTimeOff").ToString = "True") Or (Me.GetCellValue(objRow, DayNo + 5, "TT" & DayNo) = "" And DBUtilities.IsTimeEntryHoursFormat = "None" And LocaleUtilitiesBLL.ShowPercentageInTimesheet = False) Then
                BLL.DeleteAccountEmployeeTimeEntry(UpdateId, TimesheetPeriodType, TimeEntryAccountEmployeeId, dtStartDate, dtEndDate, ApprovalProjectId, AccountEmployeeTimeEntryPeriodId)
            End If
        End With
    End Sub
    ''' <summary>
    ...
    Public Sub Save()
        ...
        Catch ex As Exception
            LoggingBLL.WriteExceptionToLog("TimeEntry Period View Save(): ButtonClicked= " & ButtonClicked & " dtApprovalProjectId= " & EXdtApprovalProjectId.ToString & " PeriodId= " & dtAccountEmployeeTimeEntryPeriodId.ToString & " ProjectId= " & EXdtAccountProjectId & " EmployeeId= " & TimeEntryAccountEmployeeId, ex)
            Throw ex
        End Try
    End Sub
    ''' <summary>
    ...
    ''' <remarks></remarks>
    Public Sub ShowDate(ByVal dtDate As Date, ByVal CopyFromDate As Date, ByVal IsCopyFromDate As Boolean)
    ...
    Public Sub RefreshWeekView(Optional ByVal bDateSelect As Boolean = False)
        If bDateSelect = False Then
            ...
            If Not Request.QueryString("CopyDate") Is Nothing Then
                ...
                IsCopyFrom = True
            End If
            Me.ShowDate(Me.txtTimeEntryDate.SelectedDate.Date, CopyFromStartDate, IsCopyFrom)
    ...
    Public Sub SetClientCascadingEnabled(ByVal objRow As GridViewRow)
        ...
        End If
        MyCascading.Category = TimeEntryAccountEmployeeId & "," & AccountProjectId & "," & DBUtilities.GetShowClientInTimesheet & "," & DBUtilities.GetSessionAccountId & "," & 0 & "," & LocaleUtilitiesBLL.IsShowCompletedProjectsInTimeSheet
    End Sub
    ''' <summary>
    ...
    Public Sub SetProjectValueOnRowDataBound(ByVal objDropdown As DropDownList, ByVal dsObject As ObjectDataSource, ByVal dataValue As Object, ByVal MyCascading As AjaxControlToolkit.CascadingDropDown, ByVal Row As GridViewRow)
        ...
        If Not objDropdown Is Nothing Then
            If Not IsDBNull(DataBinder.Eval(Row.DataItem, "AccountProjectId")) Then
                ...
                MyCascading.Category = TimeEntryAccountEmployeeId & "," & dataValue & "," & DBUtilities.GetShowClientInTimesheet & "," & DBUtilities.GetSessionAccountId & "," & DataBinder.Eval(Row.DataItem, "AccountClientId") & "," & LocaleUtilitiesBLL.IsShowCompletedProjectsInTimeSheet
            End If
            If DataBinder.Eval(Row.DataItem, "IsTimeOff").ToString = "True" Then
                ...
                CType(Row.Cells(1).FindControl("lblTimeTypes"), Label).Text = DataBinder.Eval(Row.DataItem, "TimeType")
        ...
        If Not objDropdown Is Nothing Then
            ...
            If DataBinder.Eval(Row.DataItem, "IsTimeOff").ToString = "True" Then
                ...
                If Not IsDBNull(DataBinder.Eval(Row.DataItem, "AccountTimeOffTypeId")) Then
                    CType(Row.Cells(1).FindControl("dsTimeOffTypesObject"), ObjectDataSource).SelectParameters("AccountTimeOffTypeId").DefaultValue = DataBinder.Eval(Row.DataItem, "AccountTimeOffTypeId").ToString
                ...
                If Not IsDBNull(DataBinder.Eval(Row.DataItem, "AccountEmployeeTimeOffRequestId")) Then
                    CType(Row.Cells(1).FindControl("ddlTimeOffTypeId"), DropDownList).Enabled = False
                End If
            End If
        End If
            ...
            For Each objrow As GridViewRow In Me.G.Rows
                If objrow.RowType = DataControlRowType.DataRow Then
                    If Me.G.DataKeys(objrow.RowIndex)("IsTimeOff").ToString = "True" Then
                        CType(objrow.Cells(0).FindControl("P"), DropDownList).Width = Unit.Percentage(75)
                    ElseIf Me.G.DataKeys(objrow.RowIndex)("IsTimeOff").ToString = "False" Then
                        CType(objrow.Cells(0).FindControl("P"), DropDownList).Width = Unit.Pixel(225)
                    End If
                End If
            Next
        End If
    ...
    ''' <param name="dayNo"></param>
    ''' <remarks></remarks>
    Private Sub CheckHolidayIcon(ByVal Holidaydate As Date, ByVal dayNo As Integer)
        Dim HolidayBLL As New AccountHolidayTypeBLL
        Dim HolidayTypeId As Guid
        Dim dtHolidayEmployee As AccountHolidayType.vueAccountHolidayEmployeeDataTable = New AccountHolidayTypeBLL().GetvueAccountEmployeesByAccountEmployeeId(Me.ddlEmployee.SelectedValue)
        Dim drHolidayEmployee As AccountHolidayType.vueAccountHolidayEmployeeRow
    ...
    Public Sub ShowTimerTimesheet()
        ...
        btnTimerTimesheet.Attributes.Add("onclick", "javascript:window.open(" & """" & URL & """" & ", 'popupwindow', 'width=535,height=280,left=280,top=280,scrollbars=yes'); return false;")
    End Sub
    ...
    Protected Sub btnExportOfflineTimesheet_Click(sender As Object, e As System.EventArgs) Handles btnExportOfflineTimesheet.Click
        Dim tempfile As String
        Dim objImportExportBLL As New ImportExportBLL
        tempfile = objImportExportBLL.GetTempFileForExport("Delimited")
        objImportExportBLL.ExportCSV("Time Entry", tempfile, "Delimited", Now, Now, TimeEntryAccountEmployeeId, -1, Me.GetWhereClause, True)
    ...
    Public Sub DisableAllPreviousTimeEntryOfWeek()
        Dim objRow As GridViewRow
        If txtTimeEntryDate.SelectedDate < Now.Date Then
            For Each objRow In Me.G.Rows
                Me.DisableTimeEntryInWeekRows(objRow)
            Next
        End If
    ...
    Public Sub DisableAllFutureTimeEntryOfWeek()
        ...
        End If
    End Sub
    Public Sub DisablePriovousPeriodsTimeEntryOfWeek()
        Dim objRow As GridViewRow
        Dim bll As New AccountEmployeeTimeEntryBLL
        DateTimeUtilities.SetDataInVariableForGetWorkingDays(TimeEntryAccountEmployeeId)
        Dim dtCurrentDate As Date = GetCurrentDate()
