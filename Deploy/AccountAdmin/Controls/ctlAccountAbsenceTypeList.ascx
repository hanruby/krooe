<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountAbsenceTypeList, App_Web_yhen42r4" %>
...
<x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountAbsenceTypeId"
    ...
    <Columns>
        <asp:TemplateField InsertVisible="False" SortExpression="AccountAbsenceTypeId">
            <edititemtemplate>
...
<asp:Label id="Label2" runat="server" Text='<%# Bind("AccountAbsenceTypeId") %>' __designer:wfdid="w129"></asp:Label>
        ...
        <asp:TemplateField SortExpression="AbsenceDescription">
            <edititemtemplate>
        ...
        <table style="width: 100%" class="xview">
            <tr>
                <td class="caption" colspan="2" style="width: 40%;Height:21px">
                    <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Absence Type Information")%> ' /></td>
            </tr>
            <tr>
                <td class="FormViewSubHeader" colspan="2" style="width: 40%;Height:21px">
                    <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Absence Type")%> ' /></td>
            </tr>
            <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="AbsenceDescriptionTextBox">
        ...
        <asp:TextBox ID="AbsenceDescriptionTextBox" runat="server" Text='<%# Bind("AbsenceDescription") %>' Width="155px" MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
            ...
            <tr>
                ...
                <td style="height: 26px; width: 70%;" width="60%">
                    <asp:Button ID="Button2" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text%> "  Width="68px" /><asp:Button ID="Button3" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%> "  Width="68px" /></td>
            </tr>
        </table>
    </EditItemTemplate>
    <InsertItemTemplate>
        <table style="width: 100%" class="xview">
            <tr>
                <td class="caption" colspan="2" style="height: 21px" width="40%">
                    <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Absence Type Information")%> ' /></td>
            </tr>
            <tr>
                <td class="FormViewSubHeader" colspan="2" style="height: 21px" width="40%">
                    <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Absence Type")%> ' /></td>
            </tr>
            <tr>
...
<asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Absence Description:")%> ' /></asp:Label></td><td style="height: 26px; width: 70%;" colspan="1" rowspan="1">
                    <asp:TextBox ID="AbsenceDescriptionTextBox" runat="server" Text='<%# Bind("AbsenceDescription") %>' Width="155px" MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="AbsenceDescriptionTextBox"
