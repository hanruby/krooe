<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsViewer_ctlEmployeeTimeEntry, App_Web_iqmrpsj3" %>
        ...
        <table class="xFormView" style="width: 450px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Task Billing By Projects/Clients Report%> " /></td>
            </tr>
            <tr>
