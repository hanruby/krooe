<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountTimesheetPeriodTypeList, App_Web_j1ru2ref" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" SkinID="xgridviewSkinEmployee" DataSourceID="dsAccountTimesheetPeriodTypeGridViewObject" AutoGenerateColumns="False" Caption='<%# ResourceHelper.GetFromResource("Timesheet Period Types") %>' DataKeyNames="AccountTimesheetPeriodTypeId" Width="650px">
            <Columns>
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Timesheet Period Type%> " SortExpression="SystemTimesheetPeriodType">
                    <edititemtemplate>
...
<asp:Label id="Label1" runat="server" Text='<%# Bind("SystemTimesheetPeriodType") %>' __designer:wfdid="w113"></asp:Label>
                ...
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Initial Days Of The Period%> " SortExpression="SystemInitialDaysOfThePeriod">
                    <edititemtemplate>
...
<asp:Label id="Label2" runat="server" Text='<%# Bind("SystemInitialDaysOfThePeriod") %>' __designer:wfdid="w116"></asp:Label>
                ...
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Initial Days Of The Month%> " SortExpression="InitialDayOfTheMonth">
                    <edititemtemplate>
...
<asp:Label id="Label3" runat="server" Text='<%# Bind("InitialDayOfTheMonth") %>' __designer:wfdid="w119"></asp:Label>
                ...
                <asp:CommandField SelectText="Edit" ShowSelectButton="True" >
                    <itemstyle cssclass="edit_button" />
                </asp:CommandField>
                <asp:TemplateField>
                    <headertemplate>
<asp:Image id="Image1" runat="server" __designer:wfdid="w17" ToolTip="<%$ Resources:TimeLive.Web, Disabled_text%> " ImageUrl="~/Images/Disabled.gif"></asp:Image>
</headertemplate>
                    <itemtemplate>
<asp:Image id="Image11" runat="server" __designer:wfdid="w15" ToolTip="<%$ Resources:TimeLive.Web, Disabled_text%> " Visible='<%# IIF(IsDBNull(Eval("IsDisabled")),"False",Eval("IsDisabled")) %>' ImageUrl="~/Images/Disabled.gif"></asp:Image> 
</itemtemplate>
                </asp:TemplateField>
            </Columns>
        </x:GridView>
        ...
        <asp:FormView ID="FormView1" runat="server" SkinID="formviewSkinEmployee" DataSourceID="dsAccountTimesheetPeriodTypeFormViewObject" DataKeyNames="AccountTimesheetPeriodTypeId" DefaultMode="Insert" Width="450px">
            <EditItemTemplate><table width="100%" class="xview">
                <tr>
                    <td colspan="2" class="caption">
                        <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Timesheet Period Type Information")%> ' /></td>
                </tr>
                <tr>
                    <td colspan="2" class="FormViewSubHeader">
                        <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Timesheet Period Type")%> ' /></td>
                </tr>
                <tr>
                  ...
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Timesheet Period Type:")%> ' /></td>
                    <td style="width: 60%">
                        <asp:DropDownList ID="ddlTimesheetPeriodType" runat="server" DataSourceID="dsSystemTimesheetPeriodTypeObject"
                                DataTextField="SystemTimesheetPeriodType" DataValueField="SystemTimesheetPeriodTypeId" Width="130px" AutoPostBack="True" OnSelectedIndexChanged="ddlTimesheetPeriodType_SelectedIndexChanged" SelectedValue='<%# Bind("SystemTimesheetPeriodTypeId") %>' Enabled="False">
                        </asp:DropDownList>
                    </td>
                </tr>
                  ...
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Initial Days Of The Period:")%> ' /></td>
                    <td style="width: 60%">
                        <asp:DropDownList ID="ddlInitialDaysOfThePeriod" runat="server" DataSourceID="dsInitialDaysOfThePeriodObject"
                                DataTextField="SystemInitialDaysOfThePeriod" DataValueField="SystemInitialDaysOfThePeriodId" Width="90px" Visible="False" AppendDataBoundItems="True">
                ...
                <tr>
                  ...
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("Initial Day Of The Month:")%> ' /></td>
                    <td style="width: 60%">
                        <asp:TextBox ID="txtInitialDayOfTheMonth" runat="server" Width="50px" Visible="False" Text='<%# Bind("InitialDayOfTheMonth") %>'></asp:TextBox></td>
                </tr>
                <%End If %>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 60%">
                        <asp:Button ID="btnUpdate" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text %>" Width="68px" /><asp:Button
                            ID="btnCancel" runat="server" CausesValidation="False" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text %>"
                            Width="68px" /></td>
                </tr>
            </table>
            </EditItemTemplate>
            <InsertItemTemplate>
                <table width="100%" class="xview">
                    <tr>
                        <td colspan="2" class="caption">
                            <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Update_text %>" /></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="FormViewSubHeader">
                            <asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Timesheet Period Type")%> ' /></td>
                    </tr>
                    <tr>
                        <td style="width: 40%" align="right" class="FormViewLabelCell" valign="middle">
                            <SPAN 
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal7" runat="server" Text='<%# ResourceHelper.GetFromResource("Timesheet Period Type:")%> ' /></td>
                        <td style="width: 60%">
                            <asp:DropDownList ID="ddlTimesheetPeriodType" runat="server" DataSourceID="dsSystemTimesheetPeriodTypeObject"
                                DataTextField="SystemTimesheetPeriodType" DataValueField="SystemTimesheetPeriodTypeId" Width="130px" AutoPostBack="True" OnSelectedIndexChanged="ddlTimesheetPeriodType_SelectedIndexChanged" SelectedValue='<%# Bind("SystemTimesheetPeriodTypeId") %>'>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <%If CType(Me.FormView1.FindControl("ddlInitialDaysOfThePeriod"), DropDownList).Visible = True Then%>
                  ...
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal8" runat="server" Text='<%# ResourceHelper.GetFromResource("Initial Days Of The Period:")%> ' /></td>
                        <td style="width: 60%">
                            <asp:DropDownList ID="ddlInitialDaysOfThePeriod" runat="server" DataSourceID="dsInitialDaysOfThePeriodObject"
                                DataTextField="SystemInitialDaysOfThePeriod" DataValueField="SystemInitialDaysOfThePeriodId" Width="90px" Visible="False" SelectedValue='<%# Bind("SystemInitialDaysOfThePeriodId") %>' AppendDataBoundItems="True">
                                <asp:ListItem Selected="True" Value="0">&lt;Select&gt;</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
