...
Partial Class ProjectAdmin_Controls_ctlAccountInvoiceForm
    ...
    Public Sub InsertAccountTimeExpenseBillingTimesheet()
        ...
        If CType(Me.FormView1.FindControl("ddlInvoiceGroup"), DropDownList).SelectedValue = "Task" Then
            dtTimeSheet = New AccountTimeExpenseBillingBLL().GetvueAccountTimeExpenseBillingTimesheetByAccountClientId(CType(Me.FormView1.FindControl("ddlClientId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("BillingCycleStartDateTextBox"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("BillingCycleEndDateTextBox"), eWorld.UI.CalendarPopup).SelectedDate, AccountProjectId, CType(Me.FormView1.FindControl("ddlBillable"), DropDownList).SelectedValue)
        Else
            dtTimeSheet = New AccountTimeExpenseBillingBLL().GetvueAccountTimeExpenseBillingTimesheetByAccountClientIdWithTimeEntryGroup(CType(Me.FormView1.FindControl("ddlClientId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("BillingCycleStartDateTextBox"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("BillingCycleEndDateTextBox"), eWorld.UI.CalendarPopup).SelectedDate, AccountProjectId, CType(Me.FormView1.FindControl("ddlBillable"), DropDownList).SelectedValue)
        End If
        If dtTimeSheet.Rows.Count > 0 Then
            ...
            For Each drTimeSheet In dtTimeSheet.Rows
                ...
                drTimeSheet.SubTotal = drTimeSheet.TotalAmount
        ...
        If Me.FormView1.CurrentMode = FormViewMode.Insert Then
            If Me.GetInvoiceNo <> True Then
                ...
                For Each row In Me.GridView2.Rows
                    ...
                    End If
                Next
                Response.Redirect("~/Reports/AccountTimeExpenseBillingReport.aspx?AccountTimeExpenseBillingId=" & objTimeSheet.GetLastInsertedId.ToString)
            End If
        End If
        If Me.FormView1.CurrentMode = FormViewMode.Edit Then
            Me.UpdateAccountTimeExpenseBilling()
            ...
            Next
        End If
        Response.Redirect("~/Reports/AccountTimeExpenseBillingReport.aspx?AccountTimeExpenseBillingId=" & Me.Request.QueryString("AccountTimeExpenseBillingId"))
    End Sub
    ...
    Private Sub RowsCheck()
        ...
        If dtTimeSheet.Rows.Count <> 0 Or dtExpenseSheet.Rows.Count <> 0 Then
            If Me.FormView1.CurrentMode = FormViewMode.Insert Then
                ...
                Response.Redirect("~/ProjectAdmin/AccountInvoiceForm.aspx?AccountTimeExpenseBillingId=" & objTimeSheet.GetLastInsertedId.ToString)
            Else
                Dim Original_AccountTimeExpenseBillingId As New Guid(Me.Request.QueryString("AccountTimeExpenseBillingId"))
    ...
    Public Sub UpdateCalculation()
        If IsPopulate = True Then
            ...
            'Timesheet
            Dim dtTimeSheet As AccountTimeExpenseBilling.ViewAccountTimeExpenseBillingTimesheetforEditDataTable = New AccountTimeExpenseBillingBLL().GetvueAccountTimeExpenseBillingTimesheetByAccountTimeExpenseBillingId(AccountTimeExpenseBillingId, IsPopulate)
