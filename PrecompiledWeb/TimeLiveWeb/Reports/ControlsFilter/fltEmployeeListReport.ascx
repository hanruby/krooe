<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsReports_fltEmployeeListReport, App_Web_uiy04ms5" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table class="xFormView" style="width: 350px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Employee List Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 30%">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Location:%> " /></td>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 30%;">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Department:%> " /></td>
                <td align="left" style="width: 75%;">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 30%">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Role:%> " /></td>
                <td align="left" style="width: 75%">
