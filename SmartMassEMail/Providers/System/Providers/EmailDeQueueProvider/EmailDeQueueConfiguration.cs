...
namespace SmartMassEmail.Providers {
	...
	public class EmailDeQueueConfiguration {
		string defaultProvider;
		Hashtable providers = new Hashtable();

        public static EmailDeQueueConfiguration GetConfig( )
        {
            //return (EmailQueueConfiguration)ConfigurationSettings.GetConfig("smartMassEmail.providers/emailQueue");
            return (EmailDeQueueConfiguration)ConfigurationManager.GetSection("smartMassEmail.providers/emailDeQueue");
		}  
