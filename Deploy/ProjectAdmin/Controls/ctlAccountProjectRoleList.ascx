<%@ control language="VB" autoeventwireup="false" inherits="ProjectAdmin_Controls_ctlAccountProjectRoleList, App_Web_wln1wvyv" %>
...
<table class="xFormView" style="width: 500px">
    <tr>
        <td align="right" class="formviewlabelcell" style="width: 20%">
            <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Work Type:%> " /></td>
...
<asp:Label id="lblBillingRateCurrency" runat="server" Text='<%# ResourceHelper.GetFromResource("Billing Rate Currency") %>' __designer:wfdid="w120"></asp:Label> 
                    ...
                    <itemtemplate>
<asp:DropDownList id="ddlBillingRateCurrencyId" runat="server" Width="55px" DataValueField="AccountCurrencyId" DataTextField="CurrencyCode" DataSourceID="dsBillingRateCurrencyObject" __designer:wfdid="w118"></asp:DropDownList><asp:ObjectDataSource id="dsBillingRateCurrencyObject" runat="server" __designer:dtid="562949953421374" TypeName="AccountCurrencyBLL" SelectMethod="GetvueAccountCurrencyByAccountIdAndDisabled" OldValuesParameterFormatString="original_{0}" __designer:wfdid="w119"><SelectParameters __designer:dtid="562949953421375">
...
<asp:Label id="lblBillingRate" runat="server" Text='<%# ResourceHelper.GetFromResource("Billing Rate") %>' __designer:wfdid="w138"></asp:Label> 
                    ...
                    <ItemStyle Width="50px" horizontalalign="Center" verticalalign="Middle" />
                    <ItemTemplate>
<asp:TextBox id="BillingRateTextBox" runat="server" Text='<%# Bind("BillingRate") %>' Width="50px" __designer:wfdid="w136"></asp:TextBox><BR /><asp:RangeValidator id="RangeValidator3" runat="server" __designer:wfdid="w137" ControlToValidate="BillingRateTextBox" CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="Numeric Required" Font-Bold="False" MaximumValue="50000" MinimumValue="0" Type="Double"></asp:RangeValidator> 
</ItemTemplate>
                </asp:TemplateField>
...
<asp:Label id="lblEmployeeRateCurrency" runat="server" Text='<%# ResourceHelper.GetFromResource("Employee Rate Currency") %>' __designer:wfdid="w126"></asp:Label> 
                    ...
                    <itemstyle width="55px" horizontalalign="Center" verticalalign="Middle" />
                    <itemtemplate>
<asp:DropDownList id="ddlEmployeeRateCurrencyId" runat="server" Width="55px" DataValueField="AccountCurrencyId" DataTextField="CurrencyCode" DataSourceID="dsEmployeeRateCurrencyObject" __designer:wfdid="w124"></asp:DropDownList><asp:ObjectDataSource id="dsEmployeeRateCurrencyObject" runat="server" __designer:dtid="562949953421374" TypeName="AccountCurrencyBLL" SelectMethod="GetvueAccountCurrencyByAccountIdAndDisabled" OldValuesParameterFormatString="original_{0}" __designer:wfdid="w125"><SelectParameters __designer:dtid="562949953421375">
<asp:SessionParameter SessionField="AccountId" Name="AccountId" Type="Int32" __designer:dtid="562949953421376"></asp:SessionParameter>
<asp:Parameter Name="AccountCurrencyId" Type="Int32" __designer:dtid="562949953421377"></asp:Parameter>
</SelectParameters>
</asp:ObjectDataSource> 
...
<asp:Label id="lblEmployeeRate" runat="server" Text='<%# ResourceHelper.GetFromResource("Employee Rate") %>' __designer:wfdid="w141"></asp:Label> 
                    ...
                    <itemstyle width="50px" horizontalalign="Center" verticalalign="Middle" />
                    <itemtemplate>
<asp:TextBox id="EmployeeRateTextBox" runat="server" Text='<%# Bind("EmployeeRate") %>' Width="50px" __designer:wfdid="w139"></asp:TextBox><BR /><asp:RangeValidator id="rvEmployeeRate" runat="server" __designer:wfdid="w140" ControlToValidate="EmployeeRateTextBox" CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="Numeric Required" Font-Bold="False" MaximumValue="50000" MinimumValue="0" Type="Double"></asp:RangeValidator> 
</itemtemplate>
                </asp:TemplateField>
...
<asp:Label id="lblStartDate" runat="server" Text='<%# ResourceHelper.GetFromResource("Start Date") %>' __designer:wfdid="w173"></asp:Label> 
                    ...
                    <ItemTemplate>
<cc1:calendarpopup id="StartDateTextBox" runat="server" Text="..." Width="50px" __designer:wfdid="w172"></cc1:calendarpopup> 
</ItemTemplate>
                </asp:TemplateField>
...
<asp:Label id="lblEndDate" runat="server" Text='<%# ResourceHelper.GetFromResource("End Date") %>' __designer:wfdid="w175"></asp:Label> 
                    ...
                    <itemstyle horizontalalign="Center" verticalalign="Middle" width="100px" />
                    <ItemTemplate>
<cc1:calendarpopup id="EndDateTextBox" runat="server" Text="..." Width="50px" __designer:wfdid="w174"></cc1:calendarpopup> 
</ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Billing Rate History">
                    <headertemplate>
<asp:Label id="lblBillingRateHistory" runat="server" Text='<%# ResourceHelper.GetFromResource("Billing Rate History") %>' __designer:wfdid="w149"></asp:Label> 
</headertemplate>
                    <itemstyle horizontalalign="Center" verticalalign="Middle" width="0px" />
                    <ItemTemplate>
