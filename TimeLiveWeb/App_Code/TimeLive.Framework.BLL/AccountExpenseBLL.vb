...
Public Class AccountExpenseBLL
    ...
    Public Function AddAccountExpense( _
                        ByVal AccountId As Integer, ByVal AccountExpenseName As String, ByVal AccountExpenseTypeId As Integer, ByVal CreatedOn As DateTime, ByVal CreatedByEmployeeId As Integer, ByVal ModifiedOn As DateTime, ByVal ModifiedByEmployeeId As Integer, ByVal IsBillable As Boolean, _
                        ByVal DefaultExpenseRate As Double, ByVal DisabledEditingOfRate As Boolean _
                    ) As Boolean
    ...
    Public Function UpdateAccountExpense(ByVal AccountId As Integer, ByVal AccountExpenseName As String, ByVal AccountExpenseTypeId As Integer, _
    ByVal Original_AccountExpenseId As Integer, ByVal ModifiedOn As DateTime, ByVal ModifiedByEmployeeId As Integer, ByVal IsBillable As Boolean, _
    ByVal IsDisabled As Boolean, ByVal DefaultExpenseRate As Double, ByVal DisabledEditingOfRate As Boolean) As Boolean
