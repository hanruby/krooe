<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlExternalUserList, App_Web_yhen42r4" %>
...
<asp:LinkButton id="LinkButton2" runat="server" Visible='<%# iif(Eval("AccountEmployeeId") = 0,false,true) %>' __designer:wfdid="w29" CausesValidation="False" CommandName="Select" Text="Edit"></asp:LinkButton>
                    ...
                    <itemstyle cssclass="edit_button" horizontalalign="Center" width="5%" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Delete_text %>" ShowHeader="False">
                    <ItemTemplate>
<asp:LinkButton id="LinkButton1" runat="server" Visible='<%# iif(Eval("AccountEmployeeId") = 0,false,true) %>' __designer:wfdid="w30" CausesValidation="False" CommandName="Delete" OnClientClick="<%# ResourceHelper.GetDeleteMessageJavascript() %>" Text="<%$ Resources:TimeLive.Web, Delete_text %>"></asp:LinkButton> 
</ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" Width="5%" cssclass="delete_button" />
                </asp:TemplateField>
                <asp:TemplateField>
                    <HeaderTemplate>
...
<asp:UpdatePanel ID="UpdatePanel3" runat="server">
    <ContentTemplate>
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="AccountEmployeeId" DataSourceID="ObjectDataSource1"
            DefaultMode="Insert" SkinID="formviewSkinEmployee" Width="95%">
            <EditItemTemplate>
                <table id="Table1" border="0" cellpadding="0" cellspacing="2" language="javascript"
                    style="width: 100%" class="xview">
                    <tr>
                        <td class="caption" colspan="4" style="width: 20%; height: 26px">
                            <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("External User Information")%> ' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="4" style="width: 20%; height: 26px">
                            <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Personal Information")%> ' /></td>
                    </tr>
                    <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="FirstNameTextBox"><asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("First Name:")%> ' /></asp:Label></td>
                        <td style="width: 30%; height: 26px" width="40%">
                            <asp:TextBox ID="FirstNameTextBox" runat="server" Text='<%# Bind("FirstName") %>'
                                ValidationGroup="Update"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                    runat="server" ControlToValidate="FirstNameTextBox" CssClass="ErrorMessage" Display="Dynamic"
                                    ErrorMessage="*" ValidationGroup="Insert" Width="1px"></asp:RequiredFieldValidator></td>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            
<asp:Label ID="Label5" runat="server" AssociatedControlID="MiddleNameTextBox">
                            <asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("Middle Name:")%> ' /></asp:Label></td>
                        <td style="width: 30%; height: 26px">
                            <asp:TextBox ID="MiddleNameTextBox" runat="server" Text='<%# Bind("MiddleName") %>'></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
...
<asp:Label ID="Label6" runat="server" AssociatedControlID="LastNameTextBox">
                            <span class="reqasterisk">*</span> <asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Last Name:")%> '  /></asp:Label></td>
                        <td style="width: 30%; height: 26px" width="40%">
                            <asp:TextBox ID="LastNameTextBox" runat="server" Text='<%# Bind("LastName") %>' ValidationGroup="Update"></asp:TextBox><asp:RequiredFieldValidator
                    ...
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            <span class="reqasterisk">*</span> <asp:Literal ID="Literal8" runat="server" Text='<%# ResourceHelper.GetFromResource("External User Client:")%> '  /></td>
                        <td colspan="3" style="height: 26px">
                            <asp:DropDownList ID="ddlExternalUserClientId" runat="server" DataSourceID="dsClientObject"
                                DataTextField="PartyName" DataValueField="AccountPartyId"
                                Width="490px">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlExternalUserClientId"
                                CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="*" ValidationGroup="Insert"
                                Width="1px"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            TimeZone:</td>
                        <td colspan="3" style="height: 26px">
                            <asp:DropDownList ID="ddlTimeZoneId" runat="server" DataSourceID="dsTimeZone" DataTextField="TimeZoneName"
                                DataValueField="SystemTimeZoneId" Width="490px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="4" style="width: 20%; height: 26px">
                            <asp:Literal ID="Literal9" runat="server" Text='<%# ResourceHelper.GetFromResource("Login:")%> '  /></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            
<asp:Label ID="Label8" runat="server" AssociatedControlID="EMailAddressTextBox">
                            <span class="reqasterisk">* </span><asp:Literal ID="Literal10" runat="server" Text='<%# ResourceHelper.GetFromResource("Login Email Address:")%> '  /></asp:Label></td>
                        <td colspan="3" style="height: 26px">
                            <asp:TextBox ID="EMailAddressTextBox" runat="server" Text='<%# Bind("EMailAddress") %>'
                                ValidationGroup="Update" Width="168px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="EMailAddressTextBox"
                                CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="*" ValidationGroup="Insert"
                                Width="8px"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                                    runat="server" ControlToValidate="EMailAddressTextBox" CssClass="ErrorMessage"
                            ...
                            <asp:Label ID="lblExceptionText" runat="server" CssClass="ErrorMessage" Text="Login Already Exist"
...
<asp:Label ID="Label10" runat="server" AssociatedControlID="PasswordTextBox">
                            <span class="reqasterisk">*</span> <asp:Literal ID="Literal20" runat="server" Text='<%# ResourceHelper.GetFromResource("Password:")%> '  /></asp:Label></td>
                        <td style="width: 30%; height: 26px" width="40%">
                            <asp:TextBox ID="PasswordTextBox" runat="server" Text='<%# Bind("Password") %>' TextMode="Password"
                                ValidationGroup="Update"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                    runat="server" ControlToValidate="PasswordTextBox" CssClass="ErrorMessage" Display="Dynamic"
                                    ErrorMessage="*" ValidationGroup="Insert" Width="16px"></asp:RequiredFieldValidator>
                        ...
                        <td align="right" class="FormViewLabelCell" colspan="1" style="width: 20%; height: 26px"
                            valign="middle">
                            
<asp:Label ID="Label11" runat="server" AssociatedControlID="VerifyPasswordTextbox">
                            <span class="reqasterisk">*</span> <asp:Literal ID="Literal21" runat="server" Text='<%# ResourceHelper.GetFromResource("Verify Password:")%> '  /></asp:Label></td>
                        <td colspan="1" style="width: 30%; height: 26px" valign="middle">
                            <asp:TextBox ID="VerifyPasswordTextbox" runat="server" TextMode="Password" ValidationGroup="Update"></asp:TextBox>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="VerifyPasswordTextbox"
                                ControlToValidate="PasswordTextBox" CssClass="ErrorMessage" ErrorMessage="(Mismatch)"
                                ValidationGroup="Update"></asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            <span class="reqasterisk">*</span><asp:Literal ID="Literal22" runat="server" Text='<%# ResourceHelper.GetFromResource("Role:")%> '  /></td>
                        <td style="width: 30%; height: 26px" width="40%">
                        ...
                        <td align="right" class="FormViewLabelCell" colspan="1" style="width: 20%; height: 26px">
                            <asp:Literal ID="Literal24" runat="server" Text='<%# ResourceHelper.GetFromResource("Disabled:")%> '  /></td>
                    ...
                    <tr>
                        <td class="FormViewLabelCell" colspan="3" style="width: 20%; height: 26px">
                            &nbsp;</td>
                        <td colspan="1" style="width: 30%; height: 26px">
                            <asp:Button ID="Update" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text%> " ValidationGroup="Update"
                                Width="68px" /><asp:Button ID="Cancel" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%> " ValidationGroup="Cancel"
                                Width="68px" /></td>
                    </tr>
                </table>
            </EditItemTemplate>
            <InsertItemTemplate>
                <table id="Table2" border="0" cellpadding="0" cellspacing="2" language="javascript"
                    ...
                    <tr>
                        <td class="FormViewSubHeader" colspan="4" style="width: 20%; height: 26px">
                        <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Personal Information")%> '  /></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                    ...
                    <tr>
                        ...
                        <td style="width: 30%; height: 26px" width="40%">
                            <asp:TextBox ID="FirstNameTextBox" runat="server" Text='<%# Bind("FirstName") %>'
                                ValidationGroup="Insert"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                    runat="server" ControlToValidate="FirstNameTextBox" CssClass="ErrorMessage" Display="Dynamic"
                                    ErrorMessage="*" ValidationGroup="Insert" Width="1px"></asp:RequiredFieldValidator></td>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="MiddleNameTextBox">
                            <asp:Literal ID="Literal12" runat="server" Text='<%# ResourceHelper.GetFromResource("Middle Name:")%> '  /></asp:Label></td>
                        <td style="width: 30%; height: 26px">
                            <asp:TextBox ID="MiddleNameTextBox" runat="server" Text='<%# Bind("MiddleName") %>'></asp:TextBox>
                        </td>
                    </tr>
...
<asp:Label ID="Label7" runat="server" AssociatedControlID="LastNameTextBox">
                            <span class="reqasterisk">*</span> <asp:Literal ID="Literal13" runat="server" Text='<%# ResourceHelper.GetFromResource("Last Name:")%> ' /></asp:Label></td>
                        <td style="width: 30%; height: 26px" width="40%">
                            <asp:TextBox ID="LastNameTextBox" runat="server" Text='<%# Bind("LastName") %>' ValidationGroup="Insert"></asp:TextBox><asp:RequiredFieldValidator
                                ID="RequiredFieldValidator5" runat="server" ControlToValidate="LastNameTextBox"
                                CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="*" ValidationGroup="Insert"
                                Width="1px"></asp:RequiredFieldValidator></td>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                    ...
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            <span class="reqasterisk">*</span> <asp:Literal ID="Literal14" runat="server" Text='<%# ResourceHelper.GetFromResource("External User Client:")%> '  /></td>
                        <td colspan="3" style="height: 26px">
                            <asp:DropDownList ID="ddlExternalUserClientId" runat="server" DataSourceID="dsClientObjectInsert"
                                DataTextField="PartyName" DataValueField="AccountPartyId" SelectedValue='<%# Bind("ExternalUserClientId") %>'
                                Width="490px">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlExternalUserClientId"
                                CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="*" ValidationGroup="Insert"
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="height: 26px">
                            <asp:DropDownList ID="ddlTimeZoneId" runat="server" DataSourceID="dsTimeZone" DataTextField="TimeZoneName"
                                DataValueField="SystemTimeZoneId" Width="490px" SelectedValue='<%# Bind("TimeZoneId") %>'>
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="4" style="width: 20%; height: 26px">
                            <asp:Literal ID="Literal15" runat="server" Text='<%# ResourceHelper.GetFromResource("Login")%> '  /></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            
<asp:Label ID="Label9" runat="server" AssociatedControlID="EMailAddressTextBox">
                            <span class="reqasterisk">* </span><asp:Literal ID="Literal16" runat="server" Text='<%# ResourceHelper.GetFromResource("Login Email Address:")%> '  /></asp:Label></td>
                        <td colspan="3" style="height: 26px">
                            <asp:TextBox ID="EMailAddressTextBox" runat="server" Text='<%# Bind("EMailAddress") %>'
                    ...
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            <span class="reqasterisk">*</span> <asp:Literal ID="Literal19" runat="server" Text='<%# ResourceHelper.GetFromResource("Password:")%> '  /></td>
                        <td style="width: 30%; height: 26px" width="40%">
                            <asp:TextBox ID="PasswordTextBox" runat="server" Text='<%# Bind("Password") %>' TextMode="Password"
                                ValidationGroup="Insert"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                    runat="server" ControlToValidate="PasswordTextBox" CssClass="ErrorMessage" Display="Dynamic"
                                    ErrorMessage="*" ValidationGroup="Insert" Width="16px"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                ControlToValidate="PasswordTextBox" Display="Dynamic" 
                        ...
                        <td align="right" class="FormViewLabelCell" colspan="1" style="width: 20%; height: 26px"
                            valign="middle">
                            <span class="reqasterisk">*</span> <asp:Literal ID="Literal17" runat="server" Text='<%# ResourceHelper.GetFromResource("Verify Password:")%> '  /></td>
                        <td colspan="1" style="width: 30%; height: 26px" valign="middle">
                            <asp:TextBox ID="VerifyPasswordTextbox" runat="server" TextMode="Password" ValidationGroup="Insert"></asp:TextBox><asp:RequiredFieldValidator
                                ID="RequiredFieldValidator3" runat="server" ControlToValidate="VerifyPasswordTextbox"
                                CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="*" ValidationGroup="Insert"></asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="VerifyPasswordTextbox"
                                ControlToValidate="PasswordTextBox" CssClass="ErrorMessage" ErrorMessage="(Mismatch)"
                    ...
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 20%; height: 26px">
                            <span class="reqasterisk">*</span><asp:Literal ID="Literal18" runat="server" Text='<%# ResourceHelper.GetFromResource("Role:")%> '  /></td>
                        <td style="width: 30%; height: 26px" width="40%">
                            <asp:DropDownList ID="ddlAccountRoleId" runat="server" DataSourceID="dsAccountRoleObject"
                                DataTextField="Role" DataValueField="AccountRoleId" SelectedValue='<%# Bind("AccountRoleId") %>'
                                Width="168px">
                    ...
                    <tr>
                        <td class="FormViewLabelCell" colspan="3" style="width: 20%; height: 26px">
                            &nbsp;</td>
                        <td colspan="1" style="width: 30%; height: 26px">
                            <asp:Button ID="Add" runat="server" CommandName="Insert" Text="<%$ Resources:TimeLive.Web, Add_text%> " ValidationGroup="Insert"
                                Width="68px" /></td>
                    </tr>
                </table>
            </InsertItemTemplate>
            <ItemTemplate>
                ...
                State1:
                <asp:Label ID="State1Label" runat="server" Text='<%# Bind("State1") %>'></asp:Label><br />
                Prefix:
                <asp:Label ID="PrefixLabel" runat="server" Text='<%# Bind("Prefix") %>'></asp:Label><br />
                BillingRateStartDate:
                <asp:Label ID="BillingRateStartDateLabel" runat="server" Text='<%# Bind("BillingRateStartDate") %>'>
                </asp:Label><br />
        ...
        <asp:ObjectDataSource ID="dsAccountEmployeeObject" runat="server" DeleteMethod="DeleteAccountEmployee"
