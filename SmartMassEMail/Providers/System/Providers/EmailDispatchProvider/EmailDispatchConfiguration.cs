...
namespace SmartMassEmail.Providers {
	...
	public class EmailDispatchConfiguration {
        ...
        public static EmailDispatchConfiguration GetConfig( )
        {
            return (EmailDispatchConfiguration)ConfigurationManager.GetSection("smartMassEmail.providers/emailDispatch");
		}  
