<%@ control language="vb" autoeventwireup="false" inherits="TimeLive.ctlAccountForm, App_Web_zvpgekji" %>
<%@ Register Assembly="eWorld.UI, Version=2.0.6.2393, Culture=neutral, PublicKeyToken=24d65337282035f2"
    Namespace="eWorld.UI" TagPrefix="ew" %>
    <%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc2" %>
<%@ Register Assembly="eWorld.UI"
    Namespace="eWorld.UI" TagPrefix="ew" %>
&nbsp;<asp:FormView id="FormView1" DefaultMode="Insert" DataSourceID="dsAccountObject" DataKeyNames="AccountId" runat="server" Width="700px" HorizontalAlign=Center>
        <EditItemTemplate><table border="0" cellpadding="2" cellspacing="1" style="width: 775px;" class="xFormView">
            <tr>
                <td align="left" class="caption" colspan="4">
                    <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Provide Your Information") %>' /></td>
            </tr>
            <tr>
                <td align="left" class="FormViewSubHeader" colspan="4">
                <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Organization Information") %>' /></td>
            </tr>
            <tr>
...
<asp:Label ID="Label12" runat="server" AssociatedControlID="FaxTextBox">
            ...
            <tr>
                <td class="FormViewSubHeader" colspan="4" style="height: 21px">
                    <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Application Preferences") %>' /></td>
            </tr>
            <tr>
                ...
                <asp:Literal ID="Literal24" runat="server" Text='<%# ResourceHelper.GetFromResource("Session Time Out") %>' /></asp:Label></td><td 
                    ...
                    class="FormViewLabelCell" colspan="3" style="height: 22px; text-align: left;"><asp:DropDownList 
                        ...
                        Width="368px"><asp:ListItem ID="Label103" runat="server" Label="" 
                            Text="<%$ Resources:TimeLive.Web, Auto%> " Value="auto"></asp:ListItem><%--<asp:ListItem Value="auto">&lt;Auto&gt;</asp:ListItem>--%></asp:DropDownList></td></tr><tr><td 
                    align="right" class="FormViewLabelCell" style="width: 70%; height: 22px"><asp:Literal 
                    ...
                    class="FormViewLabelCell" colspan="3" style="height: 22px; text-align: left;"><asp:DropDownList 
                        ...
                        DataValueField="CurrencySymbol" Width="368px"><asp:ListItem ID="Label100" 
                            runat="server" Label="" Text="<%$ Resources:TimeLive.Web, Auto%> " Value="auto"></asp:ListItem><%--<asp:ListItem Value="$">&lt;Auto&gt;</asp:ListItem>--%></asp:DropDownList></td></tr><tr>
...
<asp:Label ID="Label19" runat="server" AssociatedControlID="FromEmailAddressTextBox">
                    ...
                    class="FormViewLabelCell" colspan="3" style="height: 22px; text-align: left;"><asp:Button 
                        ...
                        Text="<%$ Resources:TimeLive.Web, Update_text%> " /></td></tr><tr>
<%  If AccountPagePermissionBLL.IsPageHasPermissionOf(136, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(113, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(147, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(149, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(1, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(118, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(122, 1) = True Then%> 
                    <td class="FormViewSubHeader" style="height: 21px" colspan="4" align="left">
                    <asp:Literal ID="Literal100" runat="server" Text='<%# ResourceHelper.GetFromResource("Timesheet Setup") %>' /></td>
                    </tr><tr><td 
                    align="right" class="FormViewLabelCell" style="width: 70%; height: 22px"><asp:Literal 
                    ...
                    colspan="3" style="height: 22px"><asp:DropDownList ID="ddlTaskInformation" 
                        runat="server" Width="150px"><asp:ListItem 
                            Text="<%$ Resources:TimeLive.Web, None%> " Value="0"></asp:ListItem><asp:ListItem 
                            Text="<%$ Resources:TimeLive.Web, Parent Task Name%> " Value="1"></asp:ListItem><asp:ListItem 
                            Text="<%$ Resources:TimeLive.Web, Parent Task Code%> " Value="2"></asp:ListItem><asp:ListItem 
                            Text="<%$ Resources:TimeLive.Web, Task Code%> " Value="3"></asp:ListItem></asp:DropDownList></td></tr><tr><td 
                    align="right" class="FormViewLabelCell" style="width: 70%; height: 22px"><asp:Literal 
                    ...
                    colspan="3" style="height: 22px"><asp:DropDownList ID="ddlDefaultTimeEntryMode" 
                        runat="server" AppendDataBoundItems="True" Width="150px"><asp:ListItem 
                            Text="<%$ Resources:TimeLive.Web, Day View%> " Value="Day View"></asp:ListItem><asp:ListItem 
                            Text="<%$ Resources:TimeLive.Web, Period View%> " Value="Period View"></asp:ListItem></asp:DropDownList></td></tr><tr><td 
...
<%  If AccountPagePermissionBLL.IsPageHasPermissionOf(6, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(5, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(107, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(106, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(117, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(114, 1) = True Then%>
                <td class="FormViewSubHeader" colspan="4" style="height: 22px">
                    <asp:Literal ID="Literal82" runat="server" Text='<%# ResourceHelper.GetFromResource("Expense Setup") %>' /></td>
            </tr>
            <tr>
...
<asp:Label ID="Label21" runat="server" AssociatedControlID="txtExpenseSheetPrintFooter">
                ...
                <td colspan="3" style="height: 22px">
                    <asp:Button ID="btnUpdatePrintInfo" runat="server"  Text="<%$ Resources:TimeLive.Web, Update_text%> " OnClick="btnUpdatePrintInfo_Click" ValidationGroup="vgPrintFooter"  /></td></tr>
<%  End If%>
<%  If AccountPagePermissionBLL.IsPageHasPermissionOf(138, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(139, 1) = True Then%> 
                </tr><tr><td class="FormViewSubHeader" style="height: 22px" colspan="4">Time Off Setup</td><tr><td 
                    align="right" class="FormViewLabelCell" style="width: 70%; height: 22px"><asp:Literal 
                    ...
                    colspan="3" style="height: 22px"><asp:CheckBox ID="chkShowProjectForTimeOff" 
                        ...
                        style="width: 70%; height: 22px">&nbsp;</td><td colspan="3" style="height: 22px"><asp:Button 
                            ...
                            Text="<%$ Resources:TimeLive.Web, Update_text%> " /></td></tr><tr><%  End If%><%  If AccountPagePermissionBLL.IsPageHasPermissionOf(12, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(76, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(33, 1) = True Or AccountPagePermissionBLL.IsPageHasPermissionOf(103, 1) = True Then%><td 
                        class="FormViewSubHeader" colspan="4" style="height: 22px"><asp:Literal 
                        ID="Literal90" runat="server" 
                        Text='<%# ResourceHelper.GetFromResource("Project Setup") %>' /></td></tr><tr><td 
                        align="right" class="FormViewLabelCell" style="width: 70%; height: 22px"><asp:Literal 
                        ...
                        Text='<%# ResourceHelper.GetFromResource("Task Setup") %>' /></td></tr><tr><td 
                        align="right" class="FormViewLabelCell" style="width: 70%; height: 22px"><asp:Literal 
                        ...
                        style="height: 22px"><asp:Button ID="btnUpdateTaskInfo" runat="server" 
                            ...
                            Text="<%$ Resources:TimeLive.Web, Update_text%> " /></td></tr><tr><%  End If%><%  If AccountPagePermissionBLL.IsPageHasPermissionOf(2, 1) = True Then%><td 
                        class="FormViewSubHeader" colspan="4" style="height: 22px"><asp:Literal 
                        ID="Literal89" runat="server" 
                        Text='<%# ResourceHelper.GetFromResource("Invoice Setup") %>' /></td></tr><tr><td 
                ...
                Text='<%# ResourceHelper.GetFromResource("Invoice No Prefix:") %>' /></asp:Label></td><td 
                        ...
                        style="height: 22px; width: 55%;"></td><td colspan="3" style="height: 22px"><asp:Button 
                            ...
                            Text="<%$ Resources:TimeLive.Web, Update_text%> " /></td></tr><tr><%  End If%><%If System.Configuration.ConfigurationManager.AppSettings("DISABLE_LICENSE") <> "Yes" Then%><%If System.Configuration.ConfigurationManager.AppSettings("ApplicationMode") = "Hosted" Then %><tr><td 
                        class="FormViewSubHeader" colspan="4" style="height: 22px"><asp:Literal 
                        ID="Literal67" runat="server" 
                        Text='<%# ResourceHelper.GetFromResource("Package Plan:") %>' /></td></tr><tr><td 
                            ...
                            colspan="3" style="height: 22px"><asp:Label ID="lblNumberOfUsersForHosted" 
                                runat="server" CssClass="ErrorMessage" Width="192px"></asp:Label></td></tr><tr><td 
                            class="FormViewSubHeader" colspan="4" style="height: 22px"><asp:Literal 
                            ID="Literal64" runat="server" 
                            Text='<%# ResourceHelper.GetFromResource("Account Expiry") %>' /></td></tr><tr><td 
                            align="right" class="FormViewLabelCell" style="width: 55%; height: 22px"><asp:Literal 
                            ...
                            colspan="3" style="width: 15%; height: 22px"><asp:Label ID="Label26" 
                                ...
                                Text="<%$ Resources:TimeLive.Web, TimeLive supports unlimited users support up to 30 days. After 30 days it converts to 5 users free account%> "></asp:Label></td></tr><%End If %><% If System.Configuration.ConfigurationManager.AppSettings("ApplicationMode") = "Installed" Then%><tr><td 
                            align="left" class="FormViewSubHeader" colspan="4" style="height: 22px"><asp:Literal 
                            ID="Literal4" runat="server" 
                            Text='<%# ResourceHelper.GetFromResource("License Activation") %>' /></td></tr><tr><td 
            ...
            Text='<%# ResourceHelper.GetFromResource("License Key") %>' /></asp:Label></td><td 
                            ...
                            colspan="3" style="height: 22px"><asp:RadioButton ID="rdManualActivation" 
                                ...
                                Text="<%$ Resources:TimeLive.Web, Activation Failed%>" Visible="False"></asp:Label></td></tr><tr><td 
                            align="right" class="FormViewLabelCell" style="width: 55%; height: 22px"><asp:Label 
                ...
                Text='<%# ResourceHelper.GetFromResource("Machine Key:") %>' /></asp:Label></td><td 
                            ...
                            colspan="3" style="width: 15%; height: 22px"><asp:Label ID="Label1" 
                                runat="server" CssClass="ErrorMessage" 
                                Text="<%$ Resources:TimeLive.Web, TimeLive supports unlimited users support up to 30 days. After 30 days it converts to 5 users free account%> "></asp:Label></td></tr><%End If%><tr><td 
                            align="right" style="width: 35%;"></td><td colspan="3"><asp:Button 
                                ID="cmdActivateSerial" runat="server" OnClick="cmdActivateSerial_Click" 
                                Text='<%# ResourceHelper.GetFromResource("Activate") %>' /></td></tr><%End If %><%End If %><tr><td 
                            align="left" class="FormViewSubHeader" colspan="4" style="height: 22px"><asp:Literal 
                            ID="Literal5" runat="server" 
                            Text='<%# ResourceHelper.GetFromResource("Upload Own Company Logo") %>' /></td></tr><tr><td 
                            align="right" class="formviewlabelcell" style="width: 55%; height: 22px"><asp:Literal 
                            ...
                            style="height: 22px"><asp:Button ID="btnUpload" runat="server" 
                                OnClick="btnUpload_Click" Text="<%$ Resources:TimeLive.Web, Update_Text%> " /></td></tr></tr></tr></table>
        ...
        <InsertItemTemplate>
            <table border="0" cellpadding="2" cellspacing="1" style="width: 100%; height: 31%; border-right: black 1px solid; border-top: black 1px solid; border-left: black 1px solid; border-bottom: black 1px solid;" class="xFormView">
                <tr>
                    <td class="caption" colspan="2" width="30%" align="left">
                        <asp:Literal ID="Literal1" runat="server" Text="Provide Your Information" /></td>
                </tr>
                <tr>
                    <td class="FormViewSubHeader" colspan="2" style="height: 22px" width="30%" align="left">
                        <asp:Literal ID="Literal5" runat="server" Text="Account Information (Organization Information)" /></td>
                </tr>
                <tr>
                    <td style="height: 22px;" class="FormViewLabelCell" width="30%" align="right">
                        <SPAN 
                  class=reqasterisk>*</SPAN><asp:Literal ID="Literal32" runat="server" Text="Organization Information:" /></td>
                    <td style="width: 65%; height: 22px;">
                  <asp:TextBox id="AccountName" runat="server" Text='<%# Bind("AccountName") %>' Width="264px" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="AccountName"
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="Address1TextBox">
                        <asp:Literal ID="Literal33" runat="server" Text="Address1:" /></asp:Label></td><td style="width: 65%; height: 23px;">
            <asp:TextBox ID="Address1TextBox" runat="server" Text='<%# Bind("Address1") %>' Width="232px"></asp:TextBox></td></tr><tr>
                    <td style="height: 24px;" class="FormViewLabelCell" width="30%" align="right">
                        
<asp:Label ID="Label5" runat="server" AssociatedControlID="Address2TextBox">
                        <asp:Literal ID="Literal34" runat="server" Text="Address2:" /></asp:Label></td><td style="width: 65%; height: 24px;">
            <asp:TextBox ID="Address2TextBox" runat="server" Text='<%# Bind("Address2") %>' Width="232px"></asp:TextBox></td></tr><tr>
                    <td style="height: 24px;" class="FormViewLabelCell" width="30%" align="right">
                        
<asp:Label ID="Label7" runat="server" AssociatedControlID="ZipCodeTextBox">
                        <asp:Literal ID="Literal35" runat="server" Text="Zipcode" /></asp:Label></td><td style="width: 65%; height: 24px;">
            <asp:TextBox ID="ZipCodeTextBox" runat="server" Text='<%# Bind("ZipCode") %>' Width="72px"></asp:TextBox></td></tr><tr>
                    <td align="right" class="FormViewLabelCell" style="height: 22px" width="30%">
                        <asp:Literal ID="Literal36" runat="server" Text="State / Province:" /></td>
                    <td style="width: 65%; height: 22px">
                        <asp:TextBox ID="StateTextBox" runat="server" Text='<%# Bind("State") %>'></asp:TextBox></td></tr><tr>
                    <td style="height: 22px" class="FormViewLabelCell" width="30%" align="right">
                            
<asp:Label ID="Label9" runat="server" AssociatedControlID="CityTextBox">
                        <asp:Literal ID="Literal37" runat="server" Text="City:" /></asp:Label></td><td style="width: 65%; height: 22px">
            <asp:TextBox ID="CityTextBox" runat="server" Text='<%# Bind("City") %>'></asp:TextBox></td></tr><tr>
                    <td style="height: 22px" class="FormViewLabelCell" width="30%" align="right">
                        <SPAN 
                  class=reqasterisk>*</SPAN><asp:Literal ID="Literal38" runat="server" Text="Country:" /></td> 
                    <td style="width: 65%; height: 22px"><asp:DropDownList ID="ddlCountryId" runat="server" DataSourceID="dsCountryObject"
                DataTextField="Country" DataValueField="CountryId"  SelectedValue='<%# Bind("CountryId") %>' Width="152px" >
                    </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="height: 21px" class="FormViewLabelCell" width="30%" align="right">
                        
<asp:Label ID="Label11" runat="server" AssociatedControlID="TelephoneTextBox">
                        <asp:Literal ID="Literal39" runat="server" Text="Telephone:" /></asp:Label></td><td style="width: 65%; height: 21px">
            <asp:TextBox ID="TelephoneTextBox" runat="server" Text='<%# Bind("Telephone") %>'></asp:TextBox></td></tr><tr>
                    <td style="height: 22px" class="FormViewLabelCell" width="30%" align="right">
            
<asp:Label ID="Label13" runat="server" AssociatedControlID="FaxTextBox">
            <asp:Literal ID="Literal40" runat="server" Text="Fax:" /></asp:Label></td><td style="width: 65%; height: 22px">
            <asp:TextBox ID="FaxTextBox" runat="server" Text='<%# Bind("Fax") %>'></asp:TextBox></td></tr><tr>
                    <td style="height: 22px" class="FormViewLabelCell" width="30%" align="right">
                        <asp:Literal ID="Literal41" runat="server" Text="Default Currency:" /></td>
                        <td style="width: 65%; height: 22px"><asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="dsCurrencyObject"
                DataTextField="CurrencyCode" DataValueField="CurrencyId"  SelectedValue='<%# Bind("DefaultCurrencyId") %>' Width="149px" >
                    </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="FormViewLabelCell" style="height: 22px" width="30%">
                    <asp:Literal ID="Literal71" runat="server" Text="User Interface Language:" />
                    <td>
                        <asp:DropDownList ID="ddlUserInterfaceLanguage" runat="server" Width="149px" AppendDataBoundItems="True" >
                            <asp:ListItem Value="en-US">English (United States)</asp:ListItem><asp:ListItem 
                    ...
                    <td align="right" class="FormViewLabelCell" style="height: 22px" width="30%">
                        <asp:Literal ID="Literal42" runat="server" Text="TimeZone:" /></td>
                    <td style="width: 65%; height: 22px">
                        <asp:DropDownList ID="ddlTimeZoneId" runat="server" DataSourceID="dsTimeZone"
                DataTextField="TimeZoneName" DataValueField="SystemTimeZoneId"  SelectedValue='<%# Bind("TimeZoneId") %>' Width="368px" >
                        </asp:DropDownList>
                ...
                <tr>
                    <td style="height: 22px" class="FormViewSubHeader" colspan="2" width="30%" align="left">
                        <asp:Literal ID="Literal68" runat="server" Text="Login Information:" /></td>
                </tr>
                ...
                <tr>
                    <td align="right" class="FormViewLabelCell" style="height: 22px" width="30%">
                        ...
                        <asp:TextBox ID="UsernameTextBox" runat="server" Text='<%# Bind("EmployeeLogin") %>'
                            Width="200px" OnTextChanged="UsernameTextBox_TextChanged" AutoPostBack="True"></asp:TextBox><br /><asp:CustomValidator ID="CustomValidator2" runat="server" CssClass="ErrorMessage"
                    ...
                    <td align="right" class="FormViewLabelCell" style="height: 22px" width="30%">
                        ...
                        <td style="width: 65%; height: 22px">
                        <asp:TextBox ID="EmployeeEMailAddress" runat="server" Text='<%# Bind("EmployeeEMailAddress") %>'
                            Width="200px" OnTextChanged="EmployeeEMailAddress_TextChanged"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="EmployeeEMailAddress"
                            ...
                            Visible="False"></asp:Label><%If LDAP.IsAspNetActiveDirectoryMembershipProvider <> True Then%><br /><asp:Label ID="Label3" runat="server" CssClass="ErrorMessage" Text="<%$ Resources:TimeLive.Web, This Email Address will be [Administrator] login name.%> "
                                Visible="True"></asp:Label><%End IF %></td></tr><tr>
                    <td style="height: 22px" class="FormViewLabelCell" width="30%" align="right">
                        <SPAN 
                  class=reqasterisk>*</SPAN><asp:Literal ID="Literal45" runat="server" Text="Password:" /></td>
                    <td style="width: 65%; height: 22px">
                        <asp:TextBox ID="PasswordTextBox" runat="server" Text='<%# Bind("EmployeePassword") %>' TextMode="Password" Width="192px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="PasswordTextBox"
                            Display="Dynamic" ErrorMessage="*" Width="1px"></asp:RequiredFieldValidator></td></tr><tr>
                    <td style="height: 22px" class="FormViewLabelCell" width="30%" align="right">
                        <SPAN 
                  class=reqasterisk>*</SPAN><asp:Literal ID="Literal46" runat="server" Text="Verify:" /></td>
                    <td style="width: 65%; height: 22px">
                        <asp:TextBox ID="VerifyPasswordTextBox" runat="server"  TextMode="Password" Width="192px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="PasswordTextBox"
                  ...
                  class=reqasterisk>*</SPAN><asp:Literal ID="Literal48" runat="server" Text="First Name:" /></td>
                    <td style="width: 65%; height: 22px">
                        <asp:TextBox ID="FirstNameTextBox" runat="server" Text='<%# Bind("EmployeeFirstName") %>' Width="184px" MaxLength="75"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="FirstNameTextBox"
                            Display="Dynamic" ErrorMessage="*" Width="1px"></asp:RequiredFieldValidator></td></tr><tr>
                    <td style="height: 22px" class="FormViewLabelCell" width="30%" align="right">
                        <asp:Literal ID="Literal49" runat="server" Text="Middle Name:" /></td>
                    <td style="width: 65%; height: 22px">
                        <asp:TextBox ID="MiddleNameTextBox" runat="server" Text='<%# Bind("EmployeeMiddleName") %>' MaxLength="20" ></asp:TextBox></td></tr><tr>
                    <td style="height: 22px" class="FormViewLabelCell" width="30%" align="right">
                        <SPAN 
                  class=reqasterisk>*</SPAN><asp:Literal ID="Literal50" runat="server" Text="Last Name:" /></td>
                    <td style="width: 65%; height: 22px">
                        <asp:TextBox ID="LastNameTextBox" runat="server" Text='<%# Bind("EmployeeLastName") %>' Width="184px" MaxLength="75"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="LastNameTextBox"
                            Display="Dynamic" ErrorMessage="*" Width="1px"></asp:RequiredFieldValidator></td></tr><tr>
                    <td style="height: 22px" width="30%" align="right">
                    </td>
                    <td style="width: 65%; height: 22px">
                        <asp:Button ID="Button1" runat="server"  Text="<%$ Resources:TimeLive.Web, Sign Up%> " CommandName="Insert"  />
                        <asp:CustomValidator ID="CustomValidatorInsert" runat="server" CssClass="ErrorMessage"
            ...
            <asp:Literal ID="Literal43" runat="server" Text="<%$ Resources:TimeLive.Web, Account Id %> " />
            <asp:Label ID="AccountIdLabel" runat="server" Text='<%# Eval("AccountId") %>'></asp:Label><br  /><asp:Literal ID="Literal51" runat="server" Text="<%$ Resources:TimeLive.Web, Account Type Id %> " />
            <asp:Label ID="AccountTypeIdLabel" runat="server" Text='<%# Bind("AccountTypeId") %>'>
            </asp:Label><br  /><asp:Literal ID="Literal52" runat="server" Text="<%$ Resources:TimeLive.Web, Account Login %> " />
            <asp:Label ID="AccountLoginLabel" runat="server" Text='<%# Bind("AccountLogin") %>'>
            </asp:Label><br  /><asp:Literal ID="Literal53" runat="server" Text="<%$ Resources:TimeLive.Web, Account Name %> " />
            <asp:Label ID="AccountNameLabel" runat="server" Text='<%# Bind("AccountName") %>'>
            </asp:Label><br  /><asp:Literal ID="Literal54" runat="server" Text="<%$ Resources:TimeLive.Web, Address1%> " />
            <asp:Label ID="Address1Label" runat="server" Text='<%# Bind("Address1") %>'></asp:Label><br  /><asp:Literal ID="Literal55" runat="server" Text="<%$ Resources:TimeLive.Web, Address2%> " />
            <asp:Label ID="Address2Label" runat="server" Text='<%# Bind("Address2") %>'></asp:Label><br  /><asp:Literal ID="Literal56" runat="server" Text="<%$ Resources:TimeLive.Web, Zipcode%> " />
            ...
            </asp:Label><br  /><asp:Literal ID="Literal58" runat="server" Text="<%$ Resources:TimeLive.Web, Telephone %> " />
            <asp:Label ID="TelephoneLabel" runat="server" Text='<%# Bind("Telephone") %>'></asp:Label><br  /><asp:Literal ID="Literal59" runat="server" Text="<%$ Resources:TimeLive.Web, Fax %> " />
            ...
            </asp:Label><br  /><asp:Literal ID="Literal66" runat="server" Text="<%$ Resources:TimeLive.Web, City%> " />
            <asp:Label ID="CityLabel" runat="server" Text='<%# Bind("City") %>'></asp:Label><br  />Country: <asp:Label ID="CountryIdLabel" runat="server" Text='<%# Bind("CountryId") %>'></asp:Label><br  /><asp:LinkButton ID="EditButton" runat="server" CausesValidation="False" CommandName="Edit"
                Text="<%$ Resources:TimeLive.Web, Edit_text%> ">
                ...
                Text="<%$ Resources:TimeLive.Web, New_text%> ">
            </asp:LinkButton></ItemTemplate></asp:FormView><br />
