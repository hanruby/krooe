...
Public Class AccountTimeOffPolicyBLL
    ...
    Public Function AddAccountTimeOffPolicyDetail( _
           ...
           ByVal MaximumAvailable As Double, ByVal EffectiveDate As System.Nullable(Of Date) _
           ) As Boolean
    ...
    Public Function UpdateAccountTimeOffPolicyDetail( _
      ...
      ByVal MaximumAvailable As Decimal, ByVal EffectiveDate As System.Nullable(Of Date) _
       ) As Boolean
