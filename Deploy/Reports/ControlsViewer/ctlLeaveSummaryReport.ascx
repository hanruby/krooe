<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsViewer_ctlLeaveSummaryReport, App_Web_or234bqc" %>
        ...
        <table class="xFormView" style="width: 400px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Leave Summary Report%> " /></td>
            </tr>
            <tr>
