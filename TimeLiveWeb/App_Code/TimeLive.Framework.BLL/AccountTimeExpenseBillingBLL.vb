...
Public Class AccountTimeExpenseBillingBLL
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetvueAccountTimeExpenseBillingTimesheetByAccountClientId(ByVal AccountClientId As Integer, ByVal BillingCycleStartDate As Date, ByVal BillingCycleEndDate As Date, ByVal AccountProjectId As Integer, ByVal IsBillable As String) As AccountTimeExpenseBilling.vueAccountTimeExpenseBillingTimesheetDataTable
        GetvueAccountTimeExpenseBillingTimesheetByAccountClientId = Adapterss.GetDataByAccountClientId(AccountClientId, BillingCycleStartDate, BillingCycleEndDate, AccountProjectId, IsBillable)
    ...
    Public Function GetvueAccountTimeExpenseBillingTimesheetByAccountClientIdWithTimeEntryGroup(ByVal AccountClientId As Integer, ByVal BillingCycleStartDate As Date, ByVal BillingCycleEndDate As Date, ByVal AccountProjectId As Integer, ByVal IsBillable As String) As AccountTimeExpenseBilling.vueAccountTimeExpenseBillingTimesheetDataTable
        GetvueAccountTimeExpenseBillingTimesheetByAccountClientIdWithTimeEntryGroup = Adapterss.GetDataByAccountClientIdAndGroupByTimeEntry(AccountClientId, BillingCycleStartDate, BillingCycleEndDate, AccountProjectId, IsBillable)
        'Return AddBlankRowsInDataTable(GetvueAccountTimeExpenseBillingTimesheetByAccountClientId)
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetvueAccountTimeExpenseBillingTimesheetByAccountTimeExpenseBillingId(ByVal AccountTimeExpenseBillingId As Guid, ByVal IsPopulate As Boolean) As AccountTimeExpenseBilling.ViewAccountTimeExpenseBillingTimesheetforEditDataTable
        ...
        'Else
        'Return GetvueAccountTimeExpenseBillingTimesheetByAccountTimeExpenseBillingId
        'End If
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
...
Public Function GetAccountTimeExpenseBillingExpenseByAccountTimeExpenseBillingId(ByVal AccountTimeExpenseBillingId As Guid) As AccountTimeExpenseBilling.AccountTimeExpenseBillingExpenseDataTable
    ...
    ByVal TaxCode2 As Double, ByVal GrandTotal As Double, ByVal IsPaid As Boolean, ByVal Terms As String, ByVal BankDetails As String) As Boolean
    ...
    ByVal SubTotal As Double, ByVal TaxCode1 As Double, ByVal TaxCode2 As Double, ByVal GrandTotal As Double, ByVal Terms As String, ByVal BankDetails As String) As Boolean
