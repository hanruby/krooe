<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ctlAttendanceDetailReport.ascx.vb" Inherits="Reports_ControlsViewer_ctlAttendanceDetailReport" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        <table class="xFormView" style="width: 350px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Attendance Detail Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 70%;">
                    <ew:calendarpopup id="txtStartDate" runat="server"></ew:calendarpopup>
                </td>
            </tr>
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 30%">
                ...
                <td style="width: 70%">
                    <ew:calendarpopup id="txtEndDate" runat="server"></ew:calendarpopup>
                </td>
            </tr>
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 30%">
        ...
        <asp:ObjectDataSource ID="dsEmployeesObject" runat="server" OldValuesParameterFormatString="original_{0}"
            ...
            <SelectParameters>
                <asp:SessionParameter DefaultValue="67" Name="AccountId" SessionField="AccountId"
                    Type="Int32" />
            </SelectParameters>
