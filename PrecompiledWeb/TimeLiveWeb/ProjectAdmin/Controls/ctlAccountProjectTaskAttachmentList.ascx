<%@ control language="VB" autoeventwireup="false" inherits="ProjectAdmin_Controls_ctlAccountProjectTaskAttachmentList, App_Web_lth4bcqk" %>
...
<table style="width: 400px" class="xview">
    <tr>
        <td class="caption" colspan="2">
            <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Project Task Information%> " /></td>
    </tr>
    <tr>
        <td style="width: 150px" align="right" class="FormViewLabelCell">
            <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:TimeLive.Web, Task Id:%> " /></td>
        </td>
    ...
    <tr>
        <td style="width: 150px" align="right" class="FormViewLabelCell">
            <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Web, Project Name:%> " /></td>
        </td>
        <td style="width: 250px">
    ...
    <tr>
        <td align="right" class="FormViewLabelCell" style="width: 150px">
            <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:TimeLive.Web, Task Name:%> " /></td>
        </td>
        <td style="width: 250px">
...
<x:GridView id="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        Caption="<%$ Resources:TimeLive.Web, Attachment List %>" 
        OnRowDataBound="GridView1_RowDataBound" OnRowCreated="GridView1_RowCreated"><Columns>
<asp:BoundField ReadOnly="True" DataField="AccountProjectTaskAttachmentId" InsertVisible="False" SortExpression="AccountProjectTaskAttachmentId" HeaderText="<%$ Resources:TimeLive.Web, Id%> ">
...
<asp:BoundField DataField="AttachmentName" SortExpression="AttachmentName" HeaderText="<%$ Resources:TimeLive.Web, Attachment Name%> ">
...
<asp:BoundField DataField="ModifiedByEmployeeId" Visible="False" SortExpression="ModifiedByEmployeeId" HeaderText="ModifiedByEmployeeId"></asp:BoundField>
     ...
     <ItemTemplate> 
       <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete"
                    ...
                    Text="Delete" Visible='<%# Eval("AccountProjectTaskAttachmentId")>=0 %>' />
     </ItemTemplate>
        </asp:TemplateField>
</Columns>
...
<InsertItemTemplate>
<TABLE style="width: 100%" class="xview"><TBODY><TR><TD class="caption" colSpan=2 width="20%"><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Project Task Attachment Information%> " /></TD></TR><TR><TD class="FormViewSubHeader" colSpan=2 width="20%"><asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Project Task Attachment%> " /></TD></TR><TR><TD class="FormViewLabelCell" align="right" width="20%">            <SPAN 
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Attachment Name:%> " /></td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="AttachmentNameTextBox"
        Display="Dynamic" ErrorMessage="*" ValidationGroup="Attachment"></asp:RequiredFieldValidator></TD></TR><TR><TD class="FormViewLabelCell" align="right" width="20%">            <SPAN 
                  class=reqasterisk>*</SPAN> <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, File Path:%> " /></td>
                  </TD><TD style="WIDTH: 32%">
                      <asp:FileUpload ID="AttachmentFileUpload" runat="server" Width="500px" /></TD></TR><TR><TD align="right" width="20%" style="height: 26px"></TD><TD style="WIDTH: 32%; height: 26px;"><asp:Button id="Upload" runat="server" Text="<%$ Resources:TimeLive.Web, Upload_text%> " ValidationGroup="Attachment" OnClick="Upload_Click"></asp:Button></TD></TR></TBODY></TABLE>
</InsertItemTemplate>
<ItemTemplate>
