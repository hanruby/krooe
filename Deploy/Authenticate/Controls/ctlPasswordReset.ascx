<%@ control language="VB" autoeventwireup="false" inherits="Authenticate_Controls_ctlPasswordReset, App_Web_m01bsgis" %>
<br />
<br />
<br />
<br />
...
<br />
<br />
<table width="700" class="xFormView" align ="center" valign ="middle">
    <tr>
        <td class="caption" colspan="2" style="height: 21px">
            <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Trouble Accessing Your Account%>" /></td>
            </tr>
    <tr>
    ...
    <tr>
        <td align="right" class="FormViewLabelCell" style="width: 35%">
            <asp:Literal ID="Literal19" runat="server" Text="<%$ Resources:TimeLive.Web, Email Address%>" />:</td>
        <td style="width: 65%">
    ...
    <tr>
        ...
        <td style="width: 65%">
            <asp:Button ID="btnPasswordReset" runat="server" Text="<%$ Resources:TimeLive.Web, Reset Password %>" Width="105px" /></td>
    </tr>
    <tr>
        <td colspan="2">
