...
<System.ComponentModel.DataObject()> Public Class AccountProjectTaskCommentsBLL
    ...
    Public Function GetAccountProjectTaskCommentssByAccountProjectTaskId(ByVal AccountProjectTaskId As Long, Optional ByVal NotFixTable As Boolean = False) As TimeLiveDataSet.vueAccountProjectTaskCommentsDataTable
        ...
        strCacheKey = CacheManager.GetCacheKeyForAccountsData("vueAccountProjectTaskCommentsDataTable", "GetAccountProjectTaskCommentssByAccountProjectTaskId", "AccountProjectTaskId=" & AccountProjectTaskId)

        If Not CacheManager.GetItemFromCache(strCacheKey) Is Nothing Then
            GetAccountProjectTaskCommentssByAccountProjectTaskId = CacheManager.GetItemFromCache(strCacheKey)
        Else
            GetAccountProjectTaskCommentssByAccountProjectTaskId = vueAdapter.GetDataByAccountProjectTaskId(AccountProjectTaskId)
            CacheManager.AddAccountDataInCache(GetAccountProjectTaskCommentssByAccountProjectTaskId, strCacheKey)
        End If
