<%@ control language="VB" autoeventwireup="false" inherits="Employee_Controls_ctlAccountEmployeeAttendanceList, App_Web_uitpp31g" %>
...
<asp:UpdatePanel ID="UP" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
<x:GridView ID="GV" runat="server" AutoGenerateColumns="False" Caption="<%$ Resources:TimeLive.Web, Employee Attendance List %>"
    DataKeyNames="AccountEmployeeAttendanceId" DataSourceID="dsAccountEmployeeAttendanceObject"
    SkinID="xgridviewSkinEmployee" AllowSorting="True" Width="296px">
    <Columns>
        <asp:BoundField DataField="AccountEmployeeAttendanceId" HeaderText="<%$ Resources:TimeLive.Web, Id %>" InsertVisible="False"
            ReadOnly="True" SortExpression="AccountEmployeeAttendanceId" />
        <asp:BoundField DataField="InOut" HeaderText="<%$ Resources:TimeLive.Web, In/Out %>" SortExpression="InOut" />
        <asp:BoundField DataField="AttendanceTime" HeaderText="<%$ Resources:TimeLive.Web, Time %>" SortExpression="AttendanceTime" DataFormatString="{0:t}" HtmlEncode="False">
            <ItemStyle HorizontalAlign="Center" />
            <HeaderStyle HorizontalAlign="Center" />
        </asp:BoundField>
        <asp:BoundField DataField="AbsenceDescription" HeaderText="<%$ Resources:TimeLive.Web, Absent %>" SortExpression="AccountEmployeeId" >
...
<asp:ObjectDataSource ID="dsAccountEmployeeAttendanceObject" runat="server" DeleteMethod="DeleteAccountEmployeeAttendance"
    ...
    SelectMethod="GetAccountEmployeeAttendanceByAttendanceDate" TypeName="AccountEmployeeAttendanceBLL"
...
<asp:ObjectDataSource ID="dsAccountEmployeeAttendanceFormObject" runat="server" DeleteMethod="DeleteAccountEmployeeAttendance"
    ...
    DataSourceID="dsAccountEmployeeAttendanceFormObject" DefaultMode="Insert" SkinID="formviewSkinEmployee" Width="350px">
    <EditItemTemplate><table width="100%" class="xview">
        <tr>
            <td class="caption" colspan="2" style="height: 21px">
                <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Employee Attendance Information%> " /></td>
        </tr>
        <tr>
            <td class="FormViewSubHeader" colspan="2" style="height: 21px">
                <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Employee Attendance%> " /></td>
        </tr>
        <tr>
            <td style="width: 30%; height: 26px;" align="right" class="FormViewLabelCell">
                <SPAN 
                  class=reqasterisk>*</span> <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, In/Out:%> " /></td>
            <td style="width: 70%; height: 26px;">
                <asp:DropDownList ID="DropDownList1" runat="server" SelectedValue='<%# Bind("InOut") %>'>
        ...
        <tr>
            <td align="right" class="FormViewLabelCell" style="width: 30%; height: 26px">
                <SPAN 
                  class=reqasterisk>*</span> <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Time:%> " /></td>
            <td style="width: 70%; height: 26px">
        ...
        <tr>
            <td align="right" class="FormViewLabelCell" style="width: 30%; height: 26px">
                <SPAN 
                  class=reqasterisk>*</span> <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Absence:%> " /></td>
            <td style="width: 70%; height: 26px">
                <asp:DropDownList ID="ddlAccountAbsenceTypeId" runat="server" DataSourceID="dsAccountAbsenceTypeObject"
                        DataTextField="AbsenceDescription" DataValueField="AccountAbsenceTypeId" AppendDataBoundItems="True">
        ...
        <tr>
            ...
            <td style="width: 70%; height: 26px;">
                <asp:Button ID="Update" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text%> " Width="50px" />
                <asp:Button ID="Cancel" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%> " Width="50px" /></td>
        </tr>
    </table>
    </EditItemTemplate>
    <InsertItemTemplate>
        <table width="100%" class="xview">
            <tr>
                <td class="caption" colspan="2" style="height: 21px">
                   <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Employee Attendance Information%> " /></td>
            </tr>
            <tr>
                <td class="FormViewSubHeader" colspan="2" style="height: 21px">
                    <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:TimeLive.Web, Employee Attendance%> " /></td>
            </tr>
            <tr>
                <td style="width: 30%; height: 26px;" align="right" class="FormViewLabelCell">
                    <SPAN 
                  class=reqasterisk>*</span> <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Web, In/Out:%> " /></td>
                <td style="width: 70%; height: 26px;">
                    <asp:DropDownList ID="DropDownList1" runat="server" SelectedValue='<%# Bind("InOut") %>'>
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem>In</asp:ListItem>
            ...
            <tr>
                <td align="right" class="FormViewLabelCell" style="width: 30%; height: 26px">
                    <SPAN 
                  class=reqasterisk>*</span> <asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:TimeLive.Web, Time:%> " /></td>
                <td style="width: 70%; height: 26px">
                    <asp:TextBox ID="AttendanceTime" runat="server" 
            ...
            <tr>
                <td align="right" class="FormViewLabelCell" style="width: 30%; height: 26px">
                    <SPAN 
                  class=reqasterisk>*</span> <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:TimeLive.Web, Absence:%> " /></td>
                <td style="width: 70%; height: 26px">
                    <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="dsAccountAbsenceTypeObjectInsert"
                        DataTextField="AbsenceDescription" DataValueField="AccountAbsenceTypeId" SelectedValue='<%# Bind("AccountAbsenceTypeId") %>' AppendDataBoundItems="True">
                        <asp:ListItem Selected="True" Value="0">Present</asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            <tr>
                ...
                <td style="width: 70%; height: 26px;">
                    <asp:Button ID="Button1" runat="server" CommandName="Insert" Text="<%$ Resources:TimeLive.Web, Add_text%> " Width="71px" /></td>
            </tr>
        </table>
    </InsertItemTemplate>
    <ItemTemplate>
