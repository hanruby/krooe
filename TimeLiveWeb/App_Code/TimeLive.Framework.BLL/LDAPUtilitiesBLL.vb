...
Public Class LDAPUtilitiesBLL
    Public Shared Function root() As DirectoryEntry
        Return New DirectoryEntry(System.Configuration.ConfigurationManager.ConnectionStrings("ADService").ConnectionString, UIUtilities.GetADConnectionUsername, UIUtilities.GetADConnectionPassword)
    End Function
    ...
    Public Function IsAspNetActiveDirectoryMembershipProvider() As Boolean
        If Membership.Provider.Name = "AspNetActiveDirectoryMembershipProvider" Or Membership.Provider.Name = "LiveLDAPMembershipProvider" Then
            Return True
        Else
            Return False
        End If
