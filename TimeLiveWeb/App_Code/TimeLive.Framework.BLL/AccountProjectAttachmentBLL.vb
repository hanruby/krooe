...
Public Class AccountProjectAttachmentBLL
    ...
    Public Function GetAccountProjectAttachmentsByAccountProjectId(ByVal AccountProjectId As Integer, Optional ByVal NotFixTable As Boolean = False) As AccountProject.AccountProjectAttachmentDataTable
        ...
        strCacheKey = CacheManager.GetCacheKeyForAccountsData("AccountProjectAttachmentDataTable", "GetAccountProjectAttachmentsByAccountProjectId", "AccountProjectId=" & AccountProjectId)

        If Not CacheManager.GetItemFromCache(strCacheKey) Is Nothing Then
            GetAccountProjectAttachmentsByAccountProjectId = CacheManager.GetItemFromCache(strCacheKey)
        Else
            GetAccountProjectAttachmentsByAccountProjectId = Adapter.GetDataByAccountProjectId(AccountProjectId)
            CacheManager.AddAccountDataInCache(GetAccountProjectAttachmentsByAccountProjectId, strCacheKey)
        End If
