<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountProjectTypeList, App_Web_qfntt3rg" %>
...
<x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountProjectTypeId"
    ...
    <Columns>
        <asp:TemplateField InsertVisible="False" SortExpression="AccountProjectTypeId">
            <edititemtemplate>
...
<asp:Label id="Label1" runat="server" Text='<%# Bind("AccountProjectTypeId") %>' __designer:wfdid="w141"></asp:Label> 
        ...
        <asp:TemplateField SortExpression="ProjectType">
            <edititemtemplate>
        ...
        <table style="width: 100%" class="xview">
            <tr>
                <td class="caption" colspan="2" style="width: 40%; height: 21px">
                    <asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("Project Type Information")%> ' /></td>
            </tr>
            <tr>
                <td class="FormViewSubHeader" colspan="2" style="width: 40%; height: 21px">
                    <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Project Type")%> ' /></td>
            </tr>
            <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="ProjectTypeTextBox">
                  <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Project Type:")%> ' /></asp:Label></td>
                <td style="width: 70%; height: 26px;">
        <asp:TextBox ID="ProjectTypeTextBox" runat="server" Text='<%# Bind("ProjectType") %>' MaxLength="100"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
            ControlToValidate="ProjectTypeTextBox" Display="Dynamic" ErrorMessage="*"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 70%; height: 26px;">
                    <asp:Button ID="Button1" runat="server" CommandName="Update" 
                        Text="<%$ Resources:TimeLive.Web, Update_Text%> " Width="55px" /><asp:Button ID="Button2" runat="server" CommandName="Cancel"
                            Text="<%$ Resources:TimeLive.Web, Cancel_Text%> " Width="55px" /></td>
            </tr>
        </table>
    </EditItemTemplate>
    <InsertItemTemplate>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="ProjectTypeTextBox">
                  <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Project Type:")%> ' /></asp:Label></td>
                </td>
                <td style="width: 70%; height: 26px;">
                    <asp:TextBox ID="ProjectTypeTextBox" runat="server" Text='<%# Bind("ProjectType") %>' MaxLength="100"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ProjectTypeTextBox"
    ...
    <ItemTemplate>
        AccountProjectTypeId:
        <asp:Label ID="AccountProjectTypeIdLabel" runat="server" Text='<%# Eval("AccountProjectTypeId") %>'>
        </asp:Label><br />
        AccountId:
        <asp:Label ID="AccountIdLabel" runat="server" Text='<%# Bind("AccountId") %>'></asp:Label><br />
        ProjectType:
        <asp:Label ID="ProjectTypeLabel" runat="server" Text='<%# Bind("ProjectType") %>'>
        </asp:Label><br />
