<%@ page language="VB" masterpagefile="~/Masters/MasterPageEmployee.master" autoeventwireup="false" inherits="AccountAdmin_Default, App_Web_yaqbagu1" title="TimeLive - Account Administration" enableviewstatemac="false" enableEventValidation="false" theme="SkinFile" viewStateEncryptionMode="Never" %>
        ...
        <tbody>
            <tr>
                <td class="FormviewHeader" colspan="2" style="width: 505px">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Administration%> " /></td>
            </tr>
            <tr>
                <td class="AdministrationOptionsSubHeader" colspan="2" style="width: 505px; height: 21px">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Organization Setup%> " /></td>
            </tr>
            <tr>
