<%@ control language="VB" autoeventwireup="false" inherits="ProjectAdmin_Controls_ctlAccountProjectAttachmentList, App_Web_qfntt3rg" %>
                    ...
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 150px">
                            <asp:Literal ID="Literal7" runat="server" 
                                Text="<%$ Resources:TimeLive.Web, Project Name:%> " />
                        </td>
                        </td>
                        <td style="width: 250px">
        ...
        <x:GridView ID="GridView1" runat="server" AllowSorting="True" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="AttachmentName" 
                    HeaderText="<%$ Resources:TimeLive.Web, Attachment Name%> " 
                    SortExpression="AttachmentName">
                    <ItemStyle HorizontalAlign="Left" Width="250px" />
                    <HeaderStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, File Name%> " 
                        ...
                        <tr>
                            <td align="right" class="FormViewLabelCell" width="20%">
                                ...
                                <asp:Literal ID="Literal1" runat="server" 
                                    Text="<%$ Resources:TimeLive.Web, Attachment Name:%> " />
                            </td>
                            </TD>
                            <td style="WIDTH: 32%">
                        ...
                        <tr>
                            <td align="right" class="FormViewLabelCell" width="20%">
                                ...
                                <asp:Literal ID="Literal3" runat="server" 
                                    Text="<%$ Resources:TimeLive.Web, File Path:%> " />
                            </td>
                            </TD>
                            <td style="WIDTH: 32%">
                        ...
                        <tr>
                            ...
                            <td style="WIDTH: 32%; height: 26px;">
                                <asp:Button ID="Upload" runat="server" 
                                    Text="<%$ Resources:TimeLive.Web, Upload_text%> " 
