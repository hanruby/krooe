...
namespace SmartMassEmail.Data
{
	...
	public static class SqlUtil
	{
		...
		{
			return Equals(column, value, true, true);
		}
		...
		{
			return Contains(column, value, true, true);
		}
		...
		{
			return StartsWith(column, value, true, true);
		}
		...
		{
			return EndsWith(column, value, true, true);
		}
		...
		{
			return Like(column, value, true, true);
		}
