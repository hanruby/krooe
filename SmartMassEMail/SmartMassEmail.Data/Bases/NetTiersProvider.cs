	...
	public abstract class NetTiersProvider : System.Configuration.Provider.ProviderBase
	{
        ...
        public override void Initialize(string name, NameValueCollection config)
	    {
	        ...
	        lock(syncObject)
            {
				...
				{
                    entityCreationalFactoryType = typeof(SmartMassEmail.Entities.EntityFactory);
				}
				else
				{
		...
		///<summary>
		/// Current EmailMessageProviderBase instance.
		///</summary>
		public virtual EmailMessageProviderBase EmailMessageProvider{get {throw new NotImplementedException();}}
		
		///<summary>
		/// Current EmailMessageDetailProviderBase instance.
		///</summary>
		public virtual EmailMessageDetailProviderBase EmailMessageDetailProvider{get {throw new NotImplementedException();}}
