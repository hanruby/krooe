...
Public Class AccountBLL
    ...
    Public Function AddAccount(ByVal AccountTypeId As System.Nullable(Of Short), _
        ...
        Try
            ...
            NewAccountId = Adapter.InsertAccount(2, AccountName, Address1, Address2, ZipCode, State, City, CInt(CountryId), EMailAddress, Telephone, Fax, CInt(DefaultCurrencyId), False, False, 1, Date.Now, Date.Now, TimeZoneId, Me.GetExpiryString())
    ...
    End Sub
    Public Sub AfterAddNewAccount(ByVal AccountId As Integer, ByVal ToEMailAddress As String, ByVal ToEMailAddressDisplayName As String, ByVal Password As String)
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function btnUpdatePrintInfo(ByVal AccountId As Integer, ByVal ShowTaskInExpenseSheet As System.Nullable(Of Boolean), ByVal ExpenseSheetPrintFooter As String) As Boolean
        Dim Preference As AccountPreferences.AccountPreferencesRow
        Dim Preferences As AccountPreferences.AccountPreferencesDataTable
        Preferences = Me.AccountPreferencesTableAdapter.GetDataByAccountId(AccountId)
        Preference = Preferences.Rows(0)
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function btnUpdateInvoiceInfo(ByVal AccountId As Integer, ByVal InvoiceNoPrefix As String, ByVal InvoiceBillingTypeId As Guid, ShowBillingRateInInvoiceReport As Boolean, _
                                         ByVal InvoiceFooter As String, ByVal ShowProjectNameInInvoiceReport As Boolean, ByVal ShowEntryDateInInvoiceReport As Boolean, ByVal ShowEmployeeNameInInvoiceReport As Boolean) As Boolean
        Dim Preference As AccountPreferences.AccountPreferencesRow
        Dim Preferences As AccountPreferences.AccountPreferencesDataTable
        Preferences = Me.AccountPreferencesTableAdapter.GetDataByAccountId(AccountId)
        Preference = Preferences.Rows(0)
    ...
    Public Function btnUpdateProjectInfo(ByVal AccountId As Integer, ByVal ProjectCodePrefix As String, ByVal AutoGenerateProjectCode As Boolean, ByVal ShowClientDepartmentInProject As Boolean, _
                                         ByVal ShowCompletedProjectInProjectGrid As Boolean) As Boolean
        Dim Preference As AccountPreferences.AccountPreferencesRow
        Dim Preferences As AccountPreferences.AccountPreferencesDataTable
        Preferences = Me.AccountPreferencesTableAdapter.GetDataByAccountId(AccountId)
        Preference = Preferences.Rows(0)
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function btnUpdateTaskInfo(ByVal AccountId As Integer, ByVal ShowProjectNameInTask As Boolean, ByVal ShowClientNameInTask As Boolean) As Boolean
        Dim Preference As AccountPreferences.AccountPreferencesRow
        Dim Preferences As AccountPreferences.AccountPreferencesDataTable
        Preferences = Me.AccountPreferencesTableAdapter.GetDataByAccountId(AccountId)
        Preference = Preferences.Rows(0)
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function btnUpdateTimeOff(ByVal AccountId As Integer, ByVal ShowProjectForTimeOff As Boolean) As Boolean
        Dim Preference As AccountPreferences.AccountPreferencesRow
        Dim Preferences As AccountPreferences.AccountPreferencesDataTable
        Preferences = Me.AccountPreferencesTableAdapter.GetDataByAccountId(AccountId)
        Preference = Preferences.Rows(0)
    ...
    Public Function UpdateTimesheetSetup(ByVal AccountId As Integer, ByVal ShowClockStartEnd As System.Nullable(Of Boolean), ByVal ShowClientInTimesheet As System.Nullable(Of Boolean), ByVal ShowDescriptionInWeekView As System.Nullable(Of Boolean), ByVal ShowCompletedProjectsInTimeSheet As System.Nullable(Of Boolean), _
                                         ByVal ShowCompletedTasksInTimeSheet As System.Nullable(Of Boolean), ByVal ShowWorkTypeInTimeSheet As Boolean, ByVal ShowCostCenterInTimeSheet As Boolean, ByVal ShowTimeOffInTimesheet As System.Nullable(Of Boolean), _
                                         ...
                                         ByVal TimesheetPrintFooter As String, ByVal TimesheetSort As String, ByVal ShowCostCenterInTimesheetBy As String, ByVal ShowCopyActivitiesButtonInTimesheet As Boolean, ByVal ShowCopyTimesheetButton As Boolean, ByVal CalculateTaskPercentageAutomatically As Boolean) As Boolean
        Dim Preference As AccountPreferences.AccountPreferencesRow
        Dim Preferences As AccountPreferences.AccountPreferencesDataTable
        Preferences = Me.AccountPreferencesTableAdapter.GetDataByAccountId(AccountId)
        Preference = Preferences.Rows(0)
    ...
    End Function
    Public Function GetLicenseID(AccountId As Integer) As String
        Dim Accounts As TimeLiveDataSet.AccountDataTable = Adapter.GetDataByAccountId(AccountId)
        Dim Account As TimeLiveDataSet.AccountRow = Accounts.Rows(0)
        Return Account.LicenseId
    End Function
    Public Sub UpdateLicenseInformation(ByVal AccountId As Integer, ByVal MachineId As String, ByVal ActivationMachineKey As String, ByVal ActivationType As String, ByVal ActivationLicenseKey As String, NumberOfUsers As Integer)
        Dim Accounts As TimeLiveDataSet.AccountDataTable = Adapter.GetDataByAccountId(AccountId)
        Dim Account As TimeLiveDataSet.AccountRow = Accounts.Rows(0)
