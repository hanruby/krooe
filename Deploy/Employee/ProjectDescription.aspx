<%@ page language="VB" autoeventwireup="false" inherits="Employee_ProjectDescription, App_Web_pv0uxbk0" theme="SkinFile" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <table width="400">
                    <tr>
                        <td class="FormViewSubHeader" colspan="2" rowspan="1">
                            ...
                            <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Project Description%> " /></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 35%" valign="top">
                            <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Discription:%> " /></td>
                        </td>
                        <td style="width: 65%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="btnUpdate" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text%> " OnClientClick="window.close()" />
