<%@ control language="VB" autoeventwireup="false" inherits="Controls_ctlAccountDepartmentList, App_Web_yhen42r4" %>
...
<x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountDepartmentId"
    ...
    <Columns>
        <asp:TemplateField InsertVisible="False" SortExpression="AccountDepartmentId">
            <edititemtemplate>
...
<asp:Label id="Label3" runat="server" __designer:wfdid="w3" Text='<%# Bind("DepartmentName") %>'></asp:Label> 
        ...
        <asp:CommandField HeaderText="<%$ Resources:TimeLive.Web, Edit_Text %>" SelectText="Edit" ShowSelectButton="True" >
            <ItemStyle HorizontalAlign="Center"  cssclass="edit_button" Width="3%"  />
...
<asp:LinkButton id="LinkButton1" runat="server" __designer:wfdid="w13" OnClientClick="<%# ResourceHelper.GetDeleteMessageJavascript()%>" CommandName="Delete" CausesValidation="False"></asp:LinkButton> 
            ...
            <ItemStyle HorizontalAlign="Center"  cssclass="delete_button" Width="3%"  />
        </asp:TemplateField>
        <asp:TemplateField>
            <HeaderTemplate>
...
<asp:FormView ID="FormView1" runat="server" DataKeyNames="AccountDepartmentId" DataSourceID="dsAccountDepartmentObject"
    DefaultMode="Insert" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" SkinID="formviewSkinEmployee" Width="550px">
    <EditItemTemplate>
        <table style="width: 100%" class="xview">
            <tr>
                <td class="caption" colspan="2" style="height: 21px" width="30%">
                    <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Department Information")%> ' /></td>
            </tr>
            <tr>
                <td class="FormViewSubHeader" colspan="2" style="height: 21px" width="30%">
                    <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Department")%> ' /></td>
            </tr>
            <tr>
                <td style="height: 26px;" class="FormViewLabelCell" align="right" width="30%">
                    <SPAN
                  class=reqasterisk>*</SPAN> <asp:Label ID="DepartmentCodeLabel" runat="server" AssociatedControlID="DepartmentCodeTextBox"><asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Department Code:")%> ' /></asp:Label></td>
                <td style="height: 26px;" width="70%">
                    <asp:TextBox ID="DepartmentCodeTextBox" runat="server" Text='<%# Bind("DepartmentCode") %>' Width="176px" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator
            ...
            <tr>
                <td style="height: 26px;" class="FormViewLabelCell" align="right" width="30%">
                    <SPAN 
                  class=reqasterisk>*</SPAN><asp:Label ID="DepartmentNameLabel" runat="server" AssociatedControlID="DepartmentNameTextBox"><asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Department Name:")%> ' /></asp:Label></td>
                <td style="height: 26px;" width="70%">
        <asp:TextBox ID="DepartmentNameTextBox" runat="server" Text='<%# Bind("DepartmentName") %>' Width="176px" MaxLength="200"></asp:TextBox><asp:RequiredFieldValidator
            ...
            <tr>
                ...
                <td width="70%">
        <asp:CheckBox ID="IsDisabledCheckBox" runat="server" Checked='<%# Bind("IsDisabled") %>' Width="168px" /></td>
            </tr>
            <tr>
                <td width="30%">
                </td>
    ...
    <InsertItemTemplate>
        <table style="width: 100%" class="xview">
            ...
            <tr>
                ...
                <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Department")%> ' /></td>
                    
            </tr>
            <tr>
                <td class="FormViewLabelCell" style="width: 30%; height: 26px;" colspan="1" rowspan="1" align="right">
                    <SPAN 
                  class=reqasterisk>*</SPAN><asp:Label ID="DepartmentCodeLabel" runat="server" AssociatedControlID="DepartmentCodeTextBox"><asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("Department Code:")%> ' /></asp:Label></td>
                <td style="width: 70%; height: 26px;">
                    <asp:TextBox ID="DepartmentCodeTextBox" runat="server" Text='<%# Bind("DepartmentCode") %>' Width="176px" MaxLength="10"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DepartmentCodeTextBox"
            ...
            <tr>
                <td style="width: 30%; height: 26px;" class="FormViewLabelCell" colspan="1" rowspan="1" align="right">
                    <SPAN 
                  class=reqasterisk>*</SPAN> <asp:Label ID="DepartmentNameLabel" runat="server" AssociatedControlID="DepartmentNameTextBox"><asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Department Name:")%> ' /></asp:Label></td>
                <td style="width: 70%; height: 26px;">
                    <asp:TextBox ID="DepartmentNameTextBox" runat="server" Text='<%# Bind("DepartmentName") %>' Width="176px" MaxLength="200"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DepartmentNameTextBox"
                        ErrorMessage="*" Display="Dynamic" Width="1px"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
    ...
    <ItemTemplate>
        AccountDepartmentId:
        <asp:Label ID="AccountDepartmentIdLabel" runat="server" Text='<%# Eval("AccountDepartmentId") %>'>
        </asp:Label><br />
        AccountId:
    ...
    <InsertRowStyle BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" />
</asp:FormView>
        &nbsp; &nbsp;
    </ContentTemplate>
</asp:UpdatePanel>