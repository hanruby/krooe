...
Partial Class Employee_Controls_ctlAccountEmployeeTimeEntryDayView
    ...
    End Sub
        ''' <summary>
        ''' Set permission for delete of specified object row of grid view row
        ''' </summary>
        ''' <param name="objRow"></param>
        ''' <remarks></remarks>
    Public Sub SetPermissionForDelete(ByVal objRow As GridViewRow)
    End Sub
        ''' <summary>
        ''' Bulk edit grid view row created of specified object row of grid view row
        ''' </summary>
        ''' <param name="sender"></param>
        ''' <param name="e"></param>
        ''' <remarks></remarks>
    Protected Sub BulkEditGridViewVB1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles BulkEditGridViewVB1.RowCreated
    End Sub
        ''' <summary>
    ...
    ''' <remarks></remarks>
    Public Sub Save(ByVal IsSubmitted As Boolean)
        Try
            Dim objRow As GridViewRow
            For Each objRow In Me.BulkEditGridViewVB1.Rows
                If objRow.RowType = DataControlRowType.DataRow Then
    ...
    Public Sub UpdateDay(ByVal objrow As GridViewRow)
        ...
        ElseIf Me.IsRowChanged(objrow) And IsDBNull(Me.BulkEditGridViewVB1.DataKeys(objrow.RowIndex)("AccountEmployeeTimeOffRequestId")) Then
    ...
    Public Sub DeleteOldDayEntriesForNewCopyEntries(ByVal AccountEmployeeId As Integer, ByVal TimeEntryDate As Date)
        ...
        If dt.Rows.Count > 0 Then
            For Each dr In dt.Rows
                Call New AccountEmployeeTimeEntryBLL().DeleteAccountEmployeeTimeEntry(dr.AccountEmployeeTimeEntryId, TimesheetPeriodType, AccountEmployeeId, dtStartDate, dtEndDate, dr.Item("AccountEmployeeTimeEntryApprovalProjectId"), dr.Item("AccountEmployeeTimeEntryPeriodId"))
            Next
    ...
    Protected Sub BulkEditGridViewVB1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles BulkEditGridViewVB1.RowDeleting
        ...
        Call New AccountEmployeeTimeEntryBLL().DeleteAccountEmployeeTimeEntry(Me.BulkEditGridViewVB1.DataKeys(e.RowIndex)("AccountEmployeeTimeEntryId"), TimesheetPeriodType, Me.ViewState("TimeEntryAccountEmployeeId"), dtStartDate, dtEndDate, AccountEmployeeTimeEntryApprovalProjectIdDataKeyValue, AccountEmployeeTimeEntryPeriodIdIdDataKeyValue)
        Me.RefreshPage()
    End Sub
    ''' <summary>
    ...
    End Function
    ''' <summary>
    ''' Bulk edit grid view init event
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Protected Sub BulkEditGridViewVB1_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles BulkEditGridViewVB1.Init
        ' Me.BulkEditGridViewVB1.InsertRowCount = DBUtilities.GetNumberOfBlankRowsInTimeEntry
    End Sub
    ''' <summary>
    ...
    Public Sub SetClientCascadingEnabled(ByVal objRow As GridViewRow)
        ...
        End If
        MyCascading.Category = Me.ViewState("TimeEntryAccountEmployeeId") & "," & AccountProjectId & "," & DBUtilities.GetShowClientInTimesheet & "," & DBUtilities.GetSessionAccountId & "," & 0 & "," & LocaleUtilitiesBLL.IsShowCompletedProjectsInTimeSheet
    End Sub
    ''' <summary>
    ...
    Public Sub SetProjectValueOnRowDataBound(ByVal objDropdown As DropDownList, ByVal dsObject As ObjectDataSource, ByVal dataValue As Object, ByVal MyCascading As AjaxControlToolkit.CascadingDropDown, ByVal Row As GridViewRow)
        ...
        If Not objDropdown Is Nothing And Not IsDBNull(DataBinder.Eval(Row.DataItem, "AccountProjectId")) Then
            ...
            MyCascading.Category = Me.ViewState("TimeEntryAccountEmployeeId") & "," & dataValue & "," & DBUtilities.GetShowClientInTimesheet & "," & DBUtilities.GetSessionAccountId & "," & DataBinder.Eval(Row.DataItem, "AccountClientId") & "," & LocaleUtilitiesBLL.IsShowCompletedProjectsInTimeSheet
        End If
        If DataBinder.Eval(Row.DataItem, "IsTimeOff").ToString = "True" Then
            ...
            CType(Row.Cells(1).FindControl("lblTimeOff"), Label).Text = DataBinder.Eval(Row.DataItem, "TimeType")
        ...
        If Not objDropdown Is Nothing Then
            ...
            If DataBinder.Eval(Row.DataItem, "IsTimeOff").ToString = "True" Then
                ...
                If Not IsDBNull(DataBinder.Eval(Row.DataItem, "AccountEmployeeTimeOffRequestId")) Then
                    CType(Row.Cells(1).FindControl("ddlTimeOffTypes"), DropDownList).Enabled = False
                End If
            End If
        End If
        ...
        For Each objrow As GridViewRow In Me.BulkEditGridViewVB1.Rows
            If objrow.RowType = DataControlRowType.DataRow Then
                If Me.BulkEditGridViewVB1.DataKeys(objrow.RowIndex)("IsTimeOff").ToString = "True" Then
                    CType(objrow.Cells(1).FindControl("ddlAccountProjectId"), DropDownList).Width = Unit.Percentage(75)
                    If Not LocaleUtilitiesBLL.IsShowProjectForTimeOff Then
                        CType(objrow.Cells(1).FindControl("lblTimeOff"), Label).Width = Unit.Percentage(75)
                    End If
                ...
                End If
                If TotalCustomFields <> 0 Then
                    CType(objrow.Cells(1).FindControl("ddlAccountProjectId"), DropDownList).Width = 200
                End If
            End If
        Next
    End Sub
