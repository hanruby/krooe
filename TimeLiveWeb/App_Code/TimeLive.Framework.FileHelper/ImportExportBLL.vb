...
Public Class ImportExportBLL
    ...
    Public Function GetDelimiter(ByVal ExportType As String) As Char
        ...
        End If
    End Function
    Public Function GetExportExtension(ByVal ExportType As String) As String
        If ExportType = "Quickbooks" Then
            Return ".iif"
        ElseIf ExportType = "MProject" Then
            Return ".mpx"
    ...
    Public Function GetQBRecordHeader(ByVal DataType As String) As String
        ...
        End If
    End Function
    Public Function GetTempFileForExport(ByVal ExportType As String) As String
        Dim TempFolderPath As String = AccountProjectTaskAttachmentBLL.CreateTempFolderPath()
        Dim TempFile As String = System.Guid.NewGuid.ToString & Me.GetExportExtension(ExportType)
    ...
    End Function
    Public Function GetAllColumnsOfDBForMapping(ByVal DataName As String) As DataTable
    ...
    Public Function GetAllColumnMappingDataTableOfMProject(ByVal strFilePath As String, ByVal ExportType As String) As DataTable
        ...
        Return objTable
    End Function
    Public Function GetExportDataSourceByName(ByVal strName As String) As DataRow
        Return Me.GetAllExportableDatasource().Select("DataName='" & strName & "'")(0)
    End Function

    Public Function GetAllExportableDatasource() As DataTable
        Dim objTable As New DataTable
    ...
    End Function
    Public Function GetCSVColumnOfDBColumn(ByVal DBColumnName As String, ByVal dtMappings As DataTable, ByVal DataName As String) As String
        For Each objRow As DataRow In dtMappings.Rows
            If Me.GetForeignColumnName(objRow("MappedColumn"), DataName) = DBColumnName Then
                Return objRow("OrignalFileColumn")
            End If
        Next
        Return "Select"
    ...
    Public Sub SetEmployeesParameterForOfflineTimesheet(OfflineTimesheet As Boolean)
        ...
        End If
    End Sub
    Public Function InsertRecords(ByVal dtMappings As DataTable, ByVal DataName As String, ByVal strFilePath As String, ByVal ExportType As String, ByVal TestMode As Boolean, Optional OfflineTimesheet As Boolean = False)

        Dim dtCSVFile As DataTable = Me.GetDataTableOfCSV(strFilePath, ExportType)
        Dim objDataDefination As DataRow = Me.GetExportDataSourceByName(DataName)
        ...
        For Each objRow As DataRow In dtCSVFile.Rows
            ...
            For n As Integer = 0 To objParameterInfo.Length - 1
                Dim MappedColumn As String = Me.GetCSVColumnOfDBColumn(objParameterInfo(n).Name, dtMappings, DataName)
                objParameters(n) = Me.GetDefaultValue(objParameterInfo(n).Name, dtMappings, DataName, objRow, OfflineTimesheet)
                objParameters(n) = Me.GetDefaultValue(objParameterInfo(n).Name, dtMappings, DataName, objRow, OfflineTimesheet)
    ...
    Public Function GetForeignColumn(ByVal ParameterName As String, ByVal ParameterValue As Object, ByVal DataName As String) As Object
        ...
        End If
    End Function
    Public Function GetForeignColumnName(ByVal ParameterName As String, ByVal DataName As String) As String
        ...
        End If
    End Function
    Public Function GetDefaultValue(ByVal ParameterName As String, ByVal dtMappings As DataTable, ByVal DataName As String, ByVal objRow As DataRow, OfflineTimesheet As Boolean) As Object
    ...
    Public Function GetDataTableFromAdapterForImport(ByVal strDataSource As String) As DataTable

        Dim assem As Assembly = Assembly.GetExecutingAssembly
        Dim objType As String = Me.GetExportDataSourceByName(strDataSource)("ImportAdapterName")
