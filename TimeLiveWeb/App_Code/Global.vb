...
Public Class AppGlobal
    ...
    Public Sub MyCacheItemRemovedCallback(ByVal key As String, ByVal value As Object, ByVal reason As CacheItemRemovedReason)
        LoggingBLL.WriteToLog("MyCacheItemRemovedCallback:DoWorkStart")
        ' Call Scheduled work function
        DoWork()
        LoggingBLL.WriteToLog("MyCacheItemRemovedCallback:DoWorkEnd")
    ...
    ''' <remarks></remarks>
    Private Sub DoWork()
        LoggingBLL.WriteToLog("Initated DoWork: Sending scheduled emails")
        ...
        If UIUtilities.IsDevelopmentEnvironment Then
            ...
            AccountEmployeeTimeOffBLL.UpdateTimeOffPolicies()
            UIUtilities.DeleteTempFiles()
        End If
        LoggingBLL.WriteToLog("DoWork:End Queue email sending")
    End Sub
    ''' <summary>
