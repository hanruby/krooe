<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountPriorityList, App_Web_j1ru2ref" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountPriorityId"
            ...
            <Columns>
                <asp:TemplateField InsertVisible="False" SortExpression="AccountPriorityId">
                    <edititemtemplate>
...
<asp:Label id="Label2" runat="server" Text='<%# Bind("Priority") %>' __designer:wfdid="w63"></asp:Label>
                ...
                <asp:CommandField HeaderText="<%$ Resources:TimeLive.Web, Edit_text %>" SelectText="Edit" ShowSelectButton="True" >
                    <ItemStyle HorizontalAlign="Center" cssclass="edit_button" Width="6%"/>
                </asp:CommandField>
                ...
                <table  width="100%" class="xview">
                    <tr>
                        <td class="caption" colspan="2" style="width: 20%; height: 21px">
                            <asp:Literal ID="Literal5" runat="server" Text='<%# ResourceHelper.GetFromResource("Priority Information")%> ' /></td>
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="2" style="width: 20%; height: 21px">
                            <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Priority")%> ' /></td>
                    </tr>
                    <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="AccountPriorityTextBox">
                  <asp:Literal ID="Literal3" runat="server" Text='<%# ResourceHelper.GetFromResource("Priority:")%> ' /></asp:Label></td><td style="width: 75%; height: 26px;">
                            <asp:TextBox ID="AccountPriorityTextBox" runat="server" Text='<%# Bind("Priority") %>' MaxLength="50"></asp:TextBox><asp:RequiredFieldValidator
                  ...
                  <asp:Literal ID="Literal4" runat="server" Text='<%# ResourceHelper.GetFromResource("Priority Order:")%> ' /></asp:Label></td><td style="width: 75%; height: 26px">
                            <asp:TextBox ID="PriorityTextBox" runat="server" MaxLength="50" Text='<%# Bind("PriorityOrder") %>'></asp:TextBox><asp:RequiredFieldValidator
                        ...
                        <td align="right" class="FormViewLabelCell" style="width: 30%; height: 26px">
                            <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Disabled_text%> " />
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 75%; height: 26px;">
                            ...
                            <asp:Button ID="Cancel" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%> " Width="68px" ValidationGroup="CANCEL!" /></td>
                    </tr>
                </table>
            </EditItemTemplate>
            <InsertItemTemplate>
                <table width="100%" class="xview">
                    <tr>
                        <td class="caption" colspan="2" style="height: 21px" width="30%">
                            <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Priority Information")%> ' />
                    </tr>
                    <tr>
                        <td class="FormViewSubHeader" colspan="2" style="height: 21px" width="30%">
                            <asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Priority")%> ' />
                    </tr>
                    <tr>
                  ...
                  <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Priority:")%> ' /></asp:Label></td><td style="width: 75%; height: 26px;">
                        ...
                        <td align="right" class="FormViewLabelCell" style="height: 26px" width="30%">
                            ...
                            <asp:TextBox ID="PriorityOrderTextBox" runat="server" MaxLength="50" Text='<%# Bind("PriorityOrder") %>'></asp:TextBox><asp:RequiredFieldValidator
