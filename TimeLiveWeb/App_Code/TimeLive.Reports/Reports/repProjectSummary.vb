...
#End Region
    ...
    Private Sub repProjectSummary_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles Me.BeforePrint
        ...
        Me.xrLabel20.Text = Resources.TimeLive.Web.Project_Activity_Summary_Report
        Me.xrLabel3.Text = Resources.TimeLive.Web.Client_
        Me.xrLabel6.Text = Resources.TimeLive.Web.Project_
