<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsFilter_fltProjectListReport, App_Web_uiy04ms5" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table style="width: 400px" class="xFormView">
            <tr>
                <td colspan="2" class="caption">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Project List Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 40%" align="right" class="formViewLabelCell">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Client Name:%> " /></td>
                <td style="width: 60%">
            ...
            <tr>
                <td style="width: 40%" align="right" class="formViewLabelCell">
                    <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Active Status:%> " /></td>
                <td style="width: 60%">
                    <asp:DropDownList ID="ddlActiveStatus" runat="server" AppendDataBoundItems="True" Height="22px" Width="180px">
                        <%--<asp:ListItem Selected="True" Value="-1">&lt;ALL&gt;</asp:ListItem>--%>
                        <asp:ListItem Selected="True" Value="-1" Label ID="Label2" runat="server" Text="<%$ Resources:TimeLive.Web, ALLs%> "></asp:ListItem>
                        <%--<asp:ListItem Value="1">Active</asp:ListItem>--%>
                        <asp:ListItem Value="1" Label ID="Label3" runat="server" Text="<%$ Resources:TimeLive.Web, Active%> "></asp:ListItem>
                        <%--<asp:ListItem Value="0">InActive</asp:ListItem>--%>
                        <asp:ListItem Value="0" Label ID="Label4" runat="server" Text="<%$ Resources:TimeLive.Web, InActive%> "></asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 40%" align="right" class="formViewLabelCell">
                    <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Project Status:%> " /></td>
                <td style="width: 60%">
