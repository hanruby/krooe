<%@ control language="VB" autoeventwireup="false" enableviewstate="False" inherits="Employee_Controls_ctlAccountEmployeeTimeEntryApprovalDetailsReadOnly, App_Web_dsdjiwop" %>
<%If SubmittedBy <> "" Then%>
<br />
<table class="xFormView" width="80%" id="Name">
    <tr>
        <td class="caption" colspan="3">
            <asp:Literal ID="L" runat="server" Text="<%$ Resources:TimeLive.Web, Timesheet Approval Detail%> " /></td>
    </tr>
    <tr>
        <td align="right" class="HighlightedTextMedium" colspan="1" style="width: 15%">
            <asp:Literal ID="L2" runat="server" Text="<%$ Resources:TimeLive.Web, Submitted By:%> " /></td>
    ...
    <tr>
        <td align="right" class="HighlightedTextMedium" colspan="1" style="width: 15%">
            <asp:Literal ID="L3" runat="server" Text="<%$ Resources:TimeLive.Web, Submitted On:%> " /></td>
        <td align="left" class="HighlightedTextMedium" colspan="2" style="width: 85%">
            <asp:Label ID="LSO" runat="server" ForeColor="Black" Text="10/10/2010"></asp:Label></td>
    </tr>
    <tr>
        <td colspan="3">
<x:GridView ID="A" runat="server" SkinID="xgridviewSkinEmployee" DataSourceID="dsAccountEmployeeTimeEntryApprovalDetailsReadOnly" AutoGenerateColumns="False" CssClass="xGridView" Width="100%">
    <Columns>
