<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountExpenseTypeList, App_Web_yhen42r4" %>

        <table border="0" cellpadding="0" cellspacing="0" class="xFormView" width="98%">
            <tr>
                <td width="15%" class="FormViewSubHeader" style="height:31px;">
                    <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:TimeLive.Web, Tax Zone:%>" />
                </td>
                <td width="85%">
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" DataSourceID="dsAccountExpenseTypeObject" AutoGenerateColumns="False" DataKeyNames="AccountExpenseTypeId" AllowSorting="True" Caption="<%$ Resources:TimeLive.Web, Expense Type List %>" SkinID="xgridviewSkinEmployee" Width="98%">
            <Columns>
                <asp:TemplateField InsertVisible="False" SortExpression="AccountExpenseTypeId">
                    <edititemtemplate>
...
<asp:Label id="Label3" Text='<%# Bind("TaxCode") %>' runat="server" __designer:wfdid="w187"></asp:Label> 
     ...
     <ItemTemplate>
       ...
       <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete"
            ...
            <HeaderStyle HorizontalAlign="Center" />
            <ItemStyle HorizontalAlign="Center" Width="3%" VerticalAlign="Middle" cssclass="delete_button" />
        </asp:TemplateField>
                <asp:TemplateField>
                    <HeaderTemplate>
            ...
            <EditItemTemplate><table width="450" class="xview">
                <tr>
                    <td class="caption" colspan="2" style="height: 21px">
                        <asp:Literal ID="Literal1" runat="server" Text='<%# ResourceHelper.GetFromResource("Expense Type Information")%> ' /></td>
                </tr>
                <tr>
                    <td class="FormViewSubHeader" colspan="2" style="height: 21px">
                    <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Expense Type")%> ' /></td>
                </tr>
                <tr>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="ExpenseTypeTextBox">
                  <asp:Literal ID="Literal8" runat="server" Text='<%# ResourceHelper.GetFromResource("Expense Type:")%> ' /></asp:Label></td>
                    </td>
                    <td style="width: 60%">
                        <asp:TextBox ID="ExpenseTypeTextBox" runat="server" Text='<%# Bind("ExpenseType") %>' MaxLength="50"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ExpenseTypeTextBox"
                ...
                <tr>
                    ...
                    <td style="width: 60%">
                        <asp:DropDownList ID="ddlAccountTaxCodeId" runat="server" DataSourceID="dsAccountTaxCodeObject"
                            DataTextField="TaxCode" DataValueField="AccountTaxCodeId" Width="159px" AppendDataBoundItems="True">
                            <asp:ListItem Value="0" Label ID="Label1" runat="server" Text="<%$ Resources:TimeLive.Web, None%> "></asp:ListItem>
                            <%--<asp:ListItem Value="0">&lt;None&gt;</asp:ListItem>--%>
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlAccountTaxCodeId"
                ...
                <tr>
                  ...
                  class=reqasterisk>*</span> <asp:Literal ID="Literal11" runat="server" Text='<%# ResourceHelper.GetFromResource("Quantity Caption:")%> ' /></td>
                    ...
                    <td style="width: 60%">
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("QuantityFieldCaption") %>'></asp:TextBox>
                        <asp:CustomValidator ID="CustomValidator1" runat="server" CssClass="ErrorMessage"
                            Display="Dynamic" ErrorMessage="*" OnServerValidate="CustomValidator1_ServerValidate1"></asp:CustomValidator></td>
                </tr>
                <tr>
                    <td align="right" class="FormViewLabelCell" style="width: 40%;">
                ...
                <tr>
                    ...
                    <td style="width: 60%">
                        <asp:Button ID="Button1" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text%> " Width="50px" /><asp:Button ID="Button2" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%> " Width="50px" /></td>
                </tr>
            </table>
            </EditItemTemplate>
            <InsertItemTemplate>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="ExpenseTypeTextBox">
                  <asp:Literal ID="Literal12" runat="server" Text='<%# ResourceHelper.GetFromResource("Expense Type:")%> ' /></asp:Label></td>
                        </td>
                        <td style="width: 60%">
                            <asp:TextBox ID="ExpenseTypeTextBox" runat="server" Text='<%# Bind("ExpenseType") %>' MaxLength="50"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ExpenseTypeTextBox"
                                Display="Dynamic" ErrorMessage="*" CssClass="ErrorMessage"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 40%">
                        ...
                        <td style="width: 60%">
                            <asp:DropDownList ID="ddlAccountTaxCodeId" runat="server" DataSourceID="dsAccountTaxCodeObject"
                                ...
                                Width="157px" AppendDataBoundItems="True">
                                <asp:ListItem Selected="True" Value="0" Label ID="Label2" runat="server" Text="<%$ Resources:TimeLive.Web, None%> "></asp:ListItem>
                  ...
                  class=reqasterisk>*</span> <asp:Literal ID="Literal7" runat="server" Text='<%# ResourceHelper.GetFromResource("Quantity Caption:")%> ' /></td>
                        ...
                        <td style="width: 60%">
                            <asp:TextBox ID="QuantityTextBox" runat="server" Text='<%# Bind("QuantityFieldCaption") %>' Enabled="False"></asp:TextBox>
                            <asp:CustomValidator ID="CustomValidator1" runat="server" CssClass="ErrorMessage"
                                Display="Dynamic" ErrorMessage="*" OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator></td>
                    </tr>
                    <tr>
                        <td style="width: 40%">
                        </td>
            ...
            <ItemTemplate>
                ...
                <asp:Label ID="AccountExpenseTypeIdLabel" runat="server" Text='<%# Eval("AccountExpenseTypeId") %>'>
                </asp:Label><br />
                ExpenseType:
                <asp:Label ID="ExpenseTypeLabel" runat="server" Text='<%# Bind("ExpenseType") %>'>
                </asp:Label><br />
                AccountId:
        ...
        <asp:ObjectDataSource ID="dsAccountTaxCodeObject" runat="server" OldValuesParameterFormatString="original_{0}"
