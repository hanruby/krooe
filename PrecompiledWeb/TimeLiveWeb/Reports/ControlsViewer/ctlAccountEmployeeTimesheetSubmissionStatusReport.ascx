<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsViewer_ctlAccountEmployeeTimesheetSubmissionStatusReport, App_Web_iqmrpsj3" %>
        ...
        <table class="xFormView" style="width: 700px">
            <tr>
                <td class="caption" colspan="2">
                    <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Employee Timesheet Submission Status Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" class="FormViewLabelCellWithBorder" style="width: 30%">
                    <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:TimeLive.Web, Department:%> " /></td>
                <td style="width: 70%">
            ...
            <tr>
                <td align="right" class="FormViewLabelCellWithBorder" style="width: 30%"><asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Web, Date Range:%>" /></td>
                <td align="left" style="width: 70%">
                    <table width="100%" class="xTableWithoutBorder">
                        <tr>
                            <td style="width: 25%" class="FormViewLabelCellBold">
