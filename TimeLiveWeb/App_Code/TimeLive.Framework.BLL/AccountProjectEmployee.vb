...
Public Class AccountProjectEmployeeBLL
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetAccountProjectEmployeesForSelectionByAccountWorkTypeId(ByVal AccountId As Integer, ByVal AccountProjectId As Integer, ByVal AccountWorkTypeId As Integer) As TimeLiveDataSet.vueAccountProjectEmployeeDataTable
        Dim _vueAccountProjectEmployeeTableAdapter As New vueAccountProjectEmployeeTableAdapter
    ...
    Public Function AddAccountProjectEmployee( _
                        ByVal AccountId As Integer, ByVal AccountProjectId As Integer, ByVal AccountEmployeeId As Integer, ByVal AccountRoleId As Integer, ByVal AccountBillingRateId As Integer) As Boolean
    ...
    Public Function DeleteAccountProjectEmployeeId(ByVal Original_AccountProjectEmployeeId As Integer) As Boolean
        Dim AccountProjectId = Adapter.GetDataByAccountProjectEmployeeId(Original_AccountProjectEmployeeId).Rows(0)("AccountProjectId")
