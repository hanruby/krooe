<%@ control language="VB" autoeventwireup="false" enableviewstate="False" inherits="Employee_Controls_ctlAccountEmployeeTimeEntryApprovalDetailsReadOnly, App_Web_uitpp31g" %>
<%If SubmittedBy <> "" Then%>
<br />
