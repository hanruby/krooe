...
Public Class AccountExpenseEntryBLL
    ...
    Public Function AddAccountExpenseEntry( _
                ByVal AccountId As Integer, ByVal AccountExpenseEntryDate As Date, ByVal AccountEmployeeId As Integer, ByVal AccountProjectId As Integer, ByVal AccountProjectTaskId As Integer, ByVal AccountExpenseId As Integer, ByVal Amount As Double, ByVal CreatedOn As DateTime, ByVal CreatedByEmployeeId As Integer, ByVal ModifiedOn As DateTime, ByVal ModifiedByEmployeeId As Integer, ByVal Description As String, ByVal IsBillable As Boolean, ByVal Reimburse As Boolean, _
    ...
    Public Function UpdateAccountExpenseEntry(ByVal AccountId As Integer, ByVal AccountExpenseEntryDate As Date, _
    ByVal Original_AccountExpenseEntryId As Integer, ByVal AccountEmployeeId As Integer, _
    ByVal AccountProjectId As Integer, ByVal AccountProjectTaskId As Integer, ByVal AccountExpenseId As Integer, ByVal Amount As Double, _
    ...
    ByVal AccountTaxZoneId As Integer, ByVal Rejected As Boolean, ByVal Submitted As Boolean, ByVal AccountEmployeeExpenseSheetId As Guid, Optional ByVal CustomField1 As String = "", _
                    Optional ByVal CustomField2 As String = "", _
                    Optional ByVal CustomField3 As String = "", _
                    Optional ByVal CustomField4 As String = "", _
                    Optional ByVal CustomField5 As String = "", _
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Insert, True)> _
    Public Function AddExpenseApproval( _
                ByVal AccountExpenseEntryId As Integer, ByVal ExpenseApprovalTypeId As Integer, ByVal ExpenseApprovalPathId As Integer, ByVal ApprovedByEmployeeId As Integer, ByVal Comments As String, ByVal IsRejected As Boolean, ByVal IsApproved As Boolean, ByVal ApprovalPathSequence As Integer _
                    ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockTeamLeadExpenseEntry(ByVal Original_AccountExpenseEntryId As Integer, _
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockTeamLeadExpenseEntryRejected(ByVal Original_AccountExpenseEntryId As Integer, _
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockProjectManagerExpenseEntry(ByVal Original_AccountExpenseEntryId As Integer, _
                    ByVal Approved As Boolean _
                    ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockProjectManagerExpenseEntryRejected(ByVal Original_AccountExpenseEntryId As Integer, _
                    ByVal Rejected As Boolean _
                    ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockSpecificEmployeeExpenseEntry(ByVal Original_AccountExpenseEntryId As Integer, _
                ByVal Approved As Boolean _
                ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockSpecificEmployeeExpenseEntryRejected(ByVal Original_AccountExpenseEntryId As Integer, _
                ByVal Rejected As Boolean _
                ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockSpecificExternalUserExpenseEntry(ByVal Original_AccountExpenseEntryId As Integer, _
                ByVal Approved As Boolean _
                ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockEmployeeManagerExpenseEntry(ByVal Original_AccountExpenseEntryId As Integer, _
            ByVal Approved As Boolean _
            ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockSpecificExternalUserExpenseEntryRejected(ByVal Original_AccountExpenseEntryId As Integer, _
                ByVal Rejected As Boolean _
                ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function LockEmployeeManagerExpenseEntryRejected(ByVal Original_AccountExpenseEntryId As Integer, _
                ByVal Rejected As Boolean _
                ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function DeleteIsRejectStatusApproval(ByVal Original_AccountExpenseEntryId As Integer _
                ) As Boolean
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function DeleteIsApprovedStatusApproval(ByVal Original_AccountExpenseEntryId As Integer _
            ) As Boolean
    ...
    Public Function GetPreparedEMailMessageForApprovedExpenseEntry(ByVal drvueAccountExpenseEntryApprovedEmail As DataRow, ByVal Comments As String) As StringDictionary
        ...
        dict.Add("[currencyamount]", drvueAccountExpenseEntryApprovedEmail.Item("BaseCurrencyCode") & " " & String.Format("{0:N}", drvueAccountExpenseEntryApprovedEmail.Item("Amount")))
    ...
    Public Sub SendApprovedExpenseEntry(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Comments As String)
        Try
            ...
            End If
            Dim dtvueAccountExpenseEntryApprovedEmailToApprover As AccountExpenseEntry.vueAccountExpenseEntryApprovedEmailToApproverDataTable = objvueAccountExpenseEntryApprovedEmail.GetApprovedAccountExpenseEntryForEmailToApproverByExpenseSheetId(AccountEmployeeExpenseSheetId)
    ...
    Public Function GetPreparedEMailMessageForRejectedExpense(ByVal drvueAccountExpenseEntryRejectedEmail As DataRow, ByVal Comments As String) As StringDictionary
        ...
        dict.Add("[currencyamount]", drvueAccountExpenseEntryRejectedEmail.Item("BaseCurrencyCode") & " " & String.Format("{0:N}", drvueAccountExpenseEntryRejectedEmail.Item("Amount")))
    ...
    Public Function GetPreparedEMailMessageForPendingExpense(ByVal strBody As String, ByVal strHeader As String) As StringDictionary
        ...
        dict.Add("[url]", System.Configuration.ConfigurationManager.AppSettings("SitePrefix") & "ProjectAdmin/ExpenseApproval.aspx")
        Return dict
    End Function
    ''' <summary>
        ...
        If dt.Rows.Count > 0 Then
            ...
            If Not IsDBNull(DataBinder.Eval(Row.DataItem, SubmittedDataItemName)) Then
                If DataBinder.Eval(Row.DataItem, SubmittedDataItemName) = True And DataBinder.Eval(Row.DataItem, ApprovedDataItemName) <> True Then
                    ...
                    StatusText = Resources.TimeLive.Web.Submitted_By__ & dr.EmployeeName & Chr(13) & Resources.TimeLive.Web.Status___Submitted & Chr(13) & Resources.TimeLive.Web.Submitted_On__ & dr.ModifiedOn.Date
                ...
                ElseIf DataBinder.Eval(Row.DataItem, ApprovedDataItemName) = True Then
                    ...
                    If IsDBNull(dr.Item("IsApproved")) OrElse dr.Item("IsApproved") = False Then
                        GVColumnVisible(GV, i)
                        StatusText = Resources.TimeLive.Web.Status___Approved
                    ...
                    ElseIf dr.Item("IsApproved") = True Then
                        GVColumnVisible(GV, i)
                        StatusText = Resources.TimeLive.Web.Approved_By__ & dr.ApproverEmployeeName & Chr(13) & Resources.TimeLive.Web.Status___Approved & Chr(13) & Resources.TimeLive.Web.Approved_On__ & dr.ApprovedOn.Date
                ...
                ElseIf Not IsDBNull(DataBinder.Eval(Row.DataItem, RejectedDataItemName)) AndAlso Not DataBinder.Eval(Row.DataItem, RejectedDataItemName) = False Then
                    If DataBinder.Eval(Row.DataItem, RejectedDataItemName) = True Then
                        If DataBinder.Eval(Row.DataItem, RejectedDataItemName) = True Then
                            GVColumnVisible(GV, i)
                            StatusText = Resources.TimeLive.Web.Rejected_By__ & dr.ApproverEmployeeName & Chr(13) & Resources.TimeLive.Web.Status___Rejected & Chr(13) & Resources.TimeLive.Web.Rejected_On__ & dr.ApprovedOn.Date
                ...
                Else
                    GVColumnVisible(GV, i)
                    StatusText = Resources.TimeLive.Web.Not_Submitted_
    ...
    Public Shared Sub SetSubmitted(ByVal lblStatus As Label, ByVal lblStatusNote As Label, ByVal StatusTexbox As TextBox, ByVal StatusText As String, ByVal StatusImage As System.Web.UI.WebControls.Image)
        lblStatus.Text = Resources.TimeLive.Web.Time_Entry_Status___Submitted
        lblStatusNote.Text = Resources.TimeLive.Web.Note___Submitted___Waiting_For_Approval
    ...
    Public Shared Sub SetApproved(ByVal lblStatus As Label, ByVal lblStatusNote As Label, ByVal StatusTexbox As TextBox, ByVal StatusText As String, ByVal StatusImage As System.Web.UI.WebControls.Image, ByVal ApprovalType As String)
        If ApprovalType = "Required" Then
            lblStatus.Text = Resources.TimeLive.Web.Time_Entry_Status___Approved
            lblStatusNote.Text = Resources.TimeLive.Web.Note___Approved
            StatusTexbox.Text = StatusText
            StatusImage.Visible = True
            StatusImage.ImageUrl = "~/images/ApprovedStatus.gif"
        ElseIf ApprovalType = "NotRequired" Then
            lblStatus.Text = Resources.TimeLive.Web.Time_Entry_Status___Approved
            lblStatusNote.Text = Resources.TimeLive.Web.Note___Approval_Not_Required_For_This_Time_Entry
            StatusTexbox.Text = StatusText
            StatusImage.Visible = True
            StatusImage.ImageUrl = "~/images/ApprovedStatus.gif"
        End If
    ...
    Public Shared Sub SetRejected(ByVal lblStatus As Label, ByVal lblStatusNote As Label, ByVal StatusTexbox As TextBox, ByVal StatusText As String, ByVal StatusImage As System.Web.UI.WebControls.Image)
        lblStatus.Text = Resources.TimeLive.Web.Time_Entry_Status___Rejected
        lblStatusNote.Text = Resources.TimeLive.Web.Note___Rejected___Waiting_For_Re_Submit
        StatusTexbox.Text = StatusText
        StatusImage.Visible = True
    ...
    Public Shared Sub SetNotSubmitted(ByVal lblStatus As Label, ByVal lblStatusNote As Label, ByVal StatusTexbox As TextBox, ByVal StatusText As String, ByVal StatusImage As System.Web.UI.WebControls.Image)
        lblStatus.Text = Resources.TimeLive.Web.Time_Entry_Status___Not_Submitted
        lblStatusNote.Text = Resources.TimeLive.Web.Note___Not_Submitted___Waiting_For_Submit
        StatusTexbox.Text = StatusText
        StatusImage.Visible = True
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub BulkExpenseEntryApprovalEntriesForApproved(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
    ByVal ApprovalType As String, ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub BulkExpenseEntryApprovalEntriesForRejected(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal chk As CheckBox, ByVal Comments As String, _
    ByVal ApprovalType As String, ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
    ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub ApprovedTeamLeadEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
    ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
    ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub ApprovedProjectManagerEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
       ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
       ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim ExpenseSheetBLL As New AccountEmployeeExpenseSheetBLL
        Dim TCount As Integer = 1
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub ApprovedSpecificEmployeeEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
       ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
       ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim TCount As Integer = 1
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub ApprovedSpecificExternalUserEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
   ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
   ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim TCount As Integer = 1
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub ApprovedEmployeeManagerEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
    ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
    ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim TCount As Integer = 1
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub RejectTeamLeadEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
   ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
   ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim TCount As Integer = 1
        Dim ExpenseSheetBll As New AccountEmployeeExpenseSheetBLL
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub RejectProjectManagerEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
    ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
    ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim TCount As Integer = 1
        Dim ExpenseSheetBll As New AccountEmployeeExpenseSheetBLL
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub RejectSpecificEmployeeEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
       ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
       ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim TCount As Integer = 1
        Dim ExpenseSheetBll As New AccountEmployeeExpenseSheetBLL
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub RejectSpecificExternalUserEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
   ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
   ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim TCount As Integer = 1
        Dim ExpenseSheetBll As New AccountEmployeeExpenseSheetBLL
    ...
    ''' <param name="AccountEmployeeId"></param>
    ''' <remarks></remarks>
    Public Sub RejectEmployeeManagerEntries(ByVal AccountEmployeeExpenseSheetId As Guid, ByVal Chk As CheckBox, ByVal Comments As String, _
    ByVal ExpenseEntryAccountEmployeeId As Integer, ByVal IncludeDateRange As Boolean, _
    ByVal ExpenseEntryStartDate As Date, ByVal ExpenseEntryEndDate As Date, ByVal AccountEmployeeId As System.Nullable(Of Integer), ByVal ApprovalPathSequence As Integer)
        Dim TCount As Integer = 1
        Dim ExpenseSheetBll As New AccountEmployeeExpenseSheetBLL
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetDataForExpenseEntryArchiveByExpenseSheet(ByVal AccountId As Integer, ByVal AccountEmployees As String, ByVal IncludeDateRange As Boolean, ByVal AccountExpenseEntryStartDate As Date, ByVal AccountExpenseEntryEndDate As Date, ByVal Approval As String) As AccountExpenseEntry.vueAccountEmployeeExpenseSheetDataTable
        Dim _vueAccountEmployeeExpenseSheetTableAdapter As New vueAccountEmployeeExpenseSheetTableAdapter
        Return _vueAccountEmployeeExpenseSheetTableAdapter.GetDataByAccountIdAndEmployeesForExpenseEntryArchive(AccountId, AccountEmployees, IncludeDateRange, AccountExpenseEntryStartDate, AccountExpenseEntryEndDate, Approval)
    End Function
    ''' <summary>
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)> _
    Public Function UpdateExpenseEntryArchive(ByVal Original_AccountEmployeeExpenseSheetId As Guid, _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function GetTotalReimbursementAmount(ByVal TotalAmount As String, ByVal AccountReimbursementCurrencyId As Integer)
        Dim CurrencyBLL As New AccountCurrencyBLL
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function AddAccountExpenseEntryWithExpenseSheetFromImport( _
                 ByVal AccountId As Integer, ByVal AccountExpenseEntryDate As Date, ByVal AccountEmployeeId As Integer, ByVal AccountProjectId As Integer, ByVal AccountProjectTaskId As Integer, ByVal AccountExpenseId As Integer, ByVal Amount As Double, ByVal CreatedOn As DateTime, ByVal CreatedByEmployeeId As Integer, ByVal ModifiedOn As DateTime, ByVal ModifiedByEmployeeId As Integer, ByVal Description As String, ByVal IsBillable As Boolean, ByVal Reimburse As Boolean, _
                   ByVal AccountCurrencyId As Integer, ByVal Quantity As Double, ByVal Rate As Double, ByVal AmountBeforeTax As Double, ByVal TaxAmount As Double, ByVal AccountPaymentMethodId As System.Nullable(Of Integer), _
                 ByVal ExchangeRate As Double, ByVal AccountTaxZoneId As Integer, ByVal Submitted As Boolean, ByVal Approved As Boolean, ByVal Rejected As Boolean, ByVal ExpenseSheetDescription As String, ByVal ExpenseSheetDate As Date, _
    ByVal SubmittedDate As Date, ByVal SheetApproved As Boolean, ByVal SheetRejected As Boolean, ByVal SheetSubmitted As Boolean, ByVal SheetInApproval As Boolean) As Boolean
        ...
        objExpenseEntryBLL.AddAccountExpenseEntry(AccountId, AccountExpenseEntryDate, AccountEmployeeId, AccountProjectId, _
        AccountProjectTaskId, AccountExpenseId, Amount, CreatedOn, CreatedByEmployeeId, ModifiedOn, ModifiedByEmployeeId, Description, IsBillable, Reimburse, _
        AccountCurrencyId, Quantity, Rate, AmountBeforeTax, TaxAmount, _
    ...
    ''' <remarks></remarks>
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
    Public Function GetApprovedAccountExpenseEntryForEmailToApproverByExpenseSheetId(ByVal AccountEmployeeExpenseSheetId As Guid) As AccountExpenseEntry.vueAccountExpenseEntryApprovedEmailToApproverDataTable
        ...
        Return _vueAccountExpenseEntryApprovedEmailToApproverTableAdapter.GetDataByAccountEmployeeExpenseSheetId(AccountEmployeeExpenseSheetId)
    End Function
    ''' <summary>
