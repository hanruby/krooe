...
Partial Class Controls_ctlAccountEmployeeList
    ...
    Protected Sub ObjectDataSource1_Inserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSource1.Inserted
        ...
        If Not CType(Me.FormView1.FindControl("BillingRateTextBox"), TextBox).Text = "" Then
            EmployeeBLL.AddBillingRateOfEmployee(CType(Me.FormView1.FindControl("BillingRateTextBox"), TextBox).Text, CType(Me.FormView1.FindControl("BillingRateStartDate"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("BillingRateEndDateTextBox"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("ddlAccountWorkTypeId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("EmployeeRateTextBox"), TextBox).Text, CType(Me.FormView1.FindControl("ddlBillingRateCurrencyId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("ddlEmployeeRateCurrencyId"), DropDownList).SelectedValue)
        End If
    End Sub
    ...
    Protected Sub ObjectDataSource1_Updated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ObjectDataSourceStatusEventArgs) Handles ObjectDataSource1.Updated
        ...
        If Me.FormView1.CurrentMode = FormViewMode.Edit Then
            ...
            If IsDBNull(drEmployee("BillingRateStartDate")) Then
                objAccountBillingRate.AddAccountBillingRate(DBUtilities.GetSessionAccountId, 1, 0, 0, Me.FormView1.DataKey("AccountEmployeeId"), 0, CType(Me.FormView1.FindControl("BillingRateTextBox"), TextBox).Text, CType(Me.FormView1.FindControl("BillingRateStartDate"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("BillingRateEndDateTextBox"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("ddlAccountWorkTypeId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("EmployeeRateTextBox"), TextBox).Text, CType(Me.FormView1.FindControl("ddlBillingRateCurrencyId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("ddlEmployeeRateCurrencyId"), DropDownList).SelectedValue)
            ...
            ElseIf CType(Me.FormView1.FindControl("BillingRateStartDate"), eWorld.UI.CalendarPopup).SelectedDate = drEmployee.BillingRateStartDate Then
                objAccountBillingRate.UpdateAccountBillingRate(DBUtilities.GetSessionAccountId, 1, 0, 0, Me.FormView1.DataKey("AccountEmployeeId"), CType(Me.FormView1.FindControl("BillingRateTextBox"), TextBox).Text, CType(Me.FormView1.FindControl("BillingRateStartDate"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("BillingRateEndDateTextBox"), eWorld.UI.CalendarPopup).SelectedDate, 0, CType(Me.FormView1.FindControl("ddlAccountWorkTypeId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("EmployeeRateTextBox"), TextBox).Text, CType(Me.FormView1.FindControl("ddlBillingRateCurrencyId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("ddlEmployeeRateCurrencyId"), DropDownList).SelectedValue, drEmployee.AccountBillingRateId)
            ElseIf CType(Me.FormView1.FindControl("BillingRateStartDate"), eWorld.UI.CalendarPopup).SelectedDate <> drEmployee.BillingRateStartDate Then
                objAccountBillingRate.AddAccountBillingRate(DBUtilities.GetSessionAccountId, 1, 0, 0, Me.FormView1.DataKey("AccountEmployeeId"), 0, CType(Me.FormView1.FindControl("BillingRateTextBox"), TextBox).Text, CType(Me.FormView1.FindControl("BillingRateStartDate"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("BillingRateEndDateTextBox"), eWorld.UI.CalendarPopup).SelectedDate, CType(Me.FormView1.FindControl("ddlAccountWorkTypeId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("EmployeeRateTextBox"), TextBox).Text, CType(Me.FormView1.FindControl("ddlBillingRateCurrencyId"), DropDownList).SelectedValue, CType(Me.FormView1.FindControl("ddlEmployeeRateCurrencyId"), DropDownList).SelectedValue)
                objAccountEmployee.UpdateAccountBillingRateId(objAccountBillingRate.GetLastInsertedId, Me.FormView1.DataKey("AccountEmployeeId"))
                Me.UpdateWorkTypeBillingRateOfEmployeeOwn(DBUtilities.GetSessionAccountId, 1, Me.FormView1.DataKey("AccountEmployeeId"), objAccountBillingRate.GetLastInsertedId, CType(Me.FormView1.FindControl("ddlAccountWorkTypeId"), DropDownList).SelectedValue)
    ...
    Protected Sub FormView1_ItemInserted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewInsertedEventArgs) Handles FormView1.ItemInserted
        AddEmployeeTypeOffByPolicy(False)
        Dim BLL As New AccountEmployeeBLL
        If Me.FormView1.CurrentMode = FormViewMode.Insert Then
            BLL.FileUpload(Me.FormView1.FindControl("txtElectronicSign"), BLL.GetLastInsertedId)
        End If
        If Me.FormView1.CurrentMode = FormViewMode.Insert Then
            BLL.FileUploadForProfile(Me.FormView1.FindControl("FileUpload1"), BLL.GetLastInsertedId)
        End If
    ...
    Protected Sub FormView1_ItemInserting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewInsertEventArgs) Handles FormView1.ItemInserting
        e.Values.Item("EmployeeManagerId") = CType(Me.FormView1.FindControl("ddlEmployeeManagerId"), DropDownList).SelectedValue
        e.Values.Item("EmployeePayTypeId") = CType(Me.FormView1.FindControl("ddlEmployeeTypeId"), DropDownList).SelectedValue
        e.Values.Item("AccountWorkingDayTypeId") = CType(Me.FormView1.FindControl("ddlWorkingDayTypeId"), DropDownList).SelectedValue
        e.Values.Item("UserInterfaceLanguage") = CType(Me.FormView1.FindControl("ddlUserInterfaceLanguage"), DropDownList).SelectedValue
        ...
        If CType(Me.FormView1.FindControl("ddlHolidayTypeId"), DropDownList).SelectedValue <> "0" Then
            e.Values.Item("AccountHolidayTypeId") = CType(Me.FormView1.FindControl("ddlHolidayTypeId"), DropDownList).SelectedValue
        Else
            e.Values.Item("AccountHolidayTypeId") = System.Guid.Empty.ToString
        End If
        If CType(Me.FormView1.FindControl("TerminationDateCalendarPopup"), eWorld.UI.CalendarPopup).SelectedValue.HasValue Then
            e.Values.Item("TerminationDate") = CType(Me.FormView1.FindControl("TerminationDateCalendarPopup"), eWorld.UI.CalendarPopup).SelectedDate
        End If
    ...
    End Sub
    Public Sub AddEmployeeTypeOffByPolicy(ByVal IsUpdate As Boolean)
        If CType(Me.FormView1.FindControl("ddlEmployeePolicyId"), DropDownList).SelectedValue <> "0" Then
            Dim AccountTimeOffPolicyId As New Guid(CType(Me.FormView1.FindControl("ddlEmployeePolicyId"), DropDownList).SelectedValue)
            Dim objEmployee As New AccountEmployeeBLL
            Dim AccountEmployeeId As Integer = IIf(IsUpdate = True, Me.FormView1.DataKey("AccountEmployeeId"), objEmployee.GetLastInsertedId)
            ...
            If dt.Rows.Count > 0 Then
                ...
                For Each dr In dt.Rows
                    If objTimeOff.IsEmployeeTimeOffExists(AccountEmployeeId, dr.AccountTimeOffTypeId) = False Then
                        objTimeOff.AddAccountEmployeeTimeOff(DBUtilities.GetSessionAccountId, AccountEmployeeId, dr.AccountTimeOffTypeId, 0, 0, 0, Now.Date, 0, AccountTimeOffPolicyId)
                    ElseIf objTimeOff.IsEmployeeTimeOffExists(AccountEmployeeId, dr.AccountTimeOffTypeId) Then
                        objTimeOff.UpdatePolicyIdByPolicyChanged(AccountEmployeeId, dr.AccountTimeOffTypeId, AccountTimeOffPolicyId)
                    End If
                Next
            End If
        End If
        Dim TimeOffBLL As New AccountEmployeeTimeOffBLL
        TimeOffBLL.SetPolicies()
    End Sub
