<%@ control language="VB" autoeventwireup="false" inherits="Employee_Controls_ctlAuditTrail, App_Web_uitpp31g" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Caption='<%# ResourceHelper.GetFromResource("Audit Trial") %>' SkinID="xgridviewSkinEmployee" OnRowDataBound="GridView1_RowDataBound">
            <Columns>
                <asp:TemplateField SortExpression="UpdateDate">
                    <edititemtemplate>
...
<asp:Label id="Label1" runat="server" Text='<%# Bind("UpdateDate", "{0:d}") %>' __designer:wfdid="w152"></asp:Label>
                ...
                <asp:BoundField DataField="PK" HeaderText="<%$ Resources:TimeLive.Web, Id %>" SortExpression="PK" Visible="False">
                    <FooterStyle HorizontalAlign="Center" />
                    <ItemStyle Width="30px" HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:TemplateField SortExpression="FieldName">
                    <edititemtemplate>
...
<asp:Label id="Label2" runat="server" Text='<%# Bind("FieldName") %>' __designer:wfdid="w156"></asp:Label>
                ...
                <asp:TemplateField SortExpression="OldValue">
                    <edititemtemplate>
...
<asp:Label id="Label3" runat="server" Text='<%# Bind("OldValue") %>' __designer:wfdid="w159"></asp:Label>
                ...
                <asp:TemplateField SortExpression="NewValue">
                    <edititemtemplate>
