...
Public Class AccountProjectTaskAttachmentBLL
    ...
    Public Function GetAccountProjectTaskAttachmentsByAccountProjectTaskId(ByVal AccountProjectTaskId As Integer, Optional ByVal NotFixTable As Boolean = False) As TimeLiveDataSet.AccountProjectTaskAttachmentDataTable
        ...
        strCacheKey = CacheManager.GetCacheKeyForAccountsData("AccountProjectTaskAttachmentDataTable", "GetAccountProjectTaskAttachmentsByAccountProjectTaskId", "AccountProjectTaskId=" & AccountProjectTaskId)

        If Not CacheManager.GetItemFromCache(strCacheKey) Is Nothing Then
            GetAccountProjectTaskAttachmentsByAccountProjectTaskId = CacheManager.GetItemFromCache(strCacheKey)
        Else
            GetAccountProjectTaskAttachmentsByAccountProjectTaskId = Adapter.GetDataByAccountProjectTaskId(AccountProjectTaskId)
            CacheManager.AddAccountDataInCache(GetAccountProjectTaskAttachmentsByAccountProjectTaskId, strCacheKey)
        End If
