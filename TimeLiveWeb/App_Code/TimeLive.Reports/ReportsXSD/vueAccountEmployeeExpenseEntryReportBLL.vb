...
Namespace dsDetailExpenseReportTableAdapters
    ...
    Partial Public Class vueAccountExpenseEntryAdapter
        ...
        Public Function GetDataByAccountIdAndEmployees(ByVal AccountId As Integer, ByVal AccountEmployees As String, ByVal AccountProjectId As Integer, ByVal AccountClientId As Long, ByVal AccountLocationId As Integer, ByVal IncludeDateRange As Boolean, ByVal AccountExpenseEntryStartDate As DateTime, ByVal AccountExpenseEntryEndDate As DateTime, ByVal Submitted As String, ByVal Approval As String, ByVal Billable As String) As dsDetailExpenseReport.vueAccountExpenseEntryDataTable
            ...
            Dim dataTable As dsDetailExpenseReport.vueAccountExpenseEntryDataTable = New dsDetailExpenseReport.vueAccountExpenseEntryDataTable
