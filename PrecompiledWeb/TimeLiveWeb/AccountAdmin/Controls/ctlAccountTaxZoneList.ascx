<%@ control language="VB" autoeventwireup="false" inherits="AccountAdmin_Controls_ctlAccountTaxZoneList, App_Web_j1ru2ref" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <x:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountTaxZoneId"
            ...
            <Columns>
                <asp:TemplateField SortExpression="AccountTaxZoneId">
                    <edititemtemplate>
...
<asp:Label id="Label1" runat="server" Text='<%# Bind("AccountTaxZoneId") %>' __designer:wfdid="w235"></asp:Label>
                ...
                <asp:TemplateField SortExpression="AccountTaxZone">
                    <edititemtemplate>
...
<asp:Label id="Label2" runat="server" Text='<%# Bind("AccountTaxZone") %>' __designer:wfdid="w238"></asp:Label>
                ...
                <asp:CommandField HeaderText="<%$ Resources:TimeLive.Web, Edit_text %>" SelectText="Edit" ShowSelectButton="True">
                    ...
                    <ItemStyle Width="6%" horizontalalign="Center" verticalalign="Middle" cssclass="edit_button" />
                </asp:CommandField>
                <asp:TemplateField HeaderText="<%$ Resources:TimeLive.Web, Delete_text %>">
                    ...
                    <headerstyle horizontalalign="Center" verticalalign="Middle" />
                    <ItemStyle  cssclass="delete_button" Width="6%"  />
                </asp:TemplateField>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="TaxZoneTextBox">
                  <asp:Literal ID="Literal2" runat="server" Text='<%# ResourceHelper.GetFromResource("Tax Zone:")%> ' /></asp:Label>
                        </td>
                        <td style="width: 250px">
                            <asp:TextBox ID="TaxZoneTextBox" runat="server" Text='<%# Bind("AccountTaxZone") %>'></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TaxZoneTextBox"
                    ...
                    <tr>
                        ...
                        <td style="width: 250px">
                            <asp:Button ID="UpdateButton" runat="server" CommandName="Update" Text="<%$ Resources:TimeLive.Web, Update_text%> " Width="68px" /><asp:Button
                                ID="CancelButton" runat="server" CommandName="Cancel" Text="<%$ Resources:TimeLive.Web, Cancel_text%> " Width="68px" /><asp:Label
                                    ID="lblExceptionText" runat="server" ForeColor="Red" Text="Label" Visible="False" CssClass="ErrorMessage"></asp:Label></td>
                    </tr>
                </table>
            </EditItemTemplate>
            <InsertItemTemplate>
...
<asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="TaxZoneTextBox">
                  <asp:Literal ID="Literal6" runat="server" Text='<%# ResourceHelper.GetFromResource("Tax Zone:")%> ' /></asp:Label>
                        </td>
                        <td style="width: 250px">
                            <asp:TextBox ID="TaxZoneTextBox" runat="server" Text='<%# Bind("AccountTaxZone") %>'></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TaxZoneTextBox"
                                CssClass="ErrorMessage" Display="Dynamic" ErrorMessage="*"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td align="right" class="FormViewLabelCell" style="width: 150px">
                        ...
                        <td style="width: 250px">
                            <asp:Button ID="ADDButton" runat="server" CommandName="Insert" Text="<%$ Resources:TimeLive.Web, Add_text%> " Width="68px" /><asp:Label
                                ID="lblExceptionText" runat="server" ForeColor="Red" Text="Label" Visible="False" CssClass="ErrorMessage"></asp:Label></td>
                    </tr>
                </table>
            </InsertItemTemplate>
            <ItemTemplate>
                AccountTaxZoneId:
                <asp:Label ID="AccountTaxZoneIdLabel" runat="server" Text='<%# Eval("AccountTaxZoneId") %>'>
                </asp:Label><br />
                AccountId:
                <asp:Label ID="AccountIdLabel" runat="server" Text='<%# Bind("AccountId") %>'></asp:Label><br />
                AccountTaxZone:
                <asp:Label ID="AccountTaxZoneLabel" runat="server" Text='<%# Bind("AccountTaxZone") %>'>
                </asp:Label><br />
                CreatedOn:
