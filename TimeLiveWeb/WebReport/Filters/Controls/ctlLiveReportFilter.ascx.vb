...
Partial Class WebReport_ctlLiveReportFilter
    ...
    Public Event ShowClicked(ByVal WhereClause As String, ByVal Consolidated As Boolean, ByVal BaseCurrencyId As Integer)
    Public Event PageLoad(ByVal WhereClause As String, ByVal Consolidated As Boolean, ByVal BaseCurrencyId As Integer)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        RaiseEvent PageLoad(Me.ViewState("WhereClause"), Consolidated, BaseCurrencyId)
    End Sub
    Public Sub GetFiltersByReport()
        ...
        If dtSystemReport.Rows.Count > 0 Then
            ...
            For Each drSystemReport In dtSystemReport.Rows
                Me.AddFilter("", drSystemReport.SystemReportFilterSource, drSystemReport.Caption, drSystemReport.IsRequired, drSystemReport.IsAllowAll)
            Next
            Dim bllreport As New TimeLive.WebReport.ReportDesignBLL
    ...
    Public Sub AddFilter(ByVal FilterType As String, ByVal FilterName As String, ByVal Caption As String, ByVal IsRequired As Boolean, ByVal IsAllowAll As Boolean)
        Me.AddRow()
        ...
        ElseIf FilterName = "Billable" Then
            AddRadioButtonFilterOf(GetFilterTextName("Both", "Billable", "Non-Billable"), Caption, FilterName, GetSelectedCaptionForRB("Both", "Billable", "Non-Billable"), FilterName)
        ElseIf FilterName = "DateRange" Then
            Me.AddRowForDate()
            AddDateRangeFilter(Caption, FilterName, IsRequired)
    ...
    Public Sub AddCascadingDropDownFilter(ByVal FilterName As String)
        ...
        End If
    End Sub
    Public Sub AddCascadingForSelectedFilter(ByVal FilterName As String, ByVal LoadingText As String, ByVal ParentControlId As DropDownList, _
    ...
    Public Sub AddCaption(ByVal caption As String, Optional ByVal AddCellToRow As Boolean = True, Optional ByVal SetRight As Boolean = True, Optional ByVal AddCellToRowForDate As Boolean = False)
        ...
        If AddCellToRow = True Then
            Me.AddFilterCellIntoFilterRowForCaption("FormViewLabelCellWithBorder")
        End If
        If SetRight Then
    ...
    End Sub
    Public Sub AddDateRangeFilter(ByVal Caption As String, ByVal FilterName As String, ByVal IsShowIncludeDateRange As Boolean)
        ...
        End If
        AddRowForDate()
        AddCalendarPopup("StartDate", "Start Date:", True, True)
        AddRowForDate()
        AddCalendarPopup("EndDate", "End Date:", True, True)
        Me.AddFilterCellIntoFilterRow()
        Me.FinishFilter()
    End Sub
    Public Sub AddLiteral(ByVal LiteralValue As String, Optional ByVal AddRowForDate As Boolean = False)
        ...
        End If
    End Sub
    Public Sub AddCalendarPopup(ByVal FilterName As String, ByVal Caption As String, Optional ByVal SkipFilterCellAddInRow As Boolean = False, Optional ByVal AddRowForDate As Boolean = False)
        AddCellForDate()
        Me.AddCaption(Caption, False, False, True)
        AddCellForDate()
        Dim CalendarPopup As New eWorld.UI.CalendarPopup
        ...
        If AddRowForDate Then
            FilterCellForDate.Controls.Add(CalendarPopup)
        Else
            FilterCell.Controls.Add(CalendarPopup)
        End If
        If SkipFilterCellAddInRow Then
            Me.AddFilterCellIntoFilterRow()
        End If
        If AddRowForDate Then
            AddFilterCellIntoFilterRowForDate()
    ...
    Protected Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        End If
        Me.UpdateIsConsolidated(AccountReportId)
        RaiseEvent ShowClicked(strWhereClause, Consolidated, BaseCurrencyId)
    End Sub
    ...
    Public Sub SetPermissionForDropDown()
        ...
        End If
    End Sub
    Public Sub AddRadioButtonFilterOf(ByVal column As String(), ByVal Caption As String, ByVal FilterName As String, ByVal SelectedCaption As String(), ByVal GroupName As String)
        Me.AddCell()
        Me.AddCaption(Caption)

        Me.AddCell()
        Me.AddRadioButtonFilter(column, FilterName, SelectedCaption, GroupName)
    End Sub
    Public Sub AddRadioButtonFilter(ByVal Column As String(), ByVal FilterName As String, ByVal SelectedCaption As String(), ByVal GroupName As String)
