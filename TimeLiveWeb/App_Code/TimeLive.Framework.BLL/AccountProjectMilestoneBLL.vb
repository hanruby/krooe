...
Public Class AccountProjectMilestoneBLL
    ...
    Public Function GetAccountProjectMilestonesByAccountProjectId(ByVal AccountProjectId As Integer, Optional ByVal NotFixTable As Boolean = False) As TimeLiveDataSet.AccountProjectMilestoneDataTable
        ...
        strCacheKey = CacheManager.GetCacheKeyForAccountsData("AccountProjectMilestoneDataTable", "GetAccountProjectMilestonesByAccountProjectId", "AccountProjectId=" & AccountProjectId)

        If Not CacheManager.GetItemFromCache(strCacheKey) Is Nothing Then
            GetAccountProjectMilestonesByAccountProjectId = CacheManager.GetItemFromCache(strCacheKey)
        Else
            GetAccountProjectMilestonesByAccountProjectId = Adapter.GetDataByAccountProjectId(AccountProjectId)
            CacheManager.AddAccountDataInCache(GetAccountProjectMilestonesByAccountProjectId, strCacheKey)
        End If
    ...
    End Function
    <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
Public Function GetAccountProjectMilestonesByAccountProjectTaskId(ByVal AccountProjectTaskId As Integer) As TimeLiveDataSet.AccountProjectMilestoneDataTable
        ...
        'Else
        GetAccountProjectMilestonesByAccountProjectTaskId = Adapter.GetDataByAccountProjectTaskId(AccountProjectTaskId)
    ...
    Public Function AddAccountProjectMilestone( _
                        ...
                        ByVal ModifiedOn As DateTime, ByVal ModifiedByEmployeeId As Integer, ByVal Comments As String, ByVal Completed As Boolean) As Boolean
    ...
    Public Function DeleteAccountProjectMilestone(ByVal Original_AccountProjectMilestoneId As Integer) As Boolean
