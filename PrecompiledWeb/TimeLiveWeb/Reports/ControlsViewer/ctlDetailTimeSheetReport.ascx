<%@ control language="VB" autoeventwireup="false" inherits="Reports_ControlsViewer_ctlDetailTimeSheetReport, App_Web_iqmrpsj3" %>
    ...
    <ContentTemplate>
        <table class="xFormView" style="width: 450px">
            <tr>
                ...
                <asp:Literal ID="Literal3" runat="server" Text="<%$ Resources:TimeLive.Web, Detail TimeSheet Report%> " /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:TimeLive.Web, Projects:%> " /></td>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:TimeLive.Web, Project Tasks:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                 <asp:Literal ID="Literal6" runat="server" Text="<%$ Resources:TimeLive.Web, Clients:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                   <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:TimeLive.Web, Department:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                ...
                <td align="left" style="width: 60%">
                    &nbsp;<asp:DropDownList ID="ddlLocation" runat="server" AppendDataBoundItems="True" DataSourceID="dslocationobject"
                        ...
                        <%--<asp:ListItem Selected="True" Value="0">&lt;ALL&gt;</asp:ListItem>--%>
                        <asp:ListItem Selected="True" Value="0" Label ID="Label6" runat="server" Text="<%$ Resources:TimeLive.Web, ALLs%> "></asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal9" runat="server" Text="<%$ Resources:TimeLive.Web, Approved:%> " /></td>
                <td align="left" style="width: 60%">
                    &nbsp;<asp:DropDownList ID="ddlApproved" runat="server" AppendDataBoundItems="True">
                        <%--<asp:ListItem Value="1">Approved</asp:ListItem>--%>
                        <asp:ListItem Value="1" Label ID="Label7" runat="server" Text="<%$ Resources:TimeLive.Web, Approved%> "></asp:ListItem>
                        <%--<asp:ListItem Value="0">Not Approved</asp:ListItem>--%>
                        <asp:ListItem Value="0" Label ID="Label8" runat="server" Text="<%$ Resources:TimeLive.Web, Not Approved%> "></asp:ListItem>
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:TimeLive.Web, Submitted:%> " /></td>
                <td align="left" style="width: 60%">
                    &nbsp;<asp:DropDownList ID="ddlSubmitted" runat="server" AppendDataBoundItems="True">
                        <asp:ListItem Value="1" Label ID="Label10" runat="server" Text="<%$ Resources:TimeLive.Web, Submitted%> "></asp:ListItem>
                        <%--<asp:ListItem Value="0">Not Approved</asp:ListItem>--%>
                        <asp:ListItem Value="0" Label ID="Label11" runat="server" Text="<%$ Resources:TimeLive.Web, Not Submitted%> "></asp:ListItem>
                        <%--<asp:ListItem Selected="True" Value="-1">Both</asp:ListItem>--%>
                        <asp:ListItem Selected="True" Value="-1" Label ID="Label12" runat="server" Text="<%$ Resources:TimeLive.Web, Both%> "></asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal11" runat="server" Text="<%$ Resources:TimeLive.Web, Billable:%> " /></td>
                <td align="left" style="width: 60%">
                    &nbsp;<asp:DropDownList ID="ddlBillable" runat="server" AppendDataBoundItems="True">
                        <asp:ListItem Value="1" Label ID="Label13" runat="server" Text="<%$ Resources:TimeLive.Web, Billable%> "></asp:ListItem>
                        <%--<asp:ListItem Value="0">Not Approved</asp:ListItem>--%>
                        <asp:ListItem Value="0" Label ID="Label14" runat="server" Text="<%$ Resources:TimeLive.Web, Un Billable%> "></asp:ListItem>
                        <%--<asp:ListItem Selected="True" Value="-1">Both</asp:ListItem>--%>
                        <asp:ListItem Selected="True" Value="-1" Label ID="Label15" runat="server" Text="<%$ Resources:TimeLive.Web, Both%> "></asp:ListItem>
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal12" runat="server" Text="<%$ Resources:TimeLive.Web, Include Date Range:%> " /></td>
                <td align="left" style="width: 60%">
                    <asp:CheckBox ID="chkIncludeDateRange" runat="server" /></td>
            </tr>
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal13" runat="server" Text="<%$ Resources:TimeLive.Web, Start Date:%> " /></td>
                <td align="left" style="width: 60%">
            ...
            <tr>
                <td align="right" class="formviewlabelcell" style="width: 40%">
                    <asp:Literal ID="Literal14" runat="server" Text="<%$ Resources:TimeLive.Web, End Date:%> " /></td>
                <td align="left" style="width: 60%">
