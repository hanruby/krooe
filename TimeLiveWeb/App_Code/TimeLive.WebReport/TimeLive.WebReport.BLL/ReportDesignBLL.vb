...
Namespace TimeLive.WebReport
    ...
    Public Function GetAccountReportDataSourceMappingByAccountReportId(ByVal AccountReportId As Guid) As dsReportDesign.AccountReportDataSourceMappingDataTable
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, True)> _
        Public Function GetDataForMyReportGrid(ByVal AccountId As Integer, ByVal AccountRoles As String, ByVal IsShowAll As Boolean) As dsReportDesign.vueAccountReportDataTable
            If IsShowAll Then
        ...
        Public Function AddAccountReport(ByVal ReportName As String, ByVal ReportDescription As String, ByVal AccountReportCategoryId As Guid, ByVal ReportIconPath As String, ByVal AccountId As Integer, ByVal IsConsolidated As Boolean, ByVal IsSystemReport As Boolean, ByVal SystemReportId As Guid, ByVal ReportOrder As Integer, ByVal ShowCompanyLogo As Boolean, ByVal ReportTitle As String, ByVal ReportHeader As String, ByVal ReportFooter As String) As Guid
